...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/reject.js"></script>
					...
					<div class="panel-body" id="eRegister">
						<form role="form" class="form-horizontal" id="formdataregister" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<table id="hreject" border="0">
									<tr>
									<th>Permohonan anda di tolak disebabkan</th>
									</tr>
									<tr>
									<td id="red" class="reason">
									</td>
									</tr>
								</table>
							...
							<div class="form-group">
								<div class="col-sm-4"><label>Nama</label></div>
									<div class='col-sm-7'>
										<input style="text-transform: uppercase;" type="text" class="form-control" id="namaAhli" name="namaAhli" disabled>
								</div>
							</div>
							...
							<input type="hidden" class="form-control" id="email" name=email disabled>
							...
							<div class="form-group">
								<div class="col-sm-4"><label>Alamat/Address <span id="red">*</span></label></div>
									<div class='col-sm-8'>
										<input style="text-transform: uppercase;" type="text" class="form-control" id="alamat" name="alamat" disabled> 
									</div>
							</div>
							<div class="form-group">
								<div class="col-sm-4"></div>
									<div class='col-sm-8'>
										<input style="text-transform: uppercase;" type="text" class="form-control" id="alamat2" name="alamat2" disabled> 
									</div>
							</div>
							<div class="form-group">
								<div class="col-sm-4"></div>
									<div class='col-sm-8'>
										<input style="text-transform: uppercase;" type="text" class="form-control" id="alamat3" name="alamat3" disabled> 
									</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-4"><label>Negeri<span id="red">*</span></label></div>
									<div class='col-sm-4'>
										<select class="form-control" id="negeri" name="negeri" disabled>
									...
									<div class='col-sm-5'>
										<div class="fileinput fileinput-new" data-provides="fileinput">
					  						<div class="fileinput-new thumbnail" style="width: 150px; height: 150px;">
					  						 	<img src="${pageContext.request.contextPath}/resources/image/user_default.png" id ="imgtest3" class="image--cover" accept=".jpg, .png">	
					    					</div>
					    					<div class="fileinput-preview fileinput-exists thumbnail" style="width:auto"></div>
					  						<div>
					    						...
					    						<input type="file" id="photo" name="photo" accept=".jpg, .png"></span>
						   ...
						   <div class="form-group picpasspekerjapsgn">
							...
							<div class="form-group getidpsgn">
								<div class="col-sm-4"><label>Sila masukkan no kakitangan Suami/Isteri anda</label></div>
									<div class='col-sm-3'>
						   ...
						   <div class="form-group getidparentstaff">
								<div class="col-sm-4"><label>Sila masukkan no kakitangan Ibu/Bapa/Penjaga anda</label></div>
									<div class='col-sm-3'>
								...
								<legend class="scheduler-border"></legend>
									...
									<div class="form-group textIdparent">
										<div class="col-sm-4"><label class="labeltextIdparent">No. K/P Ibu/Bapa/Penjaga</label></div>
											<div class='col-sm-3'>
												<input type="text" class="form-control" id="idParent" name="idparent" disabled>
											</div>
									</div>
											
								
							
									<div class="form-group textNamaparent">
										<div class="col-sm-4"><label class="labeltextNamaparent">Nama Ibu/Bapa/Penjaga</label></div>
											<div class='col-sm-7'>
												<input style="text-transform: uppercase;" type="text" class="form-control" id="namaPenjaga" name="namaPenjaga" disabled>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-4"><label>Alamat Pejabat</label></div>
											<div class='col-sm-8'>
												<input style="text-transform: uppercase;" type="text" class="form-control" id="alamatSuratParent" name="alamatSuratParent" disabled> 
											</div>
									</div>
									<div class="form-group">
										<div class="col-sm-4"></div>
											<div class='col-sm-8'>
												<input style="text-transform: uppercase;" type="text" class="form-control" id="alamatSuratParent2" name="alamatSuratParent2" disabled> 
											</div>
									</div>
									<div class="form-group">
										<div class="col-sm-4"></div>
											<div class='col-sm-8'>
												<input style="text-transform: uppercase;" type="text" class="form-control" id="alamatSuratParent3" name="alamatSuratParent3" disabled> 
											</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-4"><label>Poskod</label></div>
											<div class='col-sm-3'>
												<input type="text" class="form-control" id="poskodSuratParent" name="poskodSuratParent" disabled> 
											</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-4"><label>Negeri/Bandar</label></div>
											<div class='col-sm-4'>
											<input type="text" class="form-control" id="negeriSuratParent" name="negeriSuratParent" disabled> 
											</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-4"><label>No Telefon/ HP</label></div>
											<div class='col-sm-3'>
												<input type="text" class="form-control" id="phoneParent" name="phoneParent" disabled>
											</div>
									</div>
									...
									<div class="modal-footer">							
									    <button type="submit" id="Register" class="btn btn-primary Register">Kemaskini</button>
