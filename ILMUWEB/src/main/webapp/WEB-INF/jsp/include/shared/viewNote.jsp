			...
			<br><br>
				...
				<div class="form-group">
					...
					<div class="form-group modal-footer">
						<button type="submit" id="saveNote" class="btn btn-primary saveNote">Save</button>
						<button type="button" id="cancelNote" class="btn btn-secondary cancelNote">Cancel</button>
					     <button type="button" id="closeNote" class="btn btn-default closeNote">Close</button>    
					</div>
		</form>
	</div>
