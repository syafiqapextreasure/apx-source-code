...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Foundation/branchCode2.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Foundation/validatebranchCode2.js"></script>
...
<body>
	<!-- START MAIN CONTENT -->
			<div class="box box-default">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<button class="btn btn-primary pull-right" data-toggle='modal' data-target='#searchbranchCode'><i class="glyphicon glyphicon-search" title="Search" data-searchfor="sbranchCode"></i></button>
        				<button type="button" class="btn btn-primary pull-right" id="addbranchCode" data-toggle='modal' data-target="#modalbranchCode" data-whatever="Add"> 
        				<i class="glyphicon glyphicon-plus" title="Add Branch Code"></i></button>
        				
						<div class="clearfix"></div>
					</div>
							
					<div class="panel-body" id="display_BranchCode">
						<table id="brancCodeTable" class="table table-bordered table-striped">
						 <thead>
						 	<tr>
						 		<th>Branch Code</th>
                        		<th>Description</th>
		...
		<div class="modal fade" id="modalbranchCode" tabindex="-1" role="dialog" aria-labelledby="ModalAdd" aria-hidden="true" data-keyboard="false" data-backdrop="static">
			<div class="modal-dialog" role="document" style="width:65%">
				<div class="modal-content">
					<!-- Modal content-->
						...
						<form role="form" class="form-horizontal" id="formdataBranchCode" method="post">
							<br>
