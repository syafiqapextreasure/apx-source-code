...
<head>
 ...
 <script type="text/javascript" src="${pageContext.request.contextPath}/js/Foundation/VendorCode2.js"></script>				
...
<script>
	...
	<!-- <section class="content-header">
       <h1>
          <i class="glyphicon glyphicon-list"></i>  Vendor Code
       </h1>
    ...
    <div class="panel-heading">
        ...
        <button class="btn btn-primary pull-right" data-toggle='modal' data-target='#vendorModal' href='SearchVendor'><i class="glyphicon glyphicon-search" title="Find Patron"></i></button>
        <button type="button" class="btn btn-primary pull-right" id="btn_add" data-toggle='modal' data-target="#addModal" href="Modal_AddVendor">
     ...
     <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    	<%
							...
							List<Foundation> list = eb.getAllVendorCode();
				
							for (Foundation e : list) {
								
								String code = e.getGL39CODE();
						...
						<tr>
							<td><%=e.getGL39CODE()%></td>
							<td><%=e.getGL39NAME()%></td>
							<td><%=e.getGL39BINDER()%></td>
							<td><%=e.getGL39SUPPLIER()%></td>
							<td><%=e.getGL39PUB()%></td>
							...
							<button class="btn btn-info btn-xs" data-toggle='modal' data-target='#editModal' href='Modal_EditVendor?GL39CODE=<%=newConvertCode%>'><span class="glyphicon glyphicon-pencil" title="Edit Record" ></span></button>
   							<button class="btn btn-dull btn-xs" onclick="deleteVendor(this.id)" id="<%=e.getGL39CODE()%>"><span class="glyphicon glyphicon-trash" title="Delete Record" ></span></button>
   							</td>
