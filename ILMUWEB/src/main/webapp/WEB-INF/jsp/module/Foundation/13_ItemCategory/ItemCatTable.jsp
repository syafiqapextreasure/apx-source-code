...
<script>
	...
	<!-- <section class="content-header">
       <h1>
          <i class="glyphicon glyphicon-list"></i>  Item Category
       </h1>
    ...
    <div class="panel-heading">
        ...
        <button class="btn btn-primary pull-right" data-toggle='modal' data-target='#vendorModal' href='SearchItem'><i class="glyphicon glyphicon-search" title="Find Patron"></i></button>
        <button type="button" class="btn btn-primary pull-right" id="add" data-toggle='modal' data-target="#addModal" href="Modal_AddItemCat">
    ...
    <div class="panel-body" id="display_vendor">
     ...
     <table id="example1" class="table table-bordered table-striped">
                    ...
                    <%
						...
						List<Foundation> list = eb.getAllItemCat();
				
						for (Foundation e : list) {
							
							String code = e.getGL10ICAT();
					...
					%>
						<tr>
							...
							<button class="btn btn-primary btn-xs" data-toggle='modal' data-target='#viewModal' href='Modal_ViewItemCat?GL10ICAT=<%=newConvertCode%>'><span class="glyphicon glyphicon-eye-open" title="View Record" ></span></button>
							<button class="btn btn-info btn-xs" data-toggle='modal' data-target='#editModal' href='Modal_EditItemCat?GL10ICAT=<%=newConvertCode%>'><span class="glyphicon glyphicon-pencil" title="Edit Record" ></span></button>
							<button class="btn btn-dull btn-xs" onclick="deleteItemCat(this.id)" id="<%=e.getGL10ICAT()%>"><span class="glyphicon glyphicon-trash" title="Delete Record" ></span></button>
   							</td>
