...
<%@ page import="com.ilmu.global.connection.DBConnection, com.ilmu.foundation.VendorCode.VendorCriteria, java.util.List"%>
	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('vendorcode').checked) {
				var searchType = "GL39CODE";
			}else if (document.getElementById('vendorname').checked) {
				var searchType = "GL39NAME";
			}else if (document.getElementById('pic').checked) {
				var searchType = "GL39PERINC";
			}else if (document.getElementById('poscode').checked) {
				var searchType = "GL39PCODE";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("VendorSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="vendorcode"  checked>
    					 		Vendor Code
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="vendorname" >
    					 		Vendor Name
  								</label>
					  			</div>
					  			...
					  			<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="pic" >
    					 		Person In Charge
  								</label>
					  			</div>
					  			<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="poscode" >
    					 		Postcode
  								</label>
					  			</div>
					  			</div>
