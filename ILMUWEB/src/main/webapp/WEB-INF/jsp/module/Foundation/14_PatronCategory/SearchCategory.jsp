...
<%@ page import="com.ilmu.global.connection.DBConnection, com.ilmu.foundation.PatronCategory.CategoryCriteria, java.util.List"%>
	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('patcat').checked) {
				var searchType = "GL07CATE";
			}else if (document.getElementById('description').checked) {
				var searchType = "GL07DESC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("CategorySearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="patcat"  checked>
    					 		Patron Category
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
