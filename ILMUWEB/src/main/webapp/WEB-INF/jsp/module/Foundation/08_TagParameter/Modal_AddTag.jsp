...
<div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel" align="center">Add Tag Parameter</h4>
</div>
...
<form role="form" class="form-horizontal" method="post">
			...
			<div class="col-md-13">
					...
					<div class="form-group">
             		...
             		<div class="form-group">
             			<label class="col-sm-1 "></label>
                  		...
                  		<div class="col-sm-2 col-md-2">
                     		<input type="text" class="form-control" id="GL17TAG" name="GL17TAG" maxlength="3" required>
                  		</div>
                    ...
                    <div class="form-group">
                    	<label class="col-sm-1 "></label>
                  		...
                  		<div class="col-sm-8">
                     		<input type="text" class="form-control" id="GL17DESC" name="GL17DESC">
                  		</div>
             		</div>
             		...
             		<div class="form-group">
             			<label class="col-sm-1 "></label>
                  		...
                  		<div class="col-sm-8">
                      		<input type="text" class="form-control" id="GL17TRUC" name="GL17TRUC">
                  		</div>
             		</div> 
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                  	...
                  	<div class="col-sm-4">
                      <input type="text" class="form-control" id="GL17TABNAME" name="GL17TABNAME">
                  	</div>
                  	
                  	<div class="col-md-6">
                      	<div class="checkbox">
      						<label class="col-sm-4 " >
        					<input type="checkbox" class="minimal" name="GL17REPEAT" id="GL17REPEAT" value="Y" onclick = "change()"> Repeatable
        					<input type="hidden" class="minimal" name="GL17REPEAT" id="GL17REPEAT" value="N"> 
      						</label>
      						<label class="col-sm-5 ">
        					<input type="checkbox" class="minimal" name="GL17AUTFLAG" id="GL17AUTFLAG" value="Y" onclick = "change()"> Authority Flag
        					<input type="hidden" class="minimal" name="GL17AUTFLAG" id="GL17AUTFLAG" value="N"> 
      						</label>
    					</div>
    				</div>
             		</div> 
             		...
             		<div class="form-group">
                  	...
                  	<div class="col-sm-4">
                      <input type="text" class="form-control" id="GL17ACRO" name="GL17ACRO">
                  	</div>
                  	<div class="col-md-6">
                      	<div class="checkbox">
      						<label class="col-sm-4 " >
        					<input type="checkbox" class="minimal" name="GL17MANDA" id="GL17MANDA" value="Y" onclick = "change()"> Mandatory
        					<input type="hidden" class="minimal" name="GL17MANDA" id="GL17MANDA" value="N"> 
      						</label>
      						<label class="col-sm-5 ">
        					<input type="checkbox" class="minimal" name="GL17CPFLAG" id="GL17CPFLAG" value="Y" onclick = "change()"> Copy and Paste
        					<input type="hidden" class="minimal" name="GL17CPFLAG" id="GL17CPFLAG" value="N"> 
      						</label>
    					</div> 
    				</div>
             		</div> 
             		...
             		<div class="form-group"> 
                  	...
                  	<div class="col-sm-4">
                      <input type="text" class="form-control" id="GL17GRID" name="GL17GRID">
                  	</div>
                  	<div class="col-md-6">
                      	<div class="checkbox">
      						<label class="col-sm-4 " >
        					<input type="checkbox" class="minimal" name="GL17IDXFLAG" id="GL17IDXFLAG" value="Y" onclick = "change()"> Index Flag
        					<input type="hidden" class="minimal" name="GL17IDXFLAG" id="GL17IDXFLAG" value="N"> 
      						</label>
      						<label class="col-sm-5 ">
        					<input type="checkbox" class="minimal" name="GL17PARAMIPS" id="GL17PARAMIPS" value="Y" onclick = "change()"> PARAMIPS Link 
      						</label>
    					</div>
    				</div>
             		</div> 
             		...
             		<div class="form-group">
                  	...
                  	<div class="col-sm-4">
                      <input type="text" class="form-control" id="GL17LEN" name="GL17LEN">
                  	</div>
                  	<div class="col-md-6">
                      	<div class="checkbox">
      						<label class="col-sm-4 " >
        					<input type="checkbox" class="minimal" name="GL17KEYWORD" id="GL17KEYWORD" value="Y" onclick = "change()"> Keyword
        					<input type="hidden" class="minimal" name="GL17KEYWORD" id="GL17KEYWORD" value="N"> 
      						</label>
      						<label class="col-sm-5 ">
        					<input type="checkbox" class="minimal" name="GL17MEDIA" id="GL17MEDIA" value="Y" onclick = "change()"> Multimedia Tag
        					<input type="hidden" class="minimal" name="GL17MEDIA" id="GL17MEDIA" value="N"> 
      						</label>
    					</div>
    				</div>
             		</div> 
             		...
             		<div class="form-group">
                  	...
                  	<div class="col-sm-4">
                      <input type="text" class="form-control" id="GL17IDXLANG" name="GL17IDXLANG">
                  	</div>
                  	<div class="col-md-6">
                      	<div class="checkbox">
      						<label class="col-sm-5 " >
        					<input type="checkbox" class="minimal" name="GL17STOP" id="GL17STOP" value="Y" onclick = "change()"> Duplicate Check
        					<input type="hidden" class="minimal" name="GL17STOP" id="GL17STOP" value="N"> 
      						</label>
    					</div>
    				</div>
             		</div> 
               ...
               <label class="col-sm-2 control-label">Indicator 2 </label>
                  ...
                  <select class="form-control" id="GL17INDI2" name="GL17INDI2" >
             		...
             		<div class="form-group">
                  	...
                  	<div class="col-sm-9">
                      <input type="text" class="form-control" id="GL17DEFAULT" name="GL17DEFAULT">
                  	</div>
             		</div>
             		...
             		<div class="form-group">
                  	...
                  	<div class="col-sm-9">
                      <input type="text" class="form-control" id="GL17REMARK" name="GL17REMARK">
                  	</div>
             		</div>
                  ...
                  <!-- Tab 2 -->
                  <div class="tab-pane" id="tab_2" onclick="indilevel1()">
                  	<div class="form-group">
      						<label class="col-sm-2 " >
        					<input type="checkbox" class="minimal" name="GL18INDI_1" id="Undefined" value="#" onclick = "change()"> Undefined (#)
        					</label>
                  	<div class="col-sm-9">
                  ...
                  <!-- Tab 3 -->
                  <div class="tab-pane" id="tab_3" onclick="indilevel2()">
                   <div class="form-group">
      						<label class="col-sm-2 " >
	...
	<div class="modal-footer">
		<button type="submit" class="btn btn-primary" id="btn-add" style="width:80px;" onclick="addTag()">Save</button>
