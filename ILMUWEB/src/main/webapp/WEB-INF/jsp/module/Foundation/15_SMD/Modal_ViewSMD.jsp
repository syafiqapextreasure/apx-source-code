...
<div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel" align="center">View Specific Material Designation (SMD)</h4>
</div>
	
<form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/AddSMD"  method="post">
			...
			<div class="col-md-10">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-3 col-md-2">
                        <input type="text" class="form-control" id="GL47SMD" name="GL47SMD" value="<%=e.getGL47SMD()%>" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" id="GL47DESC" name="GL47DESC" value="<%=e.getGL47DESC()%>" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                       ...
                       <%--  <%	if(e.getGL47DISPLAY()== null){%>
                        	 <input type="text" class="form-control" id="GL47DISPLAY" name="GL47DISPLAY" value=" " readonly>
                        	 <%}else{%> --%>
                             <input type="text" class="form-control" id="GL47DISPLAY" name="GL47DISPLAY" value="<%=e.getGL47DISPLAY()%>" readonly>
                        	<%-- <%}%> --%>
                        </div>
                    </div>
