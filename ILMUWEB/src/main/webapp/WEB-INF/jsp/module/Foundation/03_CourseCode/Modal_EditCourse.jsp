...
<div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel" align="center">Edit Course Code</h4>
</div>
	
<form role="form" id="courseCodeForm" class="form-horizontal" action="${pageContext.request.contextPath}/UpdateCourse"  method="post">
			...
			<div class="form-group">
                    	<label for="inputEmail3" class="col-sm-3 "><strong>Course Code</strong></label>
                      	<div class="col-sm-5 col-md-2">
                         	<input type="text" class="form-control" id="GL12COURSE" name="GL12COURSE" value="<%=e.getGL12COURSE()%>" disabled>
                      	</div>
                      		 <input type="hidden" id="Course" name="Course" class="form-control" value="<%=e.getGL12COURSE()%>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                  		...
                  		<div class="col-sm-7">
                      		<input type="text" class="form-control" id="GL12DESC" name="GL12DESC" value="<%=e.getGL12DESC()%>" onkeyup="toUppercase()">
                  		</div>
             		</div>
             		...
             		<div class="form-group">
                  		...
                  		<div class="col-sm-5 col-md-3">
                       		...
                       		<input type="text" class="form-control" id="patronId" name="GL12TUTOR" value="<%=e.getGL12TUTOR()%>">
                  		</div>
                  		...
                  		<div class="col-sm-2 col-md-5">
                  			<%
		             	 	 		...
		             	 	 		if(e.getGL12TUTOR().trim().isEmpty()){
			                  			...
			                  			Foundation patrName = name.getPatron(e.getGL12TUTOR().trim());
       		...
       		<%} %> --%>
       			...
       			<div class="form-group">
             		 ...
             		 <div class="form-group">
                  		...
                  		<div class="col-sm-3">
                  		<input type="text" class="form-control" id="recby" name="recby" value="<%=e.getGL12RECBY()%>" readonly>
                  		</div>
             		</div>
