	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('code').checked) {
				var searchType = "GL11DEPT";
			}else if (document.getElementById('name').checked) {
				var searchType = "GL11NAME";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("DeptSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");

				$("#display_dept").html(data_vendor);
			   });
		})
	});
	</script>
