...
<%@page import="com.ilmu.foundation.global.Foundation, com.ilmu.global.*"%>
...
<script>
	...
	<!-- <section class="content-header">
       <h1>
          <i class="glyphicon glyphicon-list"></i>  General Subject
       </h1>
    ...
    <div class="panel-heading">
        ...
        <button class="btn btn-primary pull-right" data-toggle='modal' data-target='#vendorModal' href='SearchSubject'><i class="glyphicon glyphicon-search" title="Find Patron"></i></button>
        <button type="button" class="btn btn-primary pull-right" id="add" data-toggle='modal' data-target="#addModal" href="Modal_AddSubject">
    ...
    <div class="panel-body" id="display_vendor">
     ...
     <table id="example1" class="table table-bordered table-striped">
                    ...
                    <%
						...
						List<Foundation> list = eb.getAllSubjCode();
				
						for (Foundation e : list) {
							String codeA = e.getGL54SUBJSTA();
							String codeD = e.getGL54SUBJEND();
					...
					%>
						<tr>
							<td><%=e.getGL54SUBJSTA()%></td>
							<td><%=e.getGL54SUBJEND()%></td>
							<td><%=e.getGL54MARK()%></td>
							<td><%=e.getGL54DESC()%></td>
							...
							<button class="btn btn-dull btn-xs" onclick="deleteSubj(this.id)" id="<%=e.getGL54SUBJSTA()%>"><span class="glyphicon glyphicon-trash" title="Delete Record" ></span></button>
   							</td>
...
<!-- ./END MAIN CONTENT -->	
    ...
    <div class="modal fade" id="vendorModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
         <div class="modal-dialog" style="width:75%;overflow:auto;width:750px;">
             <div class="modal-content">
		 	 <!-- Remote content load here -->
		  	 </div>
		</div>
