	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('smd').checked) {
				var searchType = "GL47SMD";
			}else if (document.getElementById('description').checked) {
				var searchType = "GL47DESC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("SmdSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");

				$("#display_smd").html(data_vendor);
			   });
		})
	});
	</script>
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="smd"  checked>
    					 		SMD
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
