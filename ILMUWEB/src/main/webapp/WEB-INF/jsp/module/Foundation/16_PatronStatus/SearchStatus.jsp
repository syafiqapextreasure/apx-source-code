	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('status').checked) {
				var searchType = "GL08STAT";
			}else if (document.getElementById('description').checked) {
				var searchType = "GL08DESC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("StatusSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="status"  checked>
    					 		Patron Status
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
