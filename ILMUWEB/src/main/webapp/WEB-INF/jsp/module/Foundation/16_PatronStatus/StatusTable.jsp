...
<script>
	...
	<!-- <section class="content-header">
       <h1>
          <i class="glyphicon glyphicon-list"></i>  Patron Status
       </h1>
    ...
    <div class="panel-heading">
        ...
        <button class="btn btn-primary pull-right" data-toggle='modal' data-target='#vendorModal' href='SearchStatus'><i class="glyphicon glyphicon-search" title="Find Patron Status"></i></button>
        <button type="button" class="btn btn-primary pull-right" id="add" data-toggle='modal' data-target="#addModal" href="Modal_AddStatus">
    ...
    <div class="panel-body" id="display_vendor">
     ...
     <table id="example1" class="table table-bordered table-striped">
                    ...
                    <%
						...
						List<Foundation> list = eb.getAllPatStatus();
				
						for (Foundation e : list) {
							
							String code = e.getGL08STAT();
					...
					%>
						<tr>
							...
							<button class="btn btn-dull btn-xs" onclick="deleteStat(this.id)" id="<%=e.getGL08STAT()%>"><span class="glyphicon glyphicon-trash" title="Delete Record" ></span></button>
   							</td>
