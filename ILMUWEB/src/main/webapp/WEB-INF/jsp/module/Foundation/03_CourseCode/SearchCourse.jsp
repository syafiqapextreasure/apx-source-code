	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('course').checked) {
				var searchType = "GL12COURSE";
			}else if (document.getElementById('description').checked) {
				var searchType = "GL12DESC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("CourseSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");

				$("#display_course").html(data_vendor);
			   });
		})
	});
	</script>
				...
				<div class="panel panel-default">
					...
					<div id="search_vendor" class="panel-collapse collapse in">
						<div class="panel-body">
							<form role="form" class="form-horizontal" id="course_form" name="course_form" onsubmit="return send_vendor_info()">
							
            				<div class="form-group">
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="course"  checked>
    					 		Course Code
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
