...
<script>
    ...
    <div class="panel-heading">
        ...
        <button class="btn btn-primary pull-right" data-toggle='modal' data-target='#vendorModal' href='SearchDept'><i class="glyphicon glyphicon-search" title="Find Patron"></i></button>
        <button type="button" class="btn btn-primary pull-right" id="add" data-toggle='modal' data-target="#addModal" href="Modal_AddDept">
        <i class="glyphicon glyphicon-plus" title="Add New Code"></i></button>
		<div class="clearfix"></div>
    </div>
    <div class="panel-body" id="display_dept">
     ...
     <table id="example1" class="table table-bordered table-striped">
					...
					%>
						<tr>
							...
							<button class="btn btn-dull btn-xs" onclick="deleteDept(this.id)" id="<%=e.getGL11DEPT()%>"><span class="glyphicon glyphicon-trash" title="Delete Record" ></span></button>
   							</td>
...
<!-- ./END MAIN CONTENT -->	
 	...
 	<!-- ADD MODAL -->  
		<div class="modal fade" id="addModal" role="dialog" data-keyboard="false" data-backdrop="static">
			<div class="modal-dialog" style="width:75%;overflow:auto;height:800px;">
