...
<%@ page import="com.ilmu.global.connection.DBConnection, com.ilmu.foundation.ItemCategory.ItemCriteria, java.util.List"%>
	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('itemcode').checked) {
				var searchType = "GL10ICAT";
			}else if (document.getElementById('description').checked) {
				var searchType = "GL10DESC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("ItemSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="itemcode"  checked>
    					 		Item Category
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
