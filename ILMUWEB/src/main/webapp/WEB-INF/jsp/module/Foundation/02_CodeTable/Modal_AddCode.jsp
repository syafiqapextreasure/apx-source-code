...
<%@ page import="com.ilmu.foundation.global.*,com.ilmu.foundation.CodeTable.*, java.util.List" %>
...
.modal-body {
	...
	%>
		...
		<%-- <% 
			...
			System.out.println("SELECT FNDSYSTEM.FCODE, FNDSYSTEM.FNDNAME, FNDSYSTEM.FCOLUMN1, FNDSYSTEM.FCOLUMN2, FNDCODE.FNAME FROM FNDSYSTEM INNER JOIN FNDCODE ON FNDSYSTEM.FCODE=FNDCODE.FCODE WHERE FNDSYSTEM.FCODE='" + titlecategory + "'");
            if(!resultset.next()) {
...
<div class="modal-header">
		...
		<h4 class="modal-title" id="myModalLabel" align="center">Add <%=a.getFNDNAME() %></h4>
</div>
	<%-- <% 
		 } 
    %> --%>
<!-- <form role="form" class="form-horizontal"  method="post"> -->
<form role="form" id="codeForm" class="form-horizontal" action="${pageContext.request.contextPath}/AddCode" method="post">
			...
			<div class="col-md-10">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5 col-md-5">
                        <input type="text" class="form-control" id="CODE" name="CODE" required onkeyup="toUppercase()">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-9">
                        <input type="text" class="form-control" id="DESCRIPTION" name="DESCRIPTION" onkeyup="toUppercase()">
                    </div>
                </div>
	...
	<div class="modal-footer">
		<!-- <button type="submit" class="btn btn-primary" id="btn-add"" style="width:80px;" onclick="addCodeTable()">Save</button> -->
