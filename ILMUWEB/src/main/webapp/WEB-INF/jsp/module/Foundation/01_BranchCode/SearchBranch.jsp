...
<%@ page import="com.ilmu.global.connection.DBConnection, com.ilmu.foundation.BranchCode.BranchCriteria, java.util.List"%>
	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('branchcode').checked) {
				var searchType = "GL71BRNC";
			}else if (document.getElementById('description').checked) {
				var searchType = "GL71DESC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("BranchSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="branchcode"  checked>
    					 		Branch Code
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
