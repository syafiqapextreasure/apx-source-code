...
<script>
	...
	<section class="content-header">
       <h1>
          <i class="glyphicon glyphicon-list"></i>  Department Code
       </h1>
     ...
     <table id="example1" class="table table-bordered table-striped">
					...
					%>
						<tr>
							...
							<button class="btn btn-primary btn-xs" data-toggle='modal' data-target='#viewModal' href='Modal_ViewDept?GL11NAME=<%=e.getGL11NAME()%>'><span class="glyphicon glyphicon-eye-open" title="View Record" ></span></button>
							<button class="btn btn-info btn-xs" data-toggle='modal' data-target='#editModal' href='Modal_EditDept?GL11DEPT=<%=e.getGL11DEPT()%>'><span class="glyphicon glyphicon-pencil" title="Edit Record" ></span></button>
   							<button class="btn btn-dull btn-xs" onclick="deleteCurrency(this.id)" id="<%=e.getGL11DEPT()%>"><span class="glyphicon glyphicon-trash" title="Delete Record" ></span></button>
   							</td>
