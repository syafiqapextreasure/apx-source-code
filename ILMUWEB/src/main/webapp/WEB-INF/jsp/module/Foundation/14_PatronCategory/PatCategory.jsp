...
<script>
	...
	<!-- <section class="content-header">
       <h1>
          <i class="glyphicon glyphicon-list"></i>  Patron Category
       </h1>
    ...
    <div class="panel-heading">
        ...
        <button class="btn btn-primary pull-right" data-toggle='modal' data-target='#vendorModal' href='SearchCategory'><i class="glyphicon glyphicon-search" title="Find Patron"></i></button>
        <button type="button" class="btn btn-primary pull-right" id="btn_add" data-toggle='modal' data-target="#addModal" href="Modal_AddPatCat">
    ...
    <div class="panel-body" id="display_vendor">
     ...
     <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
						...
						List<Foundation> list = eb.getAllPatCate();
				
							for (Foundation e : list) {
								
								String code = e.getGL07CATE();
						...
						<tr>
							...
							<button class="btn btn-info btn-xs" data-toggle='modal' data-target='#editModal' href='Modal_EditPatCat?GL07CATE=<%=newConvertCode%>'><span class="glyphicon glyphicon-pencil" title="Edit Record" ></span></button>
   							<button class="btn btn-dull btn-xs" onclick="deletePatCat(this.id)" id="<%=e.getGL07CATE()%>"><span class="glyphicon glyphicon-trash" title="Delete Record" ></span></button>
   							</td>
