	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('start').checked) {
				var searchType = "GL54SUBJSTA";
			}else if (document.getElementById('end').checked) {
				var searchType = "GL54SUBJEND";
			}else if (document.getElementById('desc').checked) {
				var searchType = "GL54DESC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("SubjectSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="start"  checked>
    					 		Subject Start Code
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="end" >
    					 		Subject End Code
  								</label>
					  			</div>
					  			<div class="col-sm-5 col-md-5">
