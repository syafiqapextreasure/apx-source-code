	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('serial').checked) {
				var searchType = "GL49FREQ";
			}else if (document.getElementById('description').checked) {
				var searchType = "GL49DESC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("SerialSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="serial"  checked>
    					 		Serial Frequency
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
