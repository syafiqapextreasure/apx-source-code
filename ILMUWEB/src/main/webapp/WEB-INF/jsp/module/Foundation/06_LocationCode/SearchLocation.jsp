...
<%@ page import="com.ilmu.global.connection.DBConnection, com.ilmu.foundation.LocationCode.LocationCriteria, java.util.List"%>
	...
	$(document).ready(function(){
		...
		$('#btn_submit').click(function(){
			...
			if (document.getElementById('locacode').checked) {
				var searchType = "GL05LOCA";
			}else if (document.getElementById('desc').checked) {
				var searchType = "GL05DESC";
			}else if (document.getElementById('branch').checked) {
				var searchType = "GL05BRNC";
			}
			
			
			//alert(vendor_details);
			//alert(searchType);
			$.get("LocaSearch",{criteria:vendor_details,searchType:searchType,cate_id:cate_id},function(data_vendor){
				//alert("TEST 1");
						...
						<div class="panel-body">
            				...
            				<div class="radio">
            					<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="locacode"  checked>
    					 		Location Code
  								</label>
  								</div>
  								<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="desc" >
    					 		Description
  								</label>
					  			</div>
					  			...
					  			<div class="col-sm-5 col-md-5">
  								<label>
    							<input type="radio" class="minimal" name="choice" id="branch" >
    					 		Branch Code
  								</label>
					  			</div>
					  			</div>
