...
$(document).on("click", "#btn_submit", function(event){
	...
	$.get("SearchPatron2",{criteria:criteria,search_type:searchType,cate_id:cate_id, action:action, sort:sort, textid:textid},function(data_vendor){
...
function appendData(GL14PATR, textid){
			...
			$.get('GetoffiName', {
				...
				if(responseJson != null){
					$.each(responseJson, function(key,value) {
						...
						if(textid.trim() == "headlib"){
							$(".div-headLibname").text(value['patrName']);
							$("#headLib").val(GL14PATR);
						}else if(textid.trim() == "profficer"){
							$(".div-profficername").text(value['patrName']);
							$("#profficer").val(GL14PATR);
						}else if(textid.trim() == "acqhead"){
							$(".div-acqheadname").text(value['patrName']);
							$("#acqhead").val(GL14PATR);
						}else if(textid.trim() == "cathead"){
							$(".div-catheadname").text(value['patrName']);
							$("#catheaad").val(GL14PATR);
						}else if(textid.trim() == "cirhead"){
							$(".div-cirheadname").text(value['patrName']);
							$("#cirhead").val(GL14PATR);
						}else if(textid.trim() == "serHead"){
							$(".div-serHeadname").text(value['patrName']);
							$("#serHead").val(GL14PATR);
						}else if(textid.trim() == "irsHead"){
							$(".div-irsHeadname").text(value['patrName']);
							$("#irsHead").val(GL14PATR);
						}else if(textid.trim() == "finHead"){
							$(".div-finHeadname").text(value['patrName']);
							$("#finHead").val(GL14PATR);
						}
					});
				}
		});
