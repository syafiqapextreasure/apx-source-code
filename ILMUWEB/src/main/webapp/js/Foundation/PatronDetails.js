$(document).ready(function() {
	...
	var output = d.getFullYear() + '/' +
	 ...
	 ////05092022
	 var today = new Date(); 
	 $('.daterecadd').text(moment(today).format("DD/MM/YYYY"));
	 $('#daterecpatradd').val(moment(today).format("YYYYMMDD"));
	 $(".recbyadd").text(loginid); 
...
//	        	 $("[name='chkMailFlag(0)']").val();
	...
	//}
		...
		$("input[name=GL14NEWIC]").on('focusout',function () {
			...
			//alert("inputStr : " +inputStr+inputStr.length);
			//CheckingPatDetails2
			/*$.get('getCountTotal', {
