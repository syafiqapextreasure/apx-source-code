...
@WebServlet(value={"/addDocStatus"})
public class addDocStatus
extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            try {
                ...
                String insertDocStatus = "INSERT INTO GLDOCS (GL36STAT, GL36DESC, GL36CHGTO) VALUES ('" + documentStatus + "', '" + desc + "', '" + chgto + "')";
                System.out.println("insertDocStatus" + insertDocStatus);
                PreparedStatement statementinsertDocStatus = con.prepareStatement(insertDocStatus);
