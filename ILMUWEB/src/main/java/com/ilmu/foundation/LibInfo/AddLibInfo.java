...
@WebServlet(value={"/AddLibInfo"})
@MultipartConfig(maxFileSize=16177215L)
public class AddLibInfo
extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            try {
                ...
                RequestDispatcher view = this.getServletContext().getRequestDispatcher("/template?MODULE=Foundation/10_PatronDetails&ACTION=PatronTable.jsp");
