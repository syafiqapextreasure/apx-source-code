...
public class DBConnection {
    ...
    public static final String URL = "jdbc:sqlserver://10.1.2.18;databaseName=ILMUWEB";
    public static final String USER = "ilmuweb";
    public static final String PASSWORD = "ilmuweb";
        ...
        block13: {
            ...
            try {
                try {
                    ...
                    System.out.println("Connection Successful1");
