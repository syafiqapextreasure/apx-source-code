<%@page import="java.util.List, com.ilmu.binding.maintenance.Serial "%>
...
<%
	try {
		...
		if(action.equals("Edit")){
			Serial.UpdateSer(bindingNo, officer, binder, currency, erate, year, fcost, lcost, 
					dsent, dexpect, pages, remarks, typeBind, status, spineTitle, cColor, lColor, 
					oriCover, advert, titlePage, supp, indexInc, contentsPage, liferayLogin);
			out.println("ok");
		}
