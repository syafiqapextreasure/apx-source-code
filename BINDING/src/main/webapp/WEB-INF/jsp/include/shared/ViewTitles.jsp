 ...
 //$(document).ready(function() {
	 ...
	 if(getAction == '8'){
		...
		// $('#view-result12 td:nth-child(0)').hide();
		 ...
		 $('#view-result12 tr').find('td:nth-child(2),th:nth-child(2)').hide();
	 }else if(getAction == '20'){
		//alert("dfsfs");
		$('#view-result12 tr').find('td:nth-child(6),th:nth-child(6)').hide();
		$('#view-result12 tr').find('td:nth-child(7),th:nth-child(7)').hide();
		$('#view-result12 tr').find('td:nth-child(8),th:nth-child(8)').hide();
