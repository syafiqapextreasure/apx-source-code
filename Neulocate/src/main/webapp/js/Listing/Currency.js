		       ...
		       /* data : {startSentDate : startSentDate, endSentDate : endSentDate, 
		        ...
		        dataSrc: function (json) {
					...
					if(json[i].Column2 == " "){
		              ...
		              return_data.push({
		                'No': (i+1),
		                'Currency Code' : json[i].Id,
		                'Description' : json[i].Desc,
		                'Publishers Rate' : json[i].Column1,
		                'Banks Rate' : json[i].Column2,
		            })
		            }
		     	...
		     	columns    : [
					...
					{'data': 'Currency Code'},
					{'data': 'Description'},
					{'data': 'Publishers Rate', className: "text-right", render: $.fn.dataTable.render.number(',', '.', 2, '')},
					{'data': 'Banks Rate', className: "text-right", render: $.fn.dataTable.render.number(',', '.', 2, '')},
				],
				//order: [[ 1, 'asc' ]],
