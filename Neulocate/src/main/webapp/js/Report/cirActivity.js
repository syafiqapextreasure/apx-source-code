                ...
                /*'excel', 'pdf', 'print'*/
						{
					        ...
					        title: 'Circulation Activity By '+titleHeader +" from " +startSentDate + " unitl " +endSentDate,
					 	...
					 	},
						{
							...
							//doc.content[1].table.body[0][3].alignment = 'right';
							 ...
							 //doc.content[1].table.body[0][5].alignment = 'right';
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Circulation Activity By '+titleHeader+' from '+startSentDate+ ' until '+endSentDate+ '\n',bold:true,fontSize:13,alignment: 'center'},
						                                   /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										//alert(csv_cell_array[1]);  +" from " +startSentDate + " unitl" +endSentDate
										
										return "Circulation Activity By "+titleHeader+ " from " +startSentDate + " unitl "+ endSentDate +"\n\n" + doc;
										//var split_csv = doc.split("\n");
