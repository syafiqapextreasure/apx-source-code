                ...
                /*'excel', 'pdf', 'print'*/
						{
					        ...
					        title: 'Circulation Notice By '+titleHeader,
							...
							//doc.content[1].table.body[0][3].alignment = 'right';
							 ...
							 //doc.content[1].table.body[0][5].alignment = 'right';
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Circulation Notice By '+titleHeader+' \n',bold:true,fontSize:13,alignment: 'center'},
						                                   /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					    ...
					    },
						{
					        ...
					        customize: function ( win ) {
							    ...
							    style = win.document.createElement('style');
							                ...
							                head.appendChild(style);
					 						...
					 						$(win.document.body).prepend( "<div class='center'><b>Circulation Notice By "+titleHeader+"</b></div>");
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Circulation Notice By "+titleHeader +"\n\n" + doc;
										//var split_csv = doc.split("\n");
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
		                ...
		                'Recall' : json[i].Column1,
		                'Overdue' : json[i].Column2,
		                'Reservation' : json[i].Column3,
		            })
		            }
