 ...
 *  com.wilmu.Global.DateTime
 *  com.wilmu.Global.Handler
 *  com.wilmu.Global.connection.DBConnection
 */
package com.wilmu;

import com.wilmu.GeneralUtility;
import com.wilmu.Global.DateTime;
import com.wilmu.Global.Handler;
import com.wilmu.Global.connection.DBConnection;
import com.wilmu.PatronSQL;
...
public class Patron {
        ...
        block12: {
            ...
            try {
                try {
                    ...
                    this.setMsMemDate(rsObj.getString("GL14MEMDATE"));
    ...
    public String getMsPatronName(String msPatronID) {
        try {
            try {
                ...
                rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    this.msPatronName = Handler.ifIsNull((String)rsObj.getString("GL14NAME"));
                }
            }
            catch (Exception e) {
                e.printStackTrace();
    ...
    public String getMsMemExpiryDate(String msPatronID) throws ParseException {
        boolean deletable;
        block12: {
            ...
            try {
                try {
                    ...
                    ResultSet rs = stmt.executeQuery(query);
                    while (rs.next()) {
                        this.msMemExpiryDate = DateTime.DBToDisplayFormat((String)String.valueOf(rsObj.getString("GL14EXPDATE")));
                    }
                }
                catch (SQLException e) {
                    e.printStackTrace();
    ...
    public static List<Patron> getPatronDetails(String msPatronID) throws SQLException {
        ...
        try {
            try {
                ...
                rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    Patron circ = new Patron(Patron.ifIntIsNull(rsObj.getString("GL14LOSTBOK")), Patron.ifIntIsNull(rsObj.getString("GL14SUSPEND")), GeneralUtility.StrToDate(rsObj.getString("GL14LASTBOR")), GeneralUtility.StrToDate(rsObj.getString("GL14LASTRET")));
                    PatronDetails.add(circ);
                }
            }
            catch (Exception e) {
    ...
    public static List<Patron> retrieveDischarging(String criteria, String searchType, String cate_id) throws SQLException {
        ...
        try {
            try {
                ...
                rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    Patron misc = new Patron(rsObj.getString("CI02DOCNO"), Handler.removeSubfield((String)rsObj.getString("CT05SRAW")));
                    patrMisc.add(misc);
                }
            }
            catch (Exception e) {
