						...
						<div id="search_vendor" class="panel-collapse collapse in">
							<div class="form-horizontal"
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<button type="button" name="searchVendor" id="searchVendor" class="btn btn-info searchVendor"> 
												<span class="glyphicon glyphicon-search"></span> Search
										</button>
										<button type="button" name="cancel" id="cancel" class="btn btn-info"  data-dismiss="modal"> 
												 Cancel
										</button>
									</div>
									<!-- <div class="col-xs-offset-1 col-xs-3 col-sm-offset-1 col-sm-2 col-md-offset-1 col-md-2">
										<button name="search" value="search" id="searchVendor"
