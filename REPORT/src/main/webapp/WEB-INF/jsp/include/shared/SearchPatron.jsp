	<%@ page import="com.wilmu.global.Patron, java.util.List"%>
		...
		%>
			<tr value="<%= i.getGL66DESC()%>" class="patrid" data-dismiss="modal">
				...
				<td>
					...
					%>
					<button title="" onclick="appendData('<%= i.getGL66DESC()%>','<%= i.getGL65VALUE()%>', '<%= action%>')" class="btn btn-sm btn-default" data-original-title="Select" data-dismiss="modal">
						<i class="fa fa-check"></i> Select
					</button>
					<%
						}
