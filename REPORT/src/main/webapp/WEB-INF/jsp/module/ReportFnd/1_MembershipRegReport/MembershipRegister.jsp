...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ReportFnd/membershipReport.js"></script>
	...
	<!-- START MAIN CONTENT -->
			<div class="box box-default">
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_membershipRegister">
						<form class="form-horizontal" name="membershipRegForm" id="membershipRegForm">
							<jsp:include page="../headerSearchCriteriaReportFND.jsp"></jsp:include> 
						</form>
