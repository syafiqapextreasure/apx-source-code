...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ListingCat/TitleListing.js"></script>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="cirActForm" id="cirActForm">
							<jsp:include page="../headerSearchTitleListing.jsp"></jsp:include> 
						</form>
