...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ListingCir/ExpiredReassignmentListing.js"></script>
			...
			<div class="box box-default">
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="expReassignListing" id="expReassignListing">
							<div class="form-group">
								<div class="col-sm-2 col-md-2">
									<label class="form-check-label">View By</label>
								</div>
								<div class='col-sm-7'>
									<label class="radio-inline">
								      <input type="radio" name="viewBy" value="iCate" checked>Item Category
								    </label>
								    <label class="radio-inline">
								      <input type="radio" name="viewBy" value="locaOrBranch">Location/Branch
								    </label>
								</div>	
							</div>
