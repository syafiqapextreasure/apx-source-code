...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ReportAcq/OrdersReport.js"></script>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="cirActForm" id="cirActForm">
							...
							<input type="hidden" class="vendorSelection" value = "r">
							...
							<div class="form-group">
								...
								<div class="col-sm-2 col-md-2">
									<label class="form-check-label">
										<input class="form-check-input" type="radio" name="chkBoxSearchCateria" id="chkBoxSearchCateria" value="orderNo">
										Order No 
									</label>
								</div>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<div class="col-sm-2 col-md-2">
									<label class="form-check-label">
										<input class="form-check-input" type="radio" name="chkBoxSearchCateria" id="chkBoxSearchCateria" value="orderMode">
										Order Mode
									</label>
								</div>
								<div class='col-sm-4'>
							...
							<div class="form-group">
								<div class="col-sm-2 col-md-2">
									<label class="form-check-label">
										<input class="form-check-input" type="radio" name="chkBoxSearchCateria" id="chkBoxSearchCateria" value="acct">
										Account
									</label>
								</div>
								<div class='col-sm-4'>
									<div class="form-check">
										<select class="form-control" id="acct" name="acct">
											<jsp:include page="../../Select_Account.jsp"></jsp:include> 
										</select>
									</div>
								</div>		
							</div>
							...
							<div class="form-group">
								<div class="col-sm-2 col-md-2">
									<input class="form-check-input" type="checkbox" value="orderDate" id="orderDate">
								  			<label class="form-check-label" for="orderDate">Order Date</label>
								</div>
								<div class="col-sm-4">
