...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ReportCir/ResvScrutiny.js"></script>
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="cirActForm" id="cirActForm">
							<div class="form-group">
								<div class="col-sm-2 col-md-2 datelabel"><label>Reservation Date Range</label></div>
									<div class="col-sm-4">
