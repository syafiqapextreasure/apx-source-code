...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ReportCir/cirActBySubj.js"></script>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
							...
							<div class="form-group">
								<div class="col-sm-2 col-md-2">
									<label class="form-check-label">
										<input class="form-check-input" type="checkbox" name="chkBoxSearchCateria" id="chkBoxSearchCateria" value="brnchCheckbox">
										Branch
									</label></div>
									<div class='col-sm-6'>
						...
						<table id="reportTable" class="table table-bordered table-striped">
						 ...
						 <tfoot align="right">
							<tr><th></th><th>Total</th><th></th><th></th><th></th><th></th></tr>
						</tfoot>
						</table>
					</div>
				</div>
