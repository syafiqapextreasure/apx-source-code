...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ReportCir/cirActivity2.js"></script>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="cirActForm" id="cirActForm">
							<jsp:include page="../headerSearchCriteriaReportCirPATR.jsp"></jsp:include>
							...
							<!-- <div class="form-group unReturn">
								<div class="col-sm-2 col-md-2">
									<label> <input type="checkbox" id="unReturn" name="unReturn" value="Y"> Unreturn
									</label>
								</div>
							</div> -->
						</form>
