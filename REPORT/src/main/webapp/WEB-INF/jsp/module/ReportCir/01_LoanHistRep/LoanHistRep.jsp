...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ReportCir/LoanHistRep.js"></script>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						...
						<div class="form-group">
							<div class="col-sm-2 col-md-2 datelabel"><label>Loan Date Range</label></div>
								<div class="col-sm-4">
			...
			<div class='col-sm-4'>
				<div class="form-check">
					<select id="icat" multiple="multiple" name="icat">
						<jsp:include page="../../Select_Icat.jsp"></jsp:include> 
					</select>
				</div>
			</div>
						...
						<table id="reportTable" class="table table-bordered table-striped">
						 <thead>
						 	<tr>
								...
								<th>Item Category</th>
								<th>SMD</th>
								<th>No of Times Charged</th>
						 	</tr>
						 </thead>
						 <tfoot align="right">
							<tr><th></th><th>Grand Total</th><th></th><th></th><th></th><th></th><th></th><th></th></tr>
						</tfoot> 
						</table>
					</div>
				</div>
