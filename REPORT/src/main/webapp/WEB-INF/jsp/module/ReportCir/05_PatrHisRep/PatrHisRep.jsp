...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ReportCir/PatrHisRep.js"></script>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="cirActForm" id="cirActForm">
							...
							<div class="form-group">
								<div class="col-sm-2 col-md-2">
									<label class="form-check-label">
											<input class="form-check-input" type="radio" name="chkDate" id="chkBoxLoan" value="L" checked>
											Loan Date Range
										</label>
									</div>
									<div class="col-sm-2 col-md-2">
										<label class="form-check-label">
											<input class="form-check-input" type="radio" name="chkDate" id="chkBoxReturn" value="R">
											Return Date Range
										</label>
									</div>
									<div class="col-sm-2 col-md-2">
										<label class="form-check-label">
											<input class="form-check-input" type="radio" name="chkDate" id="chkBoxDue" value="D">
											Due Date Range
										</label>
									</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-2 col-md-2">
									<input class="form-check-input" type="checkbox" value="status" id="chkStatuslabel" name="chkStatuslabel">
								  			<label class="form-check-label" for="chkStatus">Status</label>
								</div>
								<div class="col-sm-2 col-md-2">
									<label class="form-check-label">
										<input class="form-check-input" type="radio" name="chkStatus" id="chkBoxCharge" value="C">
										Charged
									</label>
								</div>
								<div class="col-sm-2 col-md-2">
									<label class="form-check-label">
										<input class="form-check-input" type="radio" name="chkStatus" id="chkBoxDischarged" value="D">
										Discharged
									</label>
								</div>
