...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ReportCir/LostItemNotification.js"></script>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="cirActForm" id="cirActForm">
							<jsp:include page="../headerSearchCriteriaLostItemNotification.jsp"></jsp:include> 
						</form>
...
<!-- 
						<div class="col-md-12">
							...
							<div class="col-md-3">
								<button type="button" id="retrieveBtn"
