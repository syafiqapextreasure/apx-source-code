	...
	<br>
		<div class="form-group">
			...
			<div class="col-sm-2 col-md-2 datelabel">
				<label class="form-check-label">
					<input class="form-check-input" type="radio" name="chkBoxSearchCateria2" id="chkBoxSearchCateria" value="date">
					Date Range
				</label>
			</div>
				<div class="col-sm-4">
		...
		<div class="form-group">
			<!-- <div class="col-sm-2 col-md-2"><label>Accession Range</label></div> -->
			<div class="col-sm-2 col-md-2">
				<label class="form-check-label">
					<input class="form-check-input" type="radio" name="chkBoxSearchCateria2" id="chkBoxSearchCateria" value="accno">
					Accession Range
				</label>
			</div>
				<div class="col-sm-4">
					<div class="input-group">
						<input type="text" class="input-sm form-control"  name="startAcc"
							id="input-startAcc" autocomplete="off"/> <span class="input-group-addon">to</span>
						<input type="text" class="input-sm form-control" name="endAcc" id="input-endAcc" autocomplete="off"/>
					</div>
				</div>
		</div>
		...
		<div class="form-group">
			<div class="col-sm-2 col-md-2">
				<label class="form-check-label">
					<input class="form-check-input" type="radio" name="chkBoxMissOrLost" id="chkBoxMiss" value="M">
					Missing Item
				</label>
			</div>
			<div class="col-sm-2 col-md-2">
				<label class="form-check-label">
					<input class="form-check-input" type="radio" name="chkBoxMissOrLost" id="chkBoxLost" value="L">
					Lost Item
				</label>
			</div>
		</div>
