	...
	<br>
		...
		<div class="form-group">
			...
			<div class="col-sm-2 col-md-2">
				<!-- <label class="form-check-label">
					<input class="form-check-input" type="checkbox" name="chkBoxSearchCateria" id="chkBoxSearchCateria" value="itemcate">
					Item Category
				</label> -->
				
				<div class="form-check">
					<input class="form-check-input" type="checkbox" value="itemcate" id="chkitemcate">
					<label class="form-check-label" for="chkitemcate">Item Category</label>
				</div>
			</div>
			<div class='col-sm-4'>
				<div class="form-check">
			...
			<div class="col-sm-2 col-md-2">
				<!-- <label class="form-check-label">
					<input class="form-check-input" type="checkbox" name="chkBoxSearchCateria" id="chkBoxSearchCateria" value="loca">
					Location
				</label> -->
				
				<input class="form-check-input" type="checkbox" value="loca" id="chkloca">
				<label class="form-check-label" for="chkloca">Location</label>
			</div>
			<div class='col-sm-4'>
				<div class="form-check">
		...
		<div class="form-group">
			<div class="col-sm-2 col-md-2">
				<!-- <label class="form-check-label">
					<input class="form-check-input" type="checkbox" name="chkBoxSearchCateria" id="chkBoxSearchCateria" value="smd">
					SMD
				</label> -->
				<input class="form-check-input" type="checkbox" value="smd" id="chksmd">
				<label class="form-check-label" for="chksmd">SMD</label>
			</div>
			<div class='col-sm-4'>
				<div class="form-check">
			...
			<div class="col-sm-2 col-md-2 patronCategory">
				<!-- <label class="form-check-label">
					<input class="form-check-input" type="checkbox" name="chkBoxSearchCateria" id="chkBoxSearchCateria" value="pateCate">
					Patron Category
				</label> -->
				<input class="form-check-input" type="checkbox" value="pateCate" id="chkpateCate">
				<label class="form-check-label" for="chkpateCate">Patron Category</label>
			</div>
