...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Listing/auditTrail.js"></script>
			...
			<div class="box box-default">
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="auditTrailForm" id="auditTrailForm">
						
						<%  String test = request.getParameter("value");	System.out.println("qwerty"+test);%>
						
							<div class="form-group">
								<div class="col-sm-2 col-md-2 datelabel"><label>Activity Date Range</label></div>
									<div class="col-sm-4">
							...
							<div class="form-group">
								<div class="col-sm-2 col-md-2"><label>Activity Code</label></div>
									<div class='col-sm-6'>
										<div class="form-check">
											<select id="actCode" multiple="multiple" name="actCode">
													<jsp:include page="../../../module/Select_AuditTrailCir.jsp">
														<jsp:param name="auditTrailBy" value="<%=test%>"  />
													</jsp:include> 
											</select>
										</div>
									</div>	
