...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ListingFnd/PatronDetails.js"></script>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body" id="display_cirAct">
						<form class="form-horizontal" name="cirActForm" id="cirActForm">
							...
							<div class="col-sm-2 col-md-2 patronCategory">
								<label class="form-check-label">
									<input class="form-check-input" type="checkbox" name="chkBoxSearchCateria2" id="chkBoxSearchCateria2" value="branchChecked">
									Branch
								</label>
							</div>
							<div class='col-sm-4 patronCategory'>
