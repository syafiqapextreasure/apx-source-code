$(document).ready(function() {
	...
	$(".datelabel").html("<b>Notice Date Range</b>");//.text("Notice Date Range");
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
                /*'excel', 'pdf', 'print'*/
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_CirNotice',
					        title: 'Circulation Notice By '+titleHeader +sDate + " until " +eDate,
					 	...
					 	},
						{
							...
							//doc.content[1].table.body[0][3].alignment = 'right';
							 doc.content[1].table.widths = [ '8%', '50%', '12%', '12%', '17%']; 
							 //doc.content[1].table.body[0][5].alignment = 'right';
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Circulation Notice By '+titleHeader +sDate+ ' until '+eDate+ '\n',bold:true,fontSize:13,alignment: 'center'},
						                                   /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Circulation Notice By "+titleHeader +sDate + " until "+ eDate +"\n\n" + doc;
										//var split_csv = doc.split("\n");
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
		                ...
		                'Recall' : json[i].Column3,
		                'Overdue' : json[i].Column2,
		                'Reservation' : json[i].Column1,
		            })
		            }
		     	...
		     	columns    : [
					{'data': 'No'},
					{'data': 'Description'},
					{'data': 'Recall', className: "text-right"},
					{'data': 'Overdue', className: "text-right"},
					{'data': 'Reservation', className: "text-right"},
