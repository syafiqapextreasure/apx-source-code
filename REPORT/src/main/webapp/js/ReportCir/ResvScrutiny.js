		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
                /*'excel', 'pdf', 'print'*/
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_ReservationScrutiny',
					        title: 'Reservation Scrutiny Report ',
					 	...
					 	},
						{
							...
							//doc.content[1].table.body[0][3].alignment = 'right';
							 ...
							 //doc.content[1].table.body[0][5].alignment = 'right';
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Reservation Scrutiny Report '+' \n',bold:true,fontSize:13,alignment: 'center'},
						                                   /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Reservation Scrutiny Report " +"\n\n" + doc;
										//var split_csv = doc.split("\n");
		    ...
		    ajax: {
		        ...
		        dataSrc: function (json) {
					...
					/*if(title.charAt(0)=='*'){
		              ...
		              return_data.push({
		                'No': (i+1),
		                'Patron' : json[i].Column1,
		                'Status' : json[i].Column2,
		                'Reserve Date' : json[i].Column4,
		                'Reserve Time' : json[i].Column5,
						'Priority' : json[i].Column7,
		                'Title' : title,
						'Branch' : json[i].Column3,						
		            })
		            }
