		...
		var t = $('#membershipTable').DataTable( {
			...
			buttons: [
				 /*'excel', 'pdf', 'print'*/
				{
					...
					title: 'Statistics Preview '+startSentDate + " until "
				...
				},
				{
							...
							// doc.content[1].table.widths = [ '8%', '55%', '12%', '12%', '12%']; 
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Statistics Preview '+startSentDate + ' until ' +endSentDate +" " +patrStatByTest+' \n',bold:true,fontSize:13,alignment: 'center'},
					    ...
					    },
						{
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Statistics Preview "+startSentDate + " until " +endSentDate +" "+ patrStatByTest +"\n\n" + doc;
										//var split_csv = doc.split("\n");
