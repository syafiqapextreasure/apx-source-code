$(document).ready(function() {
       ...
       $(".datelabel").html("<b>Discharge Date Range</b>");
...
*/
			...
			var columnDefs = [
			    {'data': 'No'},
                                  ...
                                  {'data': 'Due Date'},
                                  {'data': 'Return Date'},
                                  {'data': 'Copy No', className: "text-right"},
			];
            ...
            buttons: [
                /*'excel', 'pdf', 'print'*/
                                         {
                                                extend: 'excelHtml5',
                                          filename: 'WILMU_ItemDisRep',
                                          title: 'Item Discharging Report By '+titleHeader +sDate + " until " +eDate,
                                         ...
                                         text: '<i class="fa fa-file-pdf-o"></i> PDF',
                                                ...
                                                doc.content[1].table.widths = [ '3%', '6%', '20%', '10%', '6%', '6%','6%','6%','6%','6%','5%','7%','7%', '3%','3%'];  
                                                 //doc.content[1].table.body[0][5].alignment = 'right';
                                                                 ...
                                                                 text: [
                                                                            { text: 'Item Discharging Report By '+titleHeader +sDate+ ' until '+eDate+ ' \n',bold:true,fontSize:13,alignment: 'center'},
                                                                            /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
                                                                 ],
                                                                 margin: [0, 0, 0, 12],
                                                             });
                                  ...
                                  title: 'Item Discharging Report ',
                                                customize: function(doc){
                                                                     ...
                                                                     return "Item Discharging Report By "+titleHeader +sDate + " until "+ eDate +"\n\n" + doc;
                                                                     //var split_csv = doc.split("\n");
                          ...
                          for(var i=0;i< json.length; i++){
                            ...
                            return_data.push({
                              ...
                              'Call No' : callno,
                                         ...
                                         'Location' : json[i].Column5,
                                         'Item Category' : json[i].Column6,
                                         'SMD' : json[i].Column7,
                              'Membership ID/Name' : json[i].Column8,                                
                                         'Patron Category' : json[i].Column9,
										 'Loan Type' : json[i].Column10,
                                         'Borrow Date' : json[i].Column11,
                                          'Due Date' : json[i].Column2 !=null && json[i].Column12!=""?json[i].Column12.substring(6, 8)+"/"+json[i].Column12.substring(4, 6)+"/"+json[i].Column12.substring(0, 4):json[i].Column12,
                                         'Return Date' : json[i].Column13 !=null && json[i].Column13!=""?json[i].Column13.substring(6, 8)+"/"+json[i].Column13.substring(4, 6)+"/"+ json[i].Column13.substring(0, 4):json[i].Column13,
                                         'Copy No' : json[i].Column14,
                          })
                          }
