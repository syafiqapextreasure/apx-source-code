$(document).ready(function() {
	...
	$('##vendor, #account, #ordermode').multiselect({
    	allSelectedText: 'All',
   		maxHeight: 200,
   		includeSelectAllOption: true
	});
	
	$("#vendor, #ordermode").multiselect("disable");
	...
	$('#Reterive').click(function(){
		...
		//	searchCateriaval = $('#patronCate').val();
		  ...
		  case 'vendor':
		    ...
		    break;
		  case 'ordermode':
			searchCateriaval = $('#ordermode').val();
...
*/
		...
		var t = $('#reportTable').DataTable( {
			...
			//		var isbn = json[i].Column6;		

			//		var author = json[i].Column7;		
		     	...
		     	columns    : [
					{'data': 'No'},
					{'data': 'Invoice No'},
					{'data': 'Inv Created Date'},
					{'data': 'Account'},					
					{'data': 'Order No'},
					{'data': 'Order Mode'},
					{'data': 'Vendor'},
					{'data': 'Payment Ref No'},
					{'data': 'Payment Req Date'},
					{'data': 'Payment Rec Date'},
					{'data': 'Amount'},
