$(document).ready(function() {
	...
	//$(".memdate, .branch, .patrStatnCate").hide();
		...
		var t = $('#membershipTable').DataTable( {
			...
			buttons: [
				 /*'excel', 'pdf', 'print'*/
				{
					...
					title: 'Statistics Preview'+sDate + " until "
						+eDate +" " +patrStatByTest,
				...
				},
				{
							...
							// doc.content[1].table.widths = [ '8%', '55%', '12%', '12%', '12%']; 
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Statistics Preview '+sDate + ' until ' +eDate +" " +patrStatByTest+' \n',bold:true,fontSize:13,alignment: 'center'},
					    ...
					    },
               			{
							...
							customize: function(doc){
										...
										return "Statistics Preview "+sDate + " until " +eDate +" "+ patrStatByTest +"\n\n" + doc;
										//var split_csv = doc.split("\n");
