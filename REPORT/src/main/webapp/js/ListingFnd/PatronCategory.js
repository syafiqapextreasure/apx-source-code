	...
	$('#Reterive').click(function(){
		...
		var t = $('#foundationTable').DataTable( {
			...
			buttons: [
				...
				{
					extend: 'excelHtml5',
					filename: 'WILMU_PatronCategoryListing',
					title: 'Patron Category Listing  ',
				...
				},
				{
							...
							customize: function (doc) {
							 ...
							 doc.content[1].table.widths = [ '8%', '12%', '40%', '12%', '12%', '12%']; 
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Patron Category Listing',bold:true,fontSize:13,alignment: 'center'},
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Patron Category Listing  \n\n" + doc;
										//var split_csv = doc.split("\n");
        ...
        processing: "Loading. Please wait..."
		    ...
		    ajax: {
		    	url: "ResultPatronCategoryListing",
		       /* data : {startSentDate : startSentDate, endSentDate : endSentDate, 
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
		                'No': (i+1),
		                'Patron Category' : json[i].Id,
		                'Description' : json[i].Desc,
		                'Max Loan' : json[i].Column1,
		                'Max Fines' : json[i].Column2,
						'Fines Limit' : json[i].Column3,
		            })
		            }
		     	...
		     	columns    : [
					...
					{'data': 'Description'},
					{'data': 'Max Loan', className: "text-right"},
					{'data': 'Max Fines', className: "text-right"},
					{'data': 'Fines Limit', className: "text-right"},
				],
				//order: [[ 1, 'asc' ]],
