$(document).ready(function() {
	...
	$(".datelabel").html("<b>Due Date Range</b>");
                ...
                /*'excel', 'pdf', 'print'*/
						{
					        ...
					        title: 'Due Item Listing '+titleHeader +" from " +sDate + " unitl " +eDate,
					 	...
					 	},
						{
						   ...
						   //doc.content[1].table.widths = [ '3%', '10%', '20%', '7%', '7%','7%','7%','7%','7%','9%','8%','8%'];  
							 //doc.content[1].table.body[0][5].alignment = 'right';
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Due Item Listing '+titleHeader+' from '+sDate+ ' until '+eDate+ ' \n',bold:true,fontSize:13,alignment: 'center'},
						                                   /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Due Item Listing "+titleHeader+ " from " +sDate + " unitl "+ eDate +"\n\n" + doc;
										//var split_csv = doc.split("\n");
