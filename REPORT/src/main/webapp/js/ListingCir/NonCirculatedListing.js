$(document).ready(function() {
	...
	$(".datelabel").html("<b>Accession Date Range</b>");
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
                /*'excel', 'pdf', 'print'*/
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_NonCirculatedListing',
					        title: 'Non-Circulated Listing By '+titleHeader +sDate + " until " +eDate,
						...
						//doc.content[1].table.widths = [ '5%', '13%', '7%', '7%', '40%', '8%', '8%', '7%']; 
							 //doc.content[1].table.body[0][5].alignment = 'right';
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Non-Circulated Listing By  '+titleHeader +sDate+ ' until '+eDate+ ' \n',bold:true,fontSize:13,alignment: 'center'},
						                                   /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
		                	extend: 'csv',
		                	filename: 'WILMU_NonCirculatedListing',
		                	title: 'Non-Circulated Item Listing ',
							customize: function(doc){
										...
										return "Non-Circulated Listing By  "+titleHeader +sDate + " until "+ eDate +"\n\n" + doc;
										//var split_csv = doc.split("\n");
			...
			footer: true,
		    ajax: {
		    	url: "ResultNonCirculatedListing",
		        ...
		        dataSrc: function (json) {
					...
					if(title!=undefined){
		              ...
		              return_data.push({
						...
						'Last Circulated Date' : json[i].Column7,
		            })
		            }
