$(document).ready(function() {
	...
	$(".datelabel").html("<b>Hold Date Range</b>");
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
                /*'excel', 'pdf', 'print'*/
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_OnHoldItemListing',
					        title: 'On Hold Item Listing By '+titleHeader +sDate + " until " +eDate,
					 	...
					 	},
						{
						   ...
						   //doc.content[1].table.widths = [ '3%', '10%', '20%', '7%', '7%','7%','7%','7%','7%','9%','8%','8%'];  
							 //doc.content[1].table.body[0][5].alignment = 'right';
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'On Hold Item Listing By '+titleHeader +sDate+ ' until '+eDate+ ' \n',bold:true,fontSize:13,alignment: 'center'},
						                                   /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										return "On Hold Item Listing By "+titleHeader +sDate + " until "+ eDate +"\n\n" + doc;
										//var split_csv = doc.split("\n");
		        ...
		        dataSrc: function (json) {
					...
					if(title!=undefined){
		              ...
		              return_data.push({
						...
						'Hold Date' : json[i].Column2,
						'Reserve Date' : json[i].Column3,
		                'Title' : title,
		                'Call No' : callno,
