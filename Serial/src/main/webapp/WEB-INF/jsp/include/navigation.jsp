        ...
        <section class="sidebar">
		  ...
		  <ul class="nav side-menu">
				<li class="header">MAIN NAVIGATION</li>
										<li>
											<a href="template?MODULE=Serial/02_Order_Maintenance&ACTION=OrderEntry.jsp"><i class="glyphicon glyphicon-home"></i> Home <i class="fa fa-angle-left pull-right"></i></a>
										</li>
                                          <li class="treeview"> 	 
                                        <a><i class="glyphicon glyphicon-wrench"></i> Maintenance <i class="fa fa-angle-left pull-right"></i></a>
			                             ...
			                             <li><i class="fa fa-angle-left pull-right"></i><a href="template?MODULE=Circulation/03_Reservation_Scrutiny&ACTION=Main_Page.jsp"><i class="fa fa-circle-o text-red"></i>Reservation Scrutiny</a>
                                        </li>
                                         <li><i class="fa fa-angle-left pull-right"></i><a href="template?MODULE=Circulation/04_Weeding&ACTION=Main_Page.jsp"><i class="fa fa-circle-o text-red"></i>Bibliographic Organisation</a></li>
