...
<%
	...
	String CT03DOCNO = request.getParameter("CT03DOCNO");
		...
		CT02LEADER = BO_Record.getLeader(CT03DOCNO);
		Weeding CTMATM = Weeding.getCTMATM(CT03DOCNO);
...
<%request.setCharacterEncoding("UTF-8"); %>
	<%
		...
		tableName = BO_Record.getBORecord(CT03DOCNO);
		

		for(BO_Record j: tableName)
		{

			searchResult = BO_Record.getAllBy(CT03DOCNO, j.getCT06TAG(),j.getGL17TABNAME(), j.getCT06POINTER());
