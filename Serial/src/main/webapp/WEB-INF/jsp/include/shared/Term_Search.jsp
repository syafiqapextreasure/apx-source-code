...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/general/Term_Search.js"></script>	
	...
	<div class="modal-header">
		<button type="button" class="close termSearch" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8 col-md-8">
										...
										<input type="button" name="cancel" value="Cancel" class="btn btn-info termSearch"/>
									</div>
								</div>
							</form>
						</div>
