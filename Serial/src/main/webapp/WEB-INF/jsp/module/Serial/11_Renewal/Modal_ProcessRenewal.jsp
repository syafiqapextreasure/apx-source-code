...
<div class="modal-footer">
  	<button type="submit" id="renewBtn" class="btn btn-primary" onClick="renew()" disabled>OK</button>
	<button type="button" id="cancelRenew" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
</div>
