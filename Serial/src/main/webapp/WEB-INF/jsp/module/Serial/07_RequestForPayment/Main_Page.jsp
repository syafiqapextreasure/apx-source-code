...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/Serial/RequestForPayment.js"></script>					
...
<!-- 												<div class="form-group row">
												...
												<div class="col-sm-5 searchInput">
													<div class="input-group">
													    <input type="text" class="form-control" maxlength="10" id="invoicedate1" readonly="readonly"/>
													    	<span class="input-group-addon">to</span>
													    <input type="text" class="form-control" maxlength="10" id="invoicedate2" readonly="readonly"/>
													</div>
												</div>
...
<!-- 										<div class="form-group row">
										    <label class="col-sm-2">
										        <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" value="orderno">
										      	Order No
										      </label>	
										      <div class="col-sm-3">
										...
										<div class="form-group row">
										    <label class="col-sm-2">
										      ...
										      <div class="col-sm-3">
										        <input type="text" class="form-control" id="referenceno" maxlength="10">
										      </div>	    
										</div>
										...
										<div class="form-group row">
										    <label class="col-sm-2">&nbsp;</label>	
										     <label class="col-sm-4">
													 <input class="form-check-input" type="checkbox" name="criteria" id="groupdetails" value="date" onchange="groupDetails()">
													Group the details of order and allow selection
												</label>    
										</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<div class="form-group row">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" id="paymentreference" maxlength="15">											
										     </div>
										     <label class="col-sm-4">
		...
		<div class="panel-group" id="accordion" role="tablist"
			...
			<div class="panel-body" id="cancel_orderList">
				<table class="table table-bordered" id="orderingList" style="font-size:10pt">
					<thead>
						<tr>
							<th data-sortable="true" class="groupList" style="text-align: center;width:5px">No.</th>
							<th data-sortable="true" class="groupList" style="text-align: center;width:10px">Print</th>
							<th data-sortable="true" style="text-align: center;width:10px">Vendor</th>
							<th data-sortable="true" class="requestList" style="text-align: center;width:100px">Reference No</th>
							<th data-sortable="true" class="requestList" style="text-align: center;width:100px">Order No</th>
							<th data-sortable="true" class="requestList" style="text-align: center;width:200px">Title</th>
