										...
										<!-- <div class="form-group row">
									    	...
									    	<div class="form-group row">
												<label for="Date" class="col-sm-5 col-form-label">
													 <input class="form-check-input" type="radio" name="optionsRadios" id="inlineRadiocharge" value="expiredate" onchange="change()">
													 Expired orders from
												</label>
												...
												<div class="form-group row">
												<label for="Date" class="col-sm-5 col-form-label">
													 <input class="form-check-input" type="radio" name="optionsRadios" id="inlineRadiocharge" value="expirectrlno" onchange="change()">
													 Expired orders with control no.
												</label>
												<div class="col-sm-7 searchInput">
													<div class="input-group">
													    <input type="text" class="form-control" maxlength="10" id="ctrlno"/>
													</div>
												</div>
...
<!-- 								<button type="button" class="btn btn-primary" id="orderbtn" data-placement="bottom" title="Order List" onclick="previewOrder()" title="Order List" disabled><span class="glyphicon glyphicon-sort-by-attributes" style="color:white"></span></button> -->
								<!-- <button type="button" class="btn btn-primary" id="previewbtn" data-placement="bottom" title="Preview" onclick="preview()" title="Preview" disabled><span class="glyphicon glyphicon-eye-open" style="color:white"></span></button>
								 --><a class="btn btn-primary" id='printRenew' data-toggle='modal' data-placement="bottom" title="Process" onclick="printRenew()"><span class="glyphicon glyphicon-hourglass" style="color:white" ></span></a>
					</div>
				</div>
				 <div id="search" class="panel-collapse collapse in">
				...
				<table class="table table-bordered" id="orderingList" style="font-size:10pt">
					<thead>
						<tr>
							...
							<th data-sortable="true" style="text-align: center;">Standing order ref.</th>
						</tr>
					</thead>
					 <tbody id="OrderList">
		...
		<div class="modal fade" id="fundDistribution" role="dialog"  data-backdrop="static">
				...
				<div class="modal fade" id="prediction" class="prediction" role="dialog"  data-backdrop="static">
				    <div class="modal-dialog modal-lg">
						  <div class="modal-content" id="predictionContent">
						  <!-- Remote content load here -->
						  </div>
					</div>
				</div>
				    ...
				    <div class="modal-dialog"  style="width:50%;">
					  <div class="modal-content" id="processContents">
						  <!-- Remote content load here -->
						  </div>
					</div>
				</div>
