   ...
   /* 	function updateCurrency(){
	...
	var publisherRate = document.getElementById('pubRate');
   	...
   	$('#btn-update').click(function(){
   		var url = "Handler_EditSerialMaster?controlNo=" + $('#controlNo').val() +
   				"&smd=" + $('#smd').val() +
   		...
   		$.ajax({
   			...
   			success: function(result) {
  				...
  				if(updateRecord == "ok"){
  				  swal('', $('#controlNo').val()+ ' has been updated.','success');
  					$('#editPeriodicalsMaster').modal('hide');
  					showAll();
  				}else{
  					swal('',"Please fill up the necessary details.","warning");
  				}
  			}
   		});
   	});
		...
		<div class="panel-body">
			<form role="form" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select class="form-control" id="smd" name="smd">
								...
								%>
									...
									<%if(e.getCode().equals(selectListCode.getSMD())){%>
											 selected
										<%}%>
											><%=e.getDesc()%></option>
								<%
					...
					<div class="col-sm-4">
						<select class="form-control currency" id="currency" name="currency" onchange="updateCurrency();" onblur="updateLocalPrice();updateForeignPrice()" required>
								<option value="0">Please Select</option>
								<%
								...
								%>
									<option value="<%=e.getCode()%>" 
									<%if(e.getCode().equals(currControlNo.getCurrency())){%>
											 selected
										<%}%>
											data-pub="<%=e.getPubRate()%>" data-bank="<%=e.getBankRate()%>"><%=e.getDesc()%></option>
								<%
									}
								%>
						</select>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<option value="0">Please Select</option>
								...
								%>
									<option value="<%=e.getCode()%>" 
									<%if(e.getCode().equals(selectListCode.getLanguage())){%>
											 selected
										<%}%>><%=e.getDesc()%></option>
								<%
									}
					...
					<div class="col-sm-2">
						<input type="text" class="form-control validate-double CT03RATE" id="pubRate" name="pubRate" onkeyup="updateBoth()"
							value="<% if(currControlNo != null){out.println(Handler.format2Decimal(currControlNo.getExchRate()));} %>">
					</div> 
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<option value="0">Please Select</option>
								...
								%>
											<option value="<%=e.getCode()%>" 
									<%if(e.getCode().equals(selectListCode.getDepartment())){%>
											 selected
										<%}%>><%=e.getDesc()%></option>
								<%
									}
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<option value="0">Please Select</option>
								...
								%>
									<option value="<%=e.getCode()%>" 
									<%if(e.getCode().equals(selectListCode.getFrequency())){%>
											 selected
										<%}%>><%=e.getDesc()%></option>
								<%
									}
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="div-vendorName"><% if(currControlNo != null){out.println(currControlNo.getVendorName());} %></div>
					</div>
				</div>
					...
					<div class="col-sm-4">
						...
						<option value="0">Please Select</option>
							<%
								...
								%>
									<option value="<%=e.getCode()%>" 
									<%if(e.getCode().equals(selectListCode.getBibliographic())){%>
											 selected
										<%}%>><%=e.getDesc()%></option>
								<%
									}
					...
					<div class="col-sm-4">
						...
						<option value="0">Please Select</option>
							<%
								...
								%>
									<option value="<%=e.getCode()%>" 
									<%if(e.getCode().equals(selectListCode.getSerialMode())){%>
											 selected
										<%}%>><%=e.getDesc()%></option>
								<%
									}
