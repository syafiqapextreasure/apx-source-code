...
public class MalayNumberToWords {
    ...
    private static String convertLessThanOneThousand(int number) {
        ...
        return String.valueOf(numNames[number]) + " RATUS " + soFar;
    }
    ...
    public static String convert(long number) {
        ...
        switch (billions) {
            ...
            case 1: {
                tradBillions = String.valueOf(MalayNumberToWords.convertLessThanOneThousand(billions)) + " billion ";
                break;
            }
            default: {
                tradBillions = String.valueOf(MalayNumberToWords.convertLessThanOneThousand(billions)) + " billion ";
        ...
        switch (millions) {
            ...
            case 1: {
                tradMillions = String.valueOf(MalayNumberToWords.convertLessThanOneThousand(millions)) + " MILLION ";
                break;
            }
            default: {
                tradMillions = String.valueOf(MalayNumberToWords.convertLessThanOneThousand(millions)) + " MILLION ";
        ...
        switch (hundredThousands) {
            ...
            default: {
                tradHundredThousands = String.valueOf(MalayNumberToWords.convertLessThanOneThousand(hundredThousands)) + " RIBU ";
            }
        }
        result = String.valueOf(result) + tradHundredThousands;
        String tradThousand = MalayNumberToWords.convertLessThanOneThousand(thousands);
