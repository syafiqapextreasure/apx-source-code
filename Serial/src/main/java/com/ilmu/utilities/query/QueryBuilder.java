...
public class QueryBuilder {
    ...
    public static String createInsertQuery(String table, Map<String, String> map, Map<String, Integer> intMap, Map<String, Double> doubleMap) {
        ...
        String columnDouble = "";
        String valueDouble = "";
        if (table.equals("CTWORK") || table.equals("CTSUBJ") || table.equals("CTAUTH") || table.equals("CTCALL") || table.equals("CTINDX") || table.equals("CTPUBL") || table.equals("CTSERI") || table.equals("CTTITL")) {
            if (map != null) {
                it = map.entrySet().iterator();
                while (it.hasNext()) {
                    pair = it.next();
            ...
            while (it.hasNext()) {
                ...
                value = ((String)pair.getValue()).isEmpty() && pair.getValue() == null ? String.valueOf(value) + null : String.valueOf(value) + "'" + (String)pair.getValue() + "'";
                if (!it.hasNext()) continue;
                column = String.valueOf(column) + ", ";
                value = String.valueOf(value) + ", ";
            }
