...
$('#titleSearch').on('shown.bs.modal', function () {
	//By default index is checked
		$("#retrieveBO input[type=radio][value=index]").prop("checked",true);
		
		//By default selection is checked
		$("#retrieveBO input[type=radio][value=selection]").prop("checked",true);
  ...
  $('input:radio').click(function(){
	  alert("sssss");
		...
		function getURL(identifier){
			...
			var searchType = $("#retrieveBO input[name='searchSelection']:checked").val();
			...
			//alert("title" +title);
			 if(searchType=="selection"){
					var title = $('#retrieveBO .criteria').val();
					var searchType = $('#retrieveBO #search_type').val();
					/*loader("#div-result");*/
