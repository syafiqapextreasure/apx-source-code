			 ...
			 if(dataCss!=null){
				...
				for(Config_Print property : patrProperty){
					...
					if((property.getLB02PROPERTY()).equals("FORMAT")){
						//System.out.println(property.getLBL02VALUE()+"property.getLB02PROPERTY())");
						format.add(property.getLBL02VALUE());
						//dataCss += "content: '"+property.getLBL02VALUE()+"';";
					}
				}
				
				dataCss += "visibility: visible;"; 
				dataCss += "position:absolute;";
				//dataCss += "content: 'fdgdg'";
				...
				System.out.println(dataCss+"property.getLB02PROPERTY())");
