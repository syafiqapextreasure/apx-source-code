		        ...
		        %>
		        	...
		        	<% 
		        	  ...
		        	  for (int cols=0;cols<Integer.parseInt(lCols); cols++){
						...
						<div class = "text-center" style=" line-height: 1.0;font-style=:Times New Roman; margin-top: 5px; padding-right: 1.1cm; font-weight: bold"  align="center">		        			<% 	
		        				...
		        				if(styletype.equalsIgnoreCase("L")){
		        					...
		        					System.out.println("book_spine.getSpineItemCategory()"+book_spine.getSpineItemCategory());
		        					System.out.println("book_spine.getSpineSMD()"+book_spine.getSpineSMD());
		        					System.out.println("book_spine.callno"+callno);
		        					System.out.println("book_spine.getVolume()"+book_spine.getVolume());
		        					System.out.println("book_spine.getCopyNo()"+book_spine.getCopyNo());
		        					System.out.println("book_spine.getPartNo()"+book_spine.getPartNo());
		        					
		        					System.out.println("UserDefineSpine"+book_spine.getUserDefineSpine());
									...
									if (book_spine.getUserDefineSpine() == null) {
										...
										call_no = generalUtil.LLCSplitTestSpineuserDefineSpine(book_spine.getUserDefineSpine());
		        					...
		        					System.out.println("dsfss"+call_no);
		        				}
