...
<%--     <!-- Bootstrap core CSS -->
    <link rel="stylesheet" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css">
<!-- 	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"> -->
 	<link rel="stylesheet" href="<%= request.getContextPath() %>/plugins/bootstrap-3.3.7/css/bootstrap.min.css">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Spine Label Search By Accession Range</a>
    </nav>
 ...
 <!--          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Search by Accession Range</h1>                   
          </div>
           -->
           
 			<form:form action="searchResult" method="post" style=" margin-left: 50px;">
                
                    <div class="row">
                    	<div class="col-sm-12" style="height:950px; margin-left: 250px;">
                        
                        <input type="hidden" name="codeList" value="accessionRange">
                                              
                        <div style='display:inline;' id='firstInput'>
                        	<br><h5 id='fromtext'>From: &nbsp;</h5> 
                        	<input type="text" name="inputVal" required style="width:50%">
                        </div>
                        
                        <div id='secondInput'>
                        	<br><h5>To: &nbsp;</h5> 
                        	<input type='text' class='text' required name='inputVal2' style="width:50%" />
                        </div>
                        
<!--                         <div style='display:none;' id='itemCat'>><br><h5>Select Item Category:</h5> -->
...
<!-- 	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script> -->
 <script type="text/javascript" src="<%= request.getContextPath() %>/plugins/bootstrap-3.3.7/js/bootstrap.min.js"></script>
