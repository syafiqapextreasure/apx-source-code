...
<!-- 
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Spine Label Search By SMD</a>
    </nav>
           ...
           -->
 			...
 			<form:form action="searchResult" method="post">
                    ...
                    <div class="row">
						...
						<input type="hidden" name="codeList" value="smd">
						
						<div  id='smd'><br><h5>Select SMD:</h5>
						  <select class="select-list" id="selectSMD" name="selectSMD" style="width:50%" >
						       <option value="" selected disabled hidden >Select SMD..</option>	 		  
						      <c:forEach var="listSMD" items="${listSMD}">
						       <option value="${listSMD.SMD}" ><c:out value="${listSMD.SMD}"/> <c:out value="${listSMD.SMDdesc}"/></option>
						      </c:forEach>
						  </select>   
						</div>   
