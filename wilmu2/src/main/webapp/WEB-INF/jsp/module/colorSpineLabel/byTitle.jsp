...
<!-- 
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Spine Label Search By Title</a>
    </nav>
...
<!--           <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Search by Title</h1>                   
          </div>
           -->
 			...
 			<form:form action="searchResult" method="post">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="codeList" value="title">
                        
                        <div style='display:inline;' id='firstInput'> 
                        	<br><h5 id='keywordtext'>Insert Title: &nbsp;</h5>
                        	<input type="text" required name="inputVal" style="width:50%">
                        </div>                                      
