...
<!-- 
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Spine Label Search By Accession Number</a>
    </nav>
...
<!--           <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Search by Accession Number</h1>                   
          </div>
           -->
...
<!--             <div class="container">	        -->
            <form:form action="searchResult" method="post">
                    ...
                    <div class="form-group row justify-content-md-center">
                    	<div class="col-md-12" style="height:950px; margin-left: 500px;">
                        
                        <input type="hidden" name="codeList" value="accessionNo">
                        
                        <div style='display:inline;' id='firstInput'> 
                        	<br><h5 id='keywordtext'>Insert Accession Number: &nbsp;</h5>
