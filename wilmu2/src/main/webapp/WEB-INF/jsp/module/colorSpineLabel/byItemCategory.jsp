...
<!--     Bootstrap core CSS
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Spine Label Search By Item Category</a>
    </nav>
...
<!--           <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Search by Item Category</h1>                   
          </div>
           -->
 			...
 			<form:form action="searchResult" method="post">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="codeList" value="itemCategory">                    
<!--                         <div style='display:none;' id='itemCat'>><br><h5>Select Item Category:</h5> -->
                        <div id='itemCategory'><br><h5>Select Item Category:</h5>
						  <select class="select-list" name="selectItemCategory" id="selectItemCategory" style="width:50%" >
						       <option value="" selected disabled hidden >Select Item Category..</option>				  
						      <c:forEach var="listItemCategory" items="${listItemCategory}">
						       <option value="${listItemCategory.itemCategory}" ><c:out value="${listItemCategory.itemCategory}"/> <c:out value="${listItemCategory.itemCategoryDesc}"/></option>
						      </c:forEach>
						  </select>   
						</div> 
