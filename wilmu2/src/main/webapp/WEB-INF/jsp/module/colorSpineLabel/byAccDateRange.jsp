...
<!-- 
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Spine Label By Accession Date Range</a>
    </nav>
...
<!--           <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Search by Accession Date Range</h1>                   
          </div>
           -->
           ...
           <form:form action="searchResult" method="post">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="codeList" value="accessionDateRange">
                                              
                        <div style='display:inline;' id='firstInput'>
                        	<br><h5 id='fromtext'>From: &nbsp;</h5> <p>(Format: yyyymmdd)</p>
                        	<input type="number" name="inputVal" required style="width:50%">
                        </div>
                        
                        <div id='secondInput'>
                        	<br><h5>To: &nbsp;</h5> <p>(Format: yyyymmdd)</p>
                        	<input type='number' class='text' required name='inputVal2' style="width:50%" />
                        </div>
