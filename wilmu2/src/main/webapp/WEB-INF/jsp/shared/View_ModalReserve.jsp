...
<input id="action" type="hidden" value="view" />

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
    <h4 class="modal-title">View Reserve</h4>
</div>
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <div class="col-md-12" style="margin-bottom: 5px;">
                            <div class="col-md-3"><input type="checkbox" class="form-check-input" name="courseCodeCB" id="courseCodeCB" /> Course Code :</div>
                        ...
                        <div class="col-md-12" style="margin-bottom: 5px;">
                            <div class="col-md-3">
                                <input type="checkbox" class="form-check-input" name="semesterMasterCB" id="semesterMasterCB" />
                                Semester Master :
                            </div>
                            <div class="col-md-3" style="margin-right: -40;">
                                <div class="input-group select">
                        ...
                        <div class="col-md-12" style="margin-bottom: 10px;">
                            <div class="col-md-3"><input type="checkbox" class="form-check-input" name="subjectCB" id="subjectCB" /> Subject* :</div>
                            <div class="col-md-3" style="margin-right: -40;">
                                <div class="input-group select">
                                    <select
                        ...
                        <div class="col-md-12" style="margin-bottom: 5px;">
                            <div class="col-md-3"><input type="checkbox" class="form-check-input" name="instructorCB" id="instructorCB" /> Instructor :</div>
                            <div class="col-md-4" style="margin-right: -50;">
                                <input type="text" id="instructorTF" name="instructorTF" option="Id" old-value="Id==" style="width: 180px;" />
                            </div>
                        ...
                        <div class="col-md-12" style="margin-bottom: 5px;">
                            ...
                            <div class="col-md-4" style="margin-right: -50;">
                            	...
                            	<div class="input-group">
									<input type="text" class="form-control ctrlno" id="controlNo" name="controlNo" maxlength="10" onkeydown="matnoKeydown(event,this)" onfocusout="matnoFocusOut(this)" required />
...
<!--                             <div class="col-sm-1 col-md-1">
                        ...
                        <div class="col-md-12" style="margin-bottom: 5px;">
                            <div class="col-md-3"><input type="checkbox" class="form-check-input" name="AccNoCB" id="AccNoCB" /> Accession No :</div>
                            <div class="col-md-2">
                                <div class="input-group select">
                                    <select class="form-control" id="accessionNo" style="width: 250px;"></select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12" style="margin-bottom: 5px;">
                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="reserveCollection">
                                                <div class="box-body">
                                                    <div class="row" style="margin-left: 0px;">Call Number: <input type="text" id="callNo" name="callNo" style="width: 500px; margin-bottom: 5px; margin-left: 10px;" disabled /></div>
                                                    <div class="row" style="margin-left: 0px;">Subject: <input type="text" id="subject" name="subject" style="width: 500px; margin-bottom: 5px; margin-left: 40px;" disabled /></div>
                                                    <div class="row" style="margin-left: 0px;">Title: <input type="text" id="title" name="title" style="width: 500px; margin-bottom: 5px; margin-left: 60px;" disabled /></div>
                                                    <div class="row" style="margin-left: 0px;">Author <input type="text" id="author" name="author" style="width: 500px; margin-bottom: 5px; margin-left: 50px;" disabled /></div>
                                                    <div class="row" style="margin-left: 0px;">Publication: <input type="text" id="publication" name="publication" style="width: 500px; margin-bottom: 5px; margin-left: 20px;" disabled /></div>
                                                    <div class="row" style="margin-left: 0px;">Location <input type="text" id="location" name="location" style="width: 500px; margin-bottom: 5px; margin-left: 40px;" disabled /></div>
                                                    <div class="row" style="margin-left: 0px;">Branch <input type="text" id="branch" name="branch" style="width: 500px; margin-bottom: 5px; margin-left: 48px;" disabled /></div>
                                                </div>
                                            </div>
                                            <!-- /.End Tab item -->
                                            <!-- TAB 2 -->
