...
<!--                             <div class="col-sm-1 col-md-1">
                                <button type="button" class="btn btn-default selectPopup" data-toggle="modal" data-target="#titleSearchAccMain" href="RetrieveTitleModal?action=20">...</button>
                            </div> -->
        ...
        <div class="float-right margin-top-15" style="margin-left: 530px;">
            <button type="button" class="btn btn-default" id="okBtn" disabled>
