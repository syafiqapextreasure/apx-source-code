...
public class ReminderByPatronId {
    private static Connection conn = null;
    private static PreparedStatement stmt = null;
    private static ResultSet rs = null;

    public static List<OverdueNotification> getReminderByPatronId(String reminder, String inputPatronId, String convertedDate) throws ParseException {
            ...
            try {
                try {
                    ...
                    while (rs.next()) {
                        ...
                        OverdueResult.add(new OverdueNotification(rs.getString("CI02DOCNO"), rs.getString("CI02PATRS"), rs.getString("CT05SRAW"), rs.getString("CallNo"), OverdueNotification.swapYearAndDayInDateFormat(rs.getString("CI02DDATE")), "1st Reminder", calcFine.calculateDays(rs.getString("CI02DDATE"), rs.getString("Branch"), conn), calcFine.calculatefines2(rs.getString("CI02PATR"), rs.getString("GL27CATE"), rs.getString("GL27ICAT"), rs.getString("GL27SMD"), rs.getString("CI02DDATE"), rs.getString("Branch"), conn), rs.getString("GL14IPADD"), rs.getString("Branch"), rs.getString("Location")));
                    }
                }
            ...
            try {
                try {
                    ...
                    while (rs.next()) {
                        ...
                        OverdueResult.add(new OverdueNotification(rs.getString("CI02DOCNO"), rs.getString("CI02PATRS"), rs.getString("CT05SRAW"), rs.getString("CallNo"), OverdueNotification.swapYearAndDayInDateFormat(rs.getString("CI02DDATE")), "2nd Reminder", calcFine.calculateDays(rs.getString("CI02DDATE"), rs.getString("Branch"), conn), calcFine.calculatefines2(rs.getString("CI02PATR"), rs.getString("GL27CATE"), rs.getString("GL27ICAT"), rs.getString("GL27SMD"), rs.getString("CI02DDATE"), rs.getString("Branch"), conn), rs.getString("GL14IPADD"), rs.getString("Branch"), rs.getString("Location")));
                    }
                }
                catch (SQLException e) {
                    e.printStackTrace();
            ...
            try {
                try {
                    ...
                    while (rs.next()) {
                        ...
                        ++count;
                        OverdueResult.add(new OverdueNotification(rs.getString("CI02DOCNO"), rs.getString("CI02PATRS"), rs.getString("CT05SRAW"), rs.getString("CallNo"), OverdueNotification.swapYearAndDayInDateFormat(rs.getString("CI02DDATE")), "3rd Reminder", calcFine.calculateDays(rs.getString("CI02DDATE"), rs.getString("Branch"), conn), calcFine.calculatefines2(rs.getString("CI02PATR"), rs.getString("GL27CATE"), rs.getString("GL27ICAT"), rs.getString("GL27SMD"), rs.getString("CI02DDATE"), rs.getString("Branch"), conn), rs.getString("GL14IPADD"), rs.getString("Branch"), rs.getString("Location")));
                    }
                }
                catch (SQLException e) {
                    e.printStackTrace();
