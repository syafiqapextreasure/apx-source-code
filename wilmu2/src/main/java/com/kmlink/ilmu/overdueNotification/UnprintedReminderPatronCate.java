...
public class UnprintedReminderPatronCate {
    private static Connection conn = null;
    private static PreparedStatement stmt = null;
    private static ResultSet rs = null;
    private static OverdueNotification overdueNotify = null;

    public static List<OverdueNotification> getUnprintedReminderPatronCate(String unprintedDate, String reminder, String patronCategoryId) throws ParseException {
        DBConnection db = new DBConnection();
        ArrayList<OverdueNotification> OverdueResult = new ArrayList<OverdueNotification>();
        System.out.println(unprintedDate);
        System.out.println(reminder);
        System.out.println(patronCategoryId);
