...
public class OverdueNotification {
    ...
    public static List<String> getFilterBranchId() {
        ...
        String query = "SELECT GL71BRNC FROM GLBRNC ORDER BY GL71BRNC ASC ";
        Connection conn = null;
        try {
            try {
                PreparedStatement stmt = null;
    ...
    public static List<String> getFilterBranchDesc() {
        ArrayList<String> branch = new ArrayList<String>();
        String query = "SELECT GL71DESC FROM GLBRNC ORDER BY GL71BRNC ASC ";
        Connection conn = null;
        try {
            try {
                PreparedStatement stmt = null;
    ...
    public static List<OverdueNotification> getTableList(String retrieveType, String unprintedDate, String reprintDate, String inputPatronId, String patronCategoryId, String branchId, String reminder, String address, String officerId, String patronStatusId) throws ParseException {
        ...
        if (unprintedDate.equals(convertedDate) && reprintDate.equals("") && inputPatronId.equals("") && !reminder.equals("") && (address.equals("department") || address.equals("office") || address.equals("home")) && patronCategoryId.equals("") && branchId.equals("") && officerId.equals("") && patronStatusId.equals("")) {
            OverdueResult = UnprintedReminder.getUnprintedReminder(unprintedDate, reminder);
        } else if (unprintedDate.equals(convertedDate) && reprintDate.equals("") && inputPatronId.equals("") && !reminder.equals("") && (address.equals("department") || address.equals("office") || address.equals("home")) && !patronCategoryId.equals("") && branchId.equals("") && officerId.equals("") && patronStatusId.equals("")) {
        ...
        } else if (retrieveType.equals("reprint") && unprintedDate.equals("") && reprintDate.equals("") && inputPatronId.equals("") && !reminder.equals("") && (address.equals("department") || address.equals("office") || address.equals("home")) && patronCategoryId.equals("") && branchId.equals("") && officerId.equals("") && patronStatusId.equals("")) {
            OverdueResult = ReprintReminder.getReprintReminder(reprintDate, reminder);
        } else if (retrieveType.equals("patron") && unprintedDate.equals("") && reprintDate.equals("") && !inputPatronId.equals("") && !reminder.equals("") && (address.equals("department") || address.equals("office") || address.equals("home")) && patronCategoryId.equals("") && branchId.equals("") && officerId.equals("") && patronStatusId.equals("")) {
            OverdueResult = ReminderByPatronId.getReminderByPatronId(reminder, inputPatronId, convertedDate);
        } else if (!retrieveType.equals("") && !unprintedDate.equals("") && reprintDate.equals("") && inputPatronId.equals("") && !reminder.equals("") && (address.equals("department") || address.equals("office") || address.equals("home")) && patronCategoryId.equals("") && branchId.equals("") && !officerId.equals("") && patronStatusId.equals("")) {
...
//    }
    ...
    public static void updateSentNotificationCICRC(String patronId, String accessionNo, String notifyType) {
        if (patronId == null || accessionNo == null) {
            throw new IllegalArgumentException("patronId and accessionNo cannot be null");
        }
        ...
        try {
            ...
            if ("first".equals(notifyType)) {
                updateQuery = "UPDATE CICIRC SET CI02SENT1 = ? WHERE CI02PATR = ? AND CI02DOCNO = ?";
            } else if ("second".equals(notifyType)) {
                updateQuery = "UPDATE CICIRC SET CI02SENT2 = ? WHERE CI02PATR = ? AND CI02DOCNO = ?";
            } else if ("third".equals(notifyType)) {
                updateQuery = "UPDATE CICIRC SET CI02SENT3 = ? WHERE CI02PATR = ? AND CI02DOCNO = ?";
            }
            ...
            if (updateQuery != null) {
                ...
                stmt = conn.createStatement();
                rs = stmt.executeQuery("SELECT GL98VALUE FROM GLNUMB WHERE GL98FUNC = 'CINOTC'");
                int maxCINOTC = 0;
                if (rs.next()) {
                    maxCINOTC = rs.getInt("GL98VALUE");
                }
                int nextNotificationNo = maxCINOTC + 1;

                // Insert new notification
                String insertQuery = "INSERT INTO CINOTC (CI10COUNTER, CI10NOTDATE, CI10NOTTIME, CI10TYPE, CI10DOCNO, CI10PATRON, CI10OFFICER) VALUES (?, ?, ?, ?, ?, ?, ?)";
                pstmt = conn.prepareStatement(insertQuery);
                pstmt.setInt(1, nextNotificationNo);
                ...
                String updateCounterQuery = "UPDATE GLNUMB SET GL98VALUE = ? WHERE GL98FUNC = 'CINOTC'";
                pstmt1 = conn.prepareStatement(updateCounterQuery);
                pstmt1.setInt(1, nextNotificationNo);
                pstmt1.executeUpdate();
            }

        } catch (SQLException e) {
            throw new RuntimeException("Database error while updating notification: " + e.getMessage(), e);
        } finally {
            closeResources(rs, pstmt, pstmt1, stmt, conn);
        }
    }

    private static void closeResources(ResultSet rs, PreparedStatement pstmt, 
            PreparedStatement pstmt1, Statement stmt, Connection conn) {
        try {
            if (rs != null) rs.close();
