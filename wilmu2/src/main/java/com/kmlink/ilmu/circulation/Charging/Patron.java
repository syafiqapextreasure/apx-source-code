...
import com.kmlink.ilmu.circulation.sql.PatronSQL;
...
public class Patron {
    ...
    private String msPatronHomeTel;
    private String msPatronOHomeAdd1;
    private String msPatronOHomeAdd2;
    private String msPatronOHomeAdd3;
    private String msPatronOHomePatronCode;
    private String msPatronOHomePatronTown;
    private String msPatronOHomeHtel;
    ...
    private String msPatronOPatronAdd1;
    private String msPatronOPatronAdd2;
    private String msPatronOPatronAdd3;
    private String msPatronOPostcode;
    private String msPatronOTown;
    private String msPatronOOtel;
    ...
    public Patron(String msPatronID) {
        ...
        try {
            try {
                ...
                System.out.println("Initializing Patron Object");
                this.viewtable(msPatronID);
            }
            catch (Exception e) {
                e.printStackTrace();
                try {
    ...
    public void viewtable(String msPatronID) {
        block12: {
            Connection conn1 = null;
            Statement stmt1 = null;
            ResultSet rs1 = null;
            String sql = "SELECT * FROM GLPATR WHERE GL14PATR ='" + msPatronID + "'";
            ...
            try {
                try {
                    ...
                    String town = Handler.ifIsNull(rs1.getString("GL14TOWN"));
                    String gettowndesc = town.equals(" ") ? " " : Patron.getGLfndDescByValue("M", rs1.getString("GL14TOWN"));
                    String OHomePatronTown = Handler.ifIsNull(rs1.getString("GL14TOWN2"));
                    String gettown2desc = OHomePatronTown.equals(" ") ? " " : Patron.getGLfndDescByValue("M", rs1.getString("GL14TOWN2"));
                    String OTown = Handler.ifIsNull(rs1.getString("GL14OFFTOWN"));
                    String getofftowndesc = OTown.equals(" ") ? " " : Patron.getGLfndDescByValue("M", rs1.getString("GL14OFFTOWN"));
                    this.setMsPatronId(rs1.getString("GL14PATR"));
                    this.setMsPatronName(rs1.getString("GL14NAME"));
                    this.setMsPatronTitle(rs1.getString("GL14NAMETITLE"));
                    this.setMsPatronStatus(rs1.getString("GL14STAT"));
                    this.setMsPatronOldIC(rs1.getString("GL14NEWIC"));
                    this.setMsPatronNewIC(rs1.getString("GL14OLDIC"));
                    this.setMsPatronCode(Handler.ifIsNull(rs1.getString("GL14CODE")));
                    this.setMsPatronTown(gettowndesc);
                    this.setMsPatronCode2(Handler.ifIsNull(rs1.getString("GL14CODE2")));
                    this.setMsPatronOHomePatronCode(Handler.ifIsNull(rs1.getString("GL14CODE2")));
                    this.setMsPatronTown2(Handler.ifIsNull(rs1.getString("GL14TOWN2")));
                    this.setMsPatronOHomePatronTown(gettown2desc);
                    this.setMsPatronHTel(Handler.ifIsNull(rs1.getString("GL14HTEL")));
                    this.setMsPatronOTel(Handler.ifIsNull(rs1.getString("GL14OTEL")));
                    this.setMsPatronFax(Handler.ifIsNull(rs1.getString("GL14FAX")));
                    this.setMsPatronCategory(rs1.getString("GL14CATE"));
                    this.setMsPatronHomeAdd1(Handler.ifIsNull(rs1.getString("GL14ADD1")));
                    this.setMsPatronHomeAdd2(Handler.ifIsNull(rs1.getString("GL14ADD2")));
                    this.setMsPatronHomeAdd3(Handler.ifIsNull(rs1.getString("GL14ADD3")));
                    this.setMsPatronOHomeAdd1(Handler.ifIsNull(rs1.getString("GL14ADD21")));
                    this.setMsPatronOHomeAdd2(Handler.ifIsNull(rs1.getString("GL14ADD22")));
                    this.setMsPatronOHomeAdd3(Handler.ifIsNull(rs1.getString("GL14ADD23")));
                    this.setMsPatronDOB(rs1.getString("GL14DOB"));
                    this.setMsPatronSex(rs1.getString("GL14SEX"));
                    this.setMsPatronRace(rs1.getString("GL14RACE"));
                    this.setMsPatronPassword(rs1.getString("GL14PASW"));
                    this.setMsPatronBranch(rs1.getString("GL14BRNC"));
                    this.setMsParentInfo(rs1.getString("GL14PARENTID"));
                    this.setMsPatronCourse(rs1.getString("GL14COURSE"));
                    this.setMsPatronDep(rs1.getString("GL14DEPT"));
                    this.setMsPatronSerialNo(rs1.getString("GL14SECURE"));
                    this.setMsMemDate(rs1.getString("GL14MEMDATE"));
                    this.setMsMemExpiryDate(rs1.getString("GL14EXPDATE"));
                    this.setMsPatronImage(rs1.getBytes("GL14IMG"));
                    this.setMsMemDate(GeneralUtility.StrToDate(rs1.getString("GL14MEMDATE")));
                    this.setMsMemExpiryDate(GeneralUtility.StrToDate(rs1.getString("GL14EXPDATE")));
                    this.setMsPatronOHomeHtel(Handler.ifIsNull(rs1.getString("GL14HTEL2")));
                    this.setMsPatronOPatronAdd1(Handler.ifIsNull(rs1.getString("GL14OFFADD1")));
                    this.setMsPatronOPatronAdd2(Handler.ifIsNull(rs1.getString("GL14OFFADD2")));
                    this.setMsPatronOPatronAdd3(Handler.ifIsNull(rs1.getString("GL14OFFADD3")));
                    this.setMsPatronOPostcode(Handler.ifIsNull(rs1.getString("GL14OFFCODE")));
                    this.setmsPatronOTown(getofftowndesc);
                    this.setMsPatronOOtele(Handler.ifIsNull(rs1.getString("GL14OTEL")));
                    this.setMsPatronHomeTel(Handler.ifIsNull(rs1.getString("GL14MTEL")));
                }
                catch (Exception e) {
                    e.printStackTrace();
                    try {
    ...
    public boolean checkPatr(String msPatronID) throws ParseException {
        boolean bSucessful = false;
        boolean validPatr = false;
        boolean ableCharge = false;
        boolean patrMaxFine = false;
        validPatr = Patron.checkValidPatr(msPatronID);
        if (validPatr) {
            String msPatronExpDate = this.getMsMemExpiryDate();
            Date date = new Date();
            ...
            if (date1.compareTo(date2 = dateFormat.parse(msPatronExpDate)) < 0) {
                ableCharge = Patron.ableCharge(msPatronID);
                if (ableCharge) {
                    Double patrFineLimit = this.getFineLimit(msPatronID);
                    if (this.getMsGetTotalFinesOutstanding() < patrFineLimit || patrFineLimit == 0.0) {
                        if (this.patronCateAllowedOverdue()) {
                            System.out.println("Overduessss");
                            bSucessful = true;
                        } else {
                            System.out.println("Overduessss1111");
                            if (this.getNoMsGetItemOverdue() != 0) {
                                this.errmessage = "046";
                                bSucessful = false;
                            } else {
                                bSucessful = true;
                    ...
                    String status = Patron.getPatrStat(msPatronID);
                    this.errmessage = "080," + status;
                    bSucessful = false;
                }
            } else {
                this.errmessage = "032";
    ...
    public static boolean checkValidPatr(String GL14PATR) {
        String query = PatronSQL.chkValidPatrSQL(GL14PATR);
    ...
    public static boolean checkFineLimitPatr(String GL14PATR) {
        String query = "SELECT GL07FINELIMIT FROM GLCATE WHERE GL07CATE=(SELECT GL14CATE FROM GLPATR WHERE GL14PATR='" + GL14PATR + "')";
        boolean checkFine = false;
        System.out.println(query);
        try {
            try {
                conn = DBConnection.getConnection();
                ...
                ResultSet rs = stmt.executeQuery(query);
                while (rs.next()) {
                    if (Integer.parseInt(rs.getString("GL07FINELIMIT")) != 0) continue;
                    checkFine = true;
                }
            }
            catch (SQLException e) {
    ...
    public static boolean ableCharge(String GL14PATR) {
        String query = PatronSQL.chkPatrActive(GL14PATR);
        boolean deletable = true;
        System.out.println(query);
        try {
            try {
    ...
    public static String getPatrStat(String GL14PATR) {
        String query = PatronSQL.getMsPatronStatusDesc(GL14PATR);
        String status = "";
        System.out.println(query);
        try {
            try {
    ...
    public String getMsPatronStatus(String msPatronID) {
        ...
        Statement stmt1 = null;
        ResultSet rs1 = null;
        String sql = PatronSQL.getMsPatronStatusCode(msPatronID);
        try {
            try {
                conn1 = DBConnection.getConnection();
                stmt1 = conn1.createStatement();
                rs1 = stmt1.executeQuery(sql);
                while (rs1.next()) {
                    this.msPatronStatus = String.valueOf(rs1.getString("GL14STAT"));
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public String getMsPatronStatusDesc() {
        String sql = PatronSQL.getMsPatronStatDesc(this.msPatronStatus);
        try {
            try {
                conn = DBConnection.getConnection();
                stmt = conn.createStatement();
    ...
    public String getMsPatronCategory(String msPatronID) {
        String sql = PatronSQL.getMsPatronCatCode(msPatronID);
        System.out.println(sql);
        Connection conn1 = null;
        try {
            try {
    ...
    public Double getFineLimit(String GL14PATR) {
        double fineLimit;
        block12: {
            String sql = PatronSQL.getFineLimit(GL14PATR);
            System.out.println(sql);
            fineLimit = 0.0;
            try {
                try {
                    ...
                    while (rsObj.next()) {
                        ...
                        fineLimit = limit == null ? 0.0 : Double.parseDouble(rsObj.getString("GL07FINELIMIT"));
                    }
                }
                catch (SQLException e) {
                    e.printStackTrace();
    ...
    public String getMsPatronBranch(String msPatronID) {
        String sql = PatronSQL.getMsPatronBranchCode(msPatronID);
        ...
        try {
            try {
                ...
                rs1 = stmt1.executeQuery(sql);
                while (rs1.next()) {
                    this.msPatronBranch = String.valueOf(rs1.getString("GL14BRNC"));
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public String getMsPatronHomeAdd1(String msPatronID) {
        ...
        try {
            try {
                ...
                rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    this.msPatronHomeAdd1 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14ADD1")));
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public String getMsPatronHomeTel() {
        return this.msPatronHomeTel;
    }

    public String getMsPatronHomeTel(String msPatronID) {
        String sql = "SELECT GL14MTEL FROM GLPATR WHERE GL14PATR= '" + msPatronID + "' ";
        try {
            try {
                conn = DBConnection.getConnection();
                stmt = conn.createStatement();
                rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    this.msPatronHomeTel = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14MTEL")));
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public void setMsPatronHomeTel(String msPatronHomeTel) {
        this.msPatronHomeTel = msPatronHomeTel;
    }
    ...
    public String getMsPatronHomeAdd2(String msPatronID) {
        ...
        try {
            try {
                ...
                ResultSet rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    this.msPatronHomeAdd2 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14ADD2")));
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public String getMsPatronHomeAdd3(String msPatronID) {
        ...
        try {
            try {
                ...
                ResultSet rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    this.msPatronHomeAdd3 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14ADD3")));
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public String getMsPatronOHomeAdd1(String msPatronID) {
        ...
        System.out.println("getMsPatronOHomeAdd1" + sql);
        try {
            try {
                conn = DBConnection.getConnection();
                stmt = conn.createStatement();
                ResultSet rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    this.msPatronOHomeAdd1 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14ADD21")));
                    System.out.println("msPatronOHomeAdd1" + this.msPatronOHomeAdd1);
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public String getMsPatronOHomeAdd2(String msPatronID) {
        ...
        System.out.println("getMsPatronOHomeAdd2" + sql);
        try {
            try {
                ResultSet rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    this.msPatronOHomeAdd2 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14ADD22")));
                    System.out.println("msPatronOHomeAdd2" + this.msPatronOHomeAdd2);
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public String getMsPatronOHomeAdd3(String msPatronID) {
        ...
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOHomeAdd3 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14ADD23")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public String getmsPatronOHomePatronCode() {
        return this.msPatronOHomePatronCode;
    }

    public String getMsPatronOHomePatronCode(String msPatronID) {
        String sql = "SELECT GL14CODE2 FROM GLPATR WHERE GL14PATR= '" + msPatronID + "' ";
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOHomePatronCode = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14CODE2")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setMsPatronOHomePatronCode(String msPatronOHomePatronCode) {
        this.msPatronOHomePatronCode = msPatronOHomePatronCode;
    }

    public String getmsPatronOHomePatronTown() {
        return this.msPatronOHomePatronTown;
    }

    public String getMsPatronOHomePatronTown(String msPatronID) {
        String sql = "SELECT DESCRIPTION FROM GLPATR LEFT JOIN FNDCODE ON GL14TOWN2 = CODE AND  FCODE = 'M' WHERE GL14PATR = '" + msPatronID + "'";
        System.out.println("getMsPatronTown" + sql);
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOHomePatronTown = String.valueOf(Handler.ifIsNull(rsObj.getString("DESCRIPTION")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setMsPatronOHomePatronTown(String msPatronOHomePatronTown) {
        this.msPatronOHomePatronTown = msPatronOHomePatronTown;
    }

    public String getmsPatronOHomeHtel() {
        return this.msPatronOHomeHtel;
    }

    public String getMsPatronOHomeHtel(String msPatronID) {
        String sql = "SELECT GL14HTEL2 FROM GLPATR WHERE GL14PATR= '" + msPatronID + "' ";
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOHomeHtel = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14HTEL2")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setMsPatronOHomeHtel(String msPatronOHomeHtel) {
        this.msPatronOHomeHtel = msPatronOHomeHtel;
    }

    public String getMsPatronOPatronAdd1() {
        return this.msPatronOPatronAdd1;
    }

    public String getmsPatronOPatronAdd1(String msPatronID) {
        String sql = "SELECT GL14OFFADD1 FROM GLPATR WHERE GL14PATR= '" + msPatronID + "' ";
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOPatronAdd1 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14OFFADD1")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setMsPatronOPatronAdd1(String msPatronOPatronAdd1) {
        this.msPatronOPatronAdd1 = msPatronOPatronAdd1;
    }

    public String getMsPatronOPatronAdd2() {
        return this.msPatronOPatronAdd2;
    }

    public String getmsPatronOPatronAdd2(String msPatronID) {
        String sql = "SELECT GL14OFFADD2 FROM GLPATR WHERE GL14PATR= '" + msPatronID + "' ";
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOPatronAdd2 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14OFFADD2")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setMsPatronOPatronAdd2(String msPatronOPatronAdd2) {
        this.msPatronOPatronAdd2 = msPatronOPatronAdd2;
    }

    public String getMsPatronOPatronAdd3() {
        return this.msPatronOPatronAdd3;
    }

    public String getmsPatronOPatronAdd3(String msPatronID) {
        String sql = "SELECT GL14OFFADD2 FROM GLPATR WHERE GL14PATR= '" + msPatronID + "' ";
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOPatronAdd3 = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14OFFADD2")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setMsPatronOPatronAdd3(String msPatronOPatronAdd3) {
        this.msPatronOPatronAdd3 = msPatronOPatronAdd3;
    }

    public String getMsPatronOPostcode() {
        return this.msPatronOPostcode;
    }

    public String getmsPatronOPostcode(String msPatronID) {
        String sql = "SELECT GL14OFFCODE FROM GLPATR WHERE GL14PATR= '" + msPatronID + "' ";
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOPostcode = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14OFFCODE")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setMsPatronOPostcode(String msPatronOPostcode) {
        this.msPatronOPostcode = msPatronOPostcode;
    }

    public String getMsPatronOTown() {
        return this.msPatronOTown;
    }

    public String getmsPatronOTown(String msPatronID) {
        String sql = "SELECT DESCRIPTION FROM GLPATR LEFT JOIN FNDCODE ON GL14OFFTOWN = CODE AND  FCODE = 'M' WHERE GL14PATR = '" + msPatronID + "'";
        System.out.println("getMsPatronTown" + sql);
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOTown = String.valueOf(Handler.ifIsNull(rsObj.getString("DESCRIPTION")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setmsPatronOTown(String msPatronOTown) {
        this.msPatronOTown = msPatronOTown;
    }

    public String getMsPatronOOtel() {
        return this.msPatronOOtel;
    }

    public String getmsPatronOOtel(String msPatronID) {
        String sql = "SELECT GL14OTEL FROM GLPATR WHERE GL14PATR= '" + msPatronID + "' ";
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronOPostcode = String.valueOf(Handler.ifIsNull(rsObj.getString("GL14OTEL")));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public void setMsPatronOOtele(String msPatronOOtel) {
        this.msPatronOOtel = msPatronOOtel;
    }
    ...
    public String getMsPatronTown(String msPatronID) {
        String sql = "SELECT DESCRIPTION FROM GLPATR LEFT JOIN FNDCODE ON GL14TOWN = CODE AND  FCODE = 'M' WHERE GL14PATR = '" + msPatronID + "'";
        System.out.println("getMsPatronTown" + sql);
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msPatronTown = String.valueOf(Handler.ifIsNull(rsObj.getString("DESCRIPTION")));
            }
            System.out.println("getMsPatronTown" + this.msPatronTown);
        }
        catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public String getMsMemDate(String msPatronID) {
        String sql = "Select GL14MEMDATE,GL14PATR From GLPATR Where GL14PATR = '" + msPatronID + "'";
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                this.msMemDate = rsObj.getString("GL14MEMDATE");
                System.out.println(String.valueOf(sql) + this.msMemDate);
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
    ...
    public String getMsMemExpiryDate(String msPatronID) {
        boolean deletable;
        block12: {
            String query = PatronSQL.getMembershipDate(msPatronID);
            deletable = true;
            System.out.println(query);
            try {
                try {
                    ...
                    ResultSet rs = stmt.executeQuery(query);
                    while (rs.next()) {
                        this.msMemExpiryDate = DateTime.DBToDisplayFormat(String.valueOf(rsObj.getString("GL14EXPDATE")));
                    }
                }
                catch (SQLException e) {
                    e.printStackTrace();
    ...
    public String GetLastRenewDate(String msPatronId) {
        DBConnection db = new DBConnection();
        String sql = null;
        if (DBConnection.getDBType().equals("oracle")) {
            sql = "SELECT CI02RDATE FROM CICIRC WHERE CI02PATR = '" + msPatronId + "' and rownum=1 " + "ORDER BY  CI02RDATE DESC";
        } else if (DBConnection.getDBType().equals("mssql")) {
            sql = "SELECT top 1 CI02RDATE FROM CICIRC WHERE CI02PATR = '" + msPatronId + "'  " + "ORDER BY  CI02RDATE DESC";
        }
        String msLastRenewDate = null;
        try {
            ResultSet rsObj = stmt.executeQuery(sql);
            while (rsObj.next()) {
                msLastRenewDate = GeneralUtility.StrToDate(rsObj.getString("CI02RDATE"));
            }
        }
        catch (SQLException e) {
            e.printStackTrace();
        }
        return msLastRenewDate;
    }
    ...
    public int getNoMsGetItemOverdue() {
        this.msNoGetItemOverdue = 0;
        String sql = PatronSQL.getNoMsGetItemOverdue(this.msPatronId);
        System.out.println(sql);
        try {
            conn = DBConnection.getConnection();
            stmt = conn.createStatement();
    ...
    public double getMsGetTotalCharged() {
        ...
        Statement stmt1 = null;
        ResultSet rs1 = null;
        String sql = PatronSQL.getTotalFineCharged(this.msPatronId);
        System.out.println(sql);
        try {
            conn1 = DBConnection.getConnection();
            stmt1 = conn1.createStatement();
            rs1 = stmt1.executeQuery(sql);
            while (rs1.next()) {
                this.msGetTotalFines = rs1.getDouble("totalcharged");
            }
        }
        catch (SQLException e) {
            try {
    ...
    public double getMsGetTotalPaid() {
        String sql = PatronSQL.getMsGetTotalPaid(this.msPatronId);
        Connection conn1 = null;
        Statement stmt1 = null;
        ResultSet rs1 = null;
        try {
            try {
                ...
                System.out.println(sql);
                while (rs1.next()) {
                    this.msGetTotalFinesPaid = rs1.getDouble("totalpaid");
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
    ...
    public boolean patronCateAllowedOverdue() {
        boolean allowoverdue = false;
        String sql = PatronSQL.patronCateAllowedOverdue(this.msPatronCategory);
        try {
            try {
                conn = DBConnection.getConnection();
                stmt = conn.createStatement();
                rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    if (!rsObj.getString("GL07ALLOWOVD").equals("Y")) continue;
                    allowoverdue = true;
                }
            }
            catch (SQLException e) {
    ...
    public static List<Patron> getPatronDetails(String msPatronID) throws SQLException {
        ArrayList<Patron> PatronDetails = new ArrayList<Patron>();
        try {
            try {
                conn = DBConnection.getConnection();
                stmt = conn.createStatement();
                String sql = "Select GL14LOSTBOK, GL14SUSPEND, GL14LASTBOR, GL14LASTRET from GLPATR where GL14PATR='" + msPatronID + "'";
                rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    Patron circ = new Patron(Handler.ifIntIsNull(rsObj.getString("GL14LOSTBOK")), Handler.ifIntIsNull(rsObj.getString("GL14SUSPEND")), GeneralUtility.StrToDate(rsObj.getString("GL14LASTBOR")), GeneralUtility.StrToDate(rsObj.getString("GL14LASTRET")));
                    PatronDetails.add(circ);
                }
            }
            catch (Exception e) {
    ...
    public static List<Patron> retrievePatron(String criteria, String searchType, String cate_id, String sort) throws SQLException {
        ...
        try {
            try {
                ...
                while (rsObj1.next()) {
                    Patron misc = new Patron(rsObj1.getString("GL14PATR"), rsObj1.getString("GL14NAME"));
                    patrMisc.add(misc);
                }
            }
            catch (Exception e) {
    ...
    public static List<Patron> retrieveDischarging(String criteria, String searchType, String cate_id) throws SQLException {
        ...
        try {
            try {
                ...
                rsObj1 = stmt1.executeQuery(sql);
                while (rsObj1.next()) {
                    Patron misc = new Patron(rsObj1.getString("CI02DOCNO"), Handler.removeSubfield(rsObj1.getString("CT05SRAW")));
                    patrMisc.add(misc);
                }
            }
            catch (Exception e) {
    ...
    public boolean CanPatronDischarge(String GL14PATR) {
        ...
        String sql = PatronSQL.getMsPatronCanDischarge(GL14PATR);
        try {
            try {
                conn = DBConnection.getConnection();
                stmt = conn.createStatement();
    ...
    public static String getGLfndDescByValue(String fcode, String code) {
        String query = "SELECT DESCRIPTION AS fcodedesc FROM FNDCODE WHERE FCODE = '" + fcode + "' AND CODE = '" + code + "' ";
        ...
        try {
            try {
                ...
                while (rsObj.next()) {
                    glflagvalue = Handler.ifIsNull(rsObj.getString("fcodedesc"));
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
