...
public class saveMail {
    ...
    public static saveMail SAVEMAIL(int newmailno, Library sender, String vendor, String text, String letterId) throws UnknownHostException {
        ...
        try {
            try {
                ...
                valueStr.put("GL34SENDER", sender.getPatrId());
                ...
                valueStr.put("GL34SUBJECT", letterId);
