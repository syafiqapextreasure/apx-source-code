  ...
  $('input:radio').click(function(){
	  alert("sssss");
		...
		function getURL(){
			...
			var action =  $("#btn-submit-retrievemodal1").attr("data-action");
			var module =  $("#btn-submit-retrievemodal1").attr("data-module");
			...
			/*	loader("#div-result");
				...
				*/
				url = "RetrieveSearchTitle?criteria="+title+"&search_type=MatNo&action="+action + "&type=" + type+ "&module=" + module;
				$("#search_title").collapse('hide');
				$("#result_title").collapse('show');
			/*	loader("#display_title");*/
			...
			else if(searchType == "ctrlNo" || searchType=="Accno"){
				//	var searchType = "Accno";
				
				url = "RetrieveSearchTitle?criteria="+title+"&search_type="+searchType+"&action="+action + "&type=" + type+ "&module=" + module;
				$("#search_title").collapse('hide');
				$("#result_title").collapse('show');
			/*	loader("#display_title");*/
				$.get(url,function(data_title){
		...
		/*	loader("#display_title");*/
			$.get(url,function(data_title){
				...
				$("#result_title").collapse('show');
				loader("#display_title");	 
				$.get("RetrieveSearchTitle",{criteria:title,search_type:searchType,tag:tag,action:action,module:module},function(data_title){
					$("#display_title").html(data_title);
				});
