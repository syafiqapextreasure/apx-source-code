...
%>
						...
						<div class="panel-body">
							...
							<div class="form-group">
									...
									if(action.equals("5")||action.equals("8")){
										event = "getkeyURL(event)";
										}else{
											event = "getkeyDetails(event)";
										}
									%>
									<div class="col-sm-6 col-md-6">
										<input type="text" class="form-control criteria" name="criteria" id="criteria" placeholder="Enter Search Term"onkeypress="<%=event%>">

									</div>
								</div>
							<%-- 	<%
								boolean searchByAcc = false;
								if(action.equals("7")){
									String search = CheckingData.getFunc("SEARCHBYACC");
									searchByAcc = true;
								}else if(action.equals("5")){
									searchByAcc = true;
								}
								if((action.equals("5")&& searchByAcc) || (action.equals("7")&& searchByAcc) ){
								%>
								<div class="form-group">
									<div class="col-sm-3 col-md-3">
										<label>
								...
								<div class="form-group">
									...
									<div class="col-sm-2 col-md-2">
										 <label><input type="radio" name="searchin" value="index" onchange="change(this)">Index</label>
									</div>
									<div class="col-sm-2 col-md-2">
										  <label><input type="radio" name="searchin" value="buffer" onchange="change(this)">Buffer</label>
									</div>
								</div>
								<%
								}
								...
								<div class="form-group">
									<div class="col-sm-3 col-md-3">
										<label>
											<input name="type" id="type" value="type" type="checkbox" checked> 
											Type
										</label> 
									</div>
									<div class="col-sm-4 col-md-4">
									<select class="form-control tags catType" id="type" name="type">
										<%
								...
								<div class="form-group">
									<div class="col-sm-3 col-md-3">
										<label>
											<input name="searchSelection" id="Accno" value="Accno" type="radio" onclick="radio()"> 
											Accession Number
										</label> 
									</div>
								</div>
								...
								TagInfo = Tag_Handler.getBibTags(Handler.marcType(module));
								%>
 ...
 -->
								<div class="form-group">
									...
									if(action.equals("5")||action.equals("8")){
									%>
										<button type="button" class="btn btn-info" id="btn-submit-retrievemodal1" data-action="<%=action %>" data-module="<%=module%>" onclick="getURL(this);return send_title_info()">
											<span class="glyphicon glyphicon-search"></span> Search
										</button>
									<%
										}else{
									%>
										<button type="button" class="btn btn-info" id="btn-submit-retrievemodal" data-action="<%=action %>" data-module="<%=module%>" onclick="getDetails(this);return send_title_info()">
											<span class="glyphicon glyphicon-search"></span> Search
										</button>
									<%
										}
	...
	<div class="modal-footer">
		<button id="retrieve" class="btn btn-info retrieve" disabled>Retrieve</button>
	</div>
