		...
		<tbody>
			...
			searchResult1 = CTRetrieve.CT_getTitle(controlNoInput);
				...
				for(CTRetrieve i: searchResult)
				{
					...
					out.println("<td><a type='button' title='View' class='btn btn-primary' data-toggle='modal' data-target='#viewAccMaint' href='Modal_ViewAccMaint?accNo="+controlNoInput+"&controlNo="+i.getCT03MATNO()+"'><span class='glyphicon glyphicon-open-file'></span></a>");
					...
					out.println("<a type='button' title='Delete' class='btn btn-dull' data-toggle='modal' data-target='#delete' href='jsp/include/sharedV1/Delete_Modal.jsp?controlNo="+controlNoInput+"'><span class='glyphicon glyphicon-trash'></span></a>");
