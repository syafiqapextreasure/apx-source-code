						...
						<div class="panel panel-default">
						  <div class="panel-heading clearfix">
							<h4 class="panel-title pull-left" style="padding-top: 7.5px;">
								<a class="btn btn-primary" id='enableSelect' title="Add new record" onclick="enableSelection()"><span class="glyphicon glyphicon-plus" style="color:white"></span></a>
								<a class="btn btn-primary" id='retrieveLink' data-toggle='modal' data-target='#titleSearch' href='RetrieveTitleModal?action=7&module=Cataloging' title="Catalog Search"><span class="glyphicon glyphicon-search" style="color:white"></span></a>
							<!-- 	<a class="btn btn-primary" id='preRcrd' data-toggle='modal' data-target='#preRcrd' href='ParamipsZ39' title="Marc Uploader"><i class="fa fa-history" aria-hidden="true"></i></a> -->
									...
									<select class="form-control tpl" id="tpl" name="tpl" onchange="getTplDetails()" disabled>
										<option value="0">&nbsp;Please select&nbsp;</option>
											<%
												...
												String marc = Handler.marcType("Cataloging");
