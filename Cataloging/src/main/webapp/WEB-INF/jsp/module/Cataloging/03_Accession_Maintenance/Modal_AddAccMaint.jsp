			            ...
			            <div class="col-md-12">		
							 <div class="form-group">
							  ...
							  <input type="text" class="form-control CT03MATNO" id="CT03MATNO" value="" maxlength="10" onkeydown="matnoKeydown(event,this)" onfocusout="matnoFocusOut(this)" required >
							   ...
							   <div class="col-sm-1 col-md-1"><button type="button" class="btn btn-default selectPopup"  data-toggle="modal" data-target="#titleSearch" href="RetrieveTitleModal?action=8&module=Cataloging">...</button></div>
							    <div class="col-sm-5">
							  		<div class="title"></div>
							  </div>
							</div>
