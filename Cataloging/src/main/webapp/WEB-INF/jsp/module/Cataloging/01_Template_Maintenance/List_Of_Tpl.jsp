            ...
            <div class="panel-heading clearfix">
				...
				<div class="btn-group pull-right">
					<button type="button" class="btn btn-primary" id="btn_add" data-toggle="modal" 
											data-target="#addRcrd" href="AddNewTplInfo?action=1&module=Cataloging" data-placement="bottom" title="Add Template"><span class="glyphicon glyphicon-plus"></span></button>
				</div>
            </div>
              <div id="search" class="panel-collapse collapse in">
			<div class="panel-body">
				<input type="hidden" id="module" value="Cataloging">
					 ...
					 <tbody>
						...
						<tr>
							...
							<td style="text-align: center;">
								<a title="Update Template" data-toggle='modal' data-target='#updateModal' href="Modal_EditTpl?seqNo=<%=i.getCT15SEQNO()%>&module=Cataloging">
							...
							%>
							<td style="text-align: center;">
							<button type="button" id="<%=i.getCT15SEQNO()%>,<%=i.getCT15TNAME()%>,Cataloging" onclick="myFunction(this.id)" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-eye-open" title="View Template"></span></button>
