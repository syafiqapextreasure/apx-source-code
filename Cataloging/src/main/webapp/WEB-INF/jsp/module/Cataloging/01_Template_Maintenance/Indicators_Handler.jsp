...
<div class="form-group">
	...
	<div class="col-sm-3 col-md-3">
		<%	
			...
			IndiInfo1 = Indicator_Handler.getIndi1(GL18TAG, Handler.marcType(module));
		%>
	...
	<div class="col-sm-3 col-md-3">
		<select class="form-control indi tplindi2" id="indi2" name="indi2" onchange="getSubfields()">
			...
			IndiInfo2 = Indicator_Handler.getIndi2(GL18TAG, Handler.marcType(module));
			%>
			<!-- <option value="0">Please select</option> -->
				<%
	...
	<div class="col-sm-6 col-md-6">
		<select style="z-index:2" class='multiselect form-control' id='subfields' name='subfields' multiple='multiple' required aria-required="true">
			<%
				...
				subfList = Subfield_Handler.getListOfSubf(GL18TAG, Handler.marcType(module));
				int counts = 0;
