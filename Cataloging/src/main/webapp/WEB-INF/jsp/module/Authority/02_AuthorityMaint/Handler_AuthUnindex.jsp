...
for (int i = 0; i < total; i++) {
	...
	queryList.add(Handler_BO.InsertBO(Handler.replaceWithA(matno), tag[i], indi1[i], indi2[i], raw[i], 
				counter, CT04SCONV.trim(), createdate, creatime, createby,modiby, DateTime.getTodaySystemDate(), 
				DateTime.timeToDBFormat(DateTime.getTodayTime()),"A", type, Handler.tblName(module), Handler.marcType(module)));
