...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/Cataloging/Template_Maintenance.js"></script>		 <!-- DataTables -->	
            ...
            <div class="panel-heading clearfix">
				...
				<input type="hidden" id="module" value="Authority">
					<button type="button" class="btn btn-primary" id="btn_add" data-toggle="modal" 
											data-target="#addRcrd" href="AddNewTplInfo?action=1&module=Authority" data-placement="bottom" title="Add Template"><span class="glyphicon glyphicon-plus"></span></button>
				</div>
            </div>
					...
					<thead>
					 ...
					 <tbody>
						<%
							...
							allTpl = Template_Maintenance.getAuthTpl();
						...
						<tr>
							...
							<td style="text-align: center;">
								<a title="Update Template" data-toggle='modal' data-target='#updateModal' href="Modal_EditTpl?seqNo=<%=i.getCT15SEQNO()%>&module=Authority">
							...
							%>
							<td style="text-align: center;">
							<button type="button" id="<%=i.getCT15SEQNO()%>,<%=i.getCT15TNAME()%>,Authority" onclick="myFunction(this.id)" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-eye-open" title="View Template"></span></button>
							...
							%>
							<td style="text-align: center;">
								<a href="AddTplInfo?tplName=<%=i.getCT15TNAME()%>&seqNo=<%=i.getCT15SEQNO()%>&module=Authority" data-backdrop="static" class="btn btn-primary btn-sm submit disabled"><span class="glyphicon glyphicon-eye-open" title="Update Template"></span></a>
								<%-- <a href="AddNewTplInfo?tplName=<%=i.getCT15TNAME()%>&seqNo=<%=i.getCT15SEQNO()%>"data-toggle='modal' data-target='#addRcrd' class="btn btn-primary btn-sm submit"><span class="glyphicon glyphicon-plus" title="Add Template"></span></a> --%>
							<%-- 	<a data-toggle='modal' data-target='#updateModal' href="Modal_EditTpl?seqNo=<%=i.getCT15SEQNO()%>" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-pencil" title="Update Template"></span></a>
								<% 
