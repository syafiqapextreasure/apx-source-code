...
public class AccessionDetails {
    ...
    public String getMsRetDueTime() {
        return this.msRetDueTime;
    }

    public void setMsRetDueTime(String msRetDueTime) {
        this.msRetDueTime = msRetDueTime;
    }
    ...
    public AccessionDetails(String msRetAccessionNo, String msRetStatus, String msRetItemCat, String msRetMatNo, String msRetDocNo, String msRetSMD, String msRetLocation, String msRetPatron, String msRetCondition, String msRetDueDate, String msNoCircByPatron, String msRetItemBranch, String msRetDueTime) {
        this.msRetAccessionNo = msRetAccessionNo;
        this.msRetStatus = msRetStatus;
        this.msRetItemCat = msRetItemCat;
        this.msRetMatNo = msRetMatNo;
    ...
    public AccessionDetails(String msAccessionNo, String patron) throws SQLException {
        ...
        System.out.println("AccessionDetails Function : !! " + sql);
        try {
            try {
