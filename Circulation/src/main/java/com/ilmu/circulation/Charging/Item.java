...
public class Item {
    ...
    public String getMsPatronBranch() {
        return this.msIteBranch;
    }

    public String getMsItemBranchCode(String msPatronID) {
        String sql = ItemSQL.getMsItemBranchCode(msPatronID);
        System.out.println("LOCA" + sql);
        ...
        try {
            try {
                ...
                while (rs1.next()) {
                    this.msIteBranch = String.valueOf(rs1.getString("CT03LOCA"));
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
