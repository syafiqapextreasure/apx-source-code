...
public class Patron {
        ...
        block18: {
            ...
            try {
                try {
                    ...
                    this.setMsPatronCode(rs1.getString("GL14CODE"));
                    this.setMsPatronTown(rs1.getString("GL14TOWN"));
                    this.setMsPatronCode2(rs1.getString("GL14CODE2"));
                    this.setMsPatronTown2(rs1.getString("GL14TOWN2"));
                    this.setMsPatronHTel(rs1.getString("GL14HTEL"));
                    this.setMsPatronOTel(rs1.getString("GL14OTEL"));
                    this.setMsPatronFax(rs1.getString("GL14FAX"));
                    this.setMsPatronCategory(rs1.getString("GL14CATE"));
                    this.setMsPatronHomeAdd1(rs1.getString("GL14ADD1"));
                    this.setMsPatronHomeAdd2(rs1.getString("GL14ADD2"));
                    this.setMsPatronHomeAdd3(rs1.getString("GL14ADD3"));
                    this.setMsPatronOHomeAdd1(rs1.getString("GL14ADD21"));
                    this.setMsPatronOHomeAdd1(rs1.getString("GL14ADD22"));
                    this.setMsPatronOHomeAdd1(rs1.getString("GL14ADD23"));
    ...
    public String getMsPatronStatusDesc() {
        ...
        try {
            try {
                ...
                rsObj = stmt.executeQuery(sql);
                while (rsObj.next()) {
                    this.msPatronStatusDesc = String.valueOf(rsObj.getString("GL08DESC")) + "," + "GL08ACTION1=" + rsObj.getString("GL08ACTION1");
                }
            }
            catch (SQLException e) {
                try {
    ...
    public String getMsPatronStatusDesc(String action) {
        String sql = PatronSQL.getMsPatronStatDesc(this.msPatronStatus, action);
        try {
            try {
                conn = DBConnection.getConnection();
                stmt = conn.createStatement();
                ...
                while (rsObj.next()) {
                    ...
                    if (!action.equals("batchrenewal")) continue;
                    this.msPatronStatusDesc = String.valueOf(rsObj.getString("GL08DESC")) + "," + "GL08ACTION3=" + rsObj.getString("GL08ACTION3");
                }
            }
            catch (SQLException e) {
                try {
    ...
    public String getMsNoCircByPatron() {
        ...
        try {
            try {
                ...
                while (rsObj.next()) {
                    this.msNoCircByPatron = rsObj.getString("CIRCULATEDNO");
                    if (!this.msNoCircByPatron.equals(null) && !this.msNoCircByPatron.equals("")) continue;
                    this.msNoCircByPatron = "0";
                }
            }
            catch (SQLException e) {
    ...
    public double getMsGetTotalFinesOutstanding() {
        System.out.println("Total Charged" + this.getMsGetTotalCharged());
        System.out.println("Total Paid" + this.getMsGetTotalPaid());
        this.msGetTotalFinesOutstanding = this.getMsGetTotalCharged() - this.getMsGetTotalPaid();
        System.out.println("Total Paidssssss" + this.msGetTotalFinesOutstanding);
    ...
    public static List<Patron> patrMisc(String msPatronID) throws SQLException {
        System.out.println("masuk ke patrMisc? ");
