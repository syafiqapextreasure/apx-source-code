...
public class PatronSQL {
    ...
    public static String getMsPatronStatDesc(String msPatronID) {
        String query = "SELECT GL08DESC, GL08ACTION1 FROM GLSTAT WHERE GL08STAT= '" + msPatronID + "' ";
        System.out.println(query);
        return query;
    }

    public static String getMsPatronStatDesc(String msPatronID, String action) {
        String query = null;
        query = action.equals("batchrenewal") ? "SELECT GL08DESC, GL08ACTION3 FROM GLSTAT WHERE GL08STAT= '" + msPatronID + "' " : "SELECT GL08DESC, GL08ACTION1 FROM GLSTAT WHERE GL08STAT= '" + msPatronID + "' ";
        return query;
    }
