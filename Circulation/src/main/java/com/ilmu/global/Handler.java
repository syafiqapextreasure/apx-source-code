    ...
    public static String getSubfield(String raw, List<ISBD> isbd) {
        ...
        if (raw != null && raw.contains("|")) {
            ...
            while (i < rawArray.length) {
                ...
                for (ISBD j : isbd) {
                    if (j.getGL23SUBF().equals(subfield)) {
                    ...
                    System.out.println("Subfield : " + rawArray[i].substring(0, 1));
                    System.out.println("Data : " + rawArray[i].substring(1));
                }
                ++i;
            }
        } else {
        ...
        if (raw != null) {
            ...
            while (i < rawArray.length) {
                ...
                if (rawArray[i].isEmpty()) {
                    ...
                    String splitData;
                    System.out.println("aasa" + rawArray[i].substring(0, 1));
                    if (!rawArray[i].substring(0, 1).equals("6") && !rawArray[i].substring(0, 1).equals("8") && (splitData = rawArray[i].substring(1)) != null && splitData != "") {
                        splitData = "|" + rawArray[i].substring(0, 1) + splitData;
                        System.out.println("aasasas" + splitData);
