...
System.out.println(GL14PATR + CT03DOCNO + " HANDLER CIRCULAATION");


if(GL14PATR == "" || GL14PATR == " " || GL14PATR == null)
{
	out.println("033");
}
else if(CT03DOCNO=="")
...
chr= new Charging();
chr.charge(CT03DOCNO,GL14PATR, Date, DateTime.formatTimetoDB(Time), DateTime.displayToDBFormat(chargeDate), DateTime.formatTimetoDB(chargeTime), username);
chr.getErrMessage();
