	...
	<div id="exTab2" class="container" style="width:100%">	
			...
			<div class="tab-content " style="height:60%;overflow-y:auto">
			  <div class="tab-pane active" id="1">
					...
					%>
         			<table class="table table-bordered table-condensed onloantbl" style="font-size:10pt">
         				 <thead>
					      <tr>
					        <th>Accession No</th>
					        <th>Call No</th>
					        ...
					        <th>Due Date/Time</th>
					  		<th><input type="checkbox" name="checkAllPStatus" id="checkAllPStatus" onclick="checkAllPStatus()"> Action</th>   
					      </tr>
					    </thead>
					    <tbody>
         				<%
         				...
         				<tr>
         					...
         					<td>
         					<input type="checkbox" name="reprint" value="<%=i.getCI02DOCNO() %>">
         					<%-- <button class="btn btn-primary" id='reprint' title="Print Slip" data-acc="<%=i.getCI02DOCNO() %>" onclick="reprint(this)">
         			...
         			<button class="btn btn-primary" id='reprint' title="Print Slip" onclick="reprint()">
         							<span class="glyphicon glyphicon-print" style="color:white"></span>
         						</button>
				</div>
