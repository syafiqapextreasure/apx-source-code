						...
						<div class="col-xs-10 col-sm-6 col-md-6 col-lg-6">
        						<div class="input-group" id="patronSearchMode" >
									<div class="input-group-btn" style="width:20%">
										<select class="text-value form-control" id="patronsearch">
                       						 <option  data-value="patronId">ID</option>
                       						 <option data-value="patronName">Name</option>
                        					<option data-value="patrnic">New IC</option>
                        					<option data-value="patonic">Old IC</option>
                   					 </select> 
                   					 </div>
            						<input type="text" class="form-control" id="patronSearchInput" >
            							<span class="input-group-btn">
									<button class="btn btn-primary btn-md" type="button" id="btn_submitIsy" title="Search">
