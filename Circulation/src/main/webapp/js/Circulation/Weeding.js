...
//									 swal("", "Record is successfully weeded", "success");
//									}else{
//									 swal("", "Record is unsuccessfully weeded", "error");
//									}
//									  
//								  });
//										},function(dismiss) {
			...
			closeOnCancel: false 
				...
				$.get("Handler_Weeding",{CT03DOCNO:CT03DOCNO, reason:reason},function(list){
					...
					if(list.trim()=="OK"){
						...
						swal({
							  title: "",
							  text: "Record is successfully weeded",
							  icon: "success"
							}).then((result) => {
								  swal({   
										title: "Do you like to delete BO?",
										...
										closeOnCancel: false 
											 ...
											 var details =JSON.parse(localStorage.getItem('array'));
											 $("#displayBO").modal("show");
											 $.get("Modal_BORecord",{CT03DOCNO:details.CT03DOCNO,action:"deleteBO"},function(listS){
												console.log(listS)
												$("#BORecord").html(listS);
//												if(listS.trim()=="OK"){
//													swal("", "Record is successfully weeded", "success");
