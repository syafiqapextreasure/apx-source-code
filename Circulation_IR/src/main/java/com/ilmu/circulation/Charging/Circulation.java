...
public class Circulation {
    ...
    public Circulation(String CI02DOCNO, String CT05CALL, String CT05TITLE, String CI02BDATE, String CI02DDATE, String CI02DTIME, String CI02BTIME) {
        this.CI02DOCNO = CI02DOCNO;
        this.CT05CALL = CT05CALL;
        this.CT05TITLE = CT05TITLE;
        this.CI02BDATE = CI02BDATE;
    ...
    public static List<Circulation> patronStatus(String patrID, String flag) {
        ...
        String sql = null;
        if (flag.equals("C")) {
            sql = "Select T1.CI02DOCNO, T1.CI02CDATE, T1.CI02DDATE, T1.CI02CTIME, T1.CI02DTIME,T4.CT05SRAW as CallNo, T6.CT05SRAW as Title from CICIRC T1 INNER JOIN CTDOCM T2 ON T1.CI02DOCNO = T2.CT03DOCNO INNER JOIN CTPONT T3 ON T2.CT03MATNO = T3.CT06MATNO INNER JOIN CTCALL T4 ON T4.CT05POINTER=T3.CT06POINTER INNER JOIN CTPONT T5 ON T2.CT03MATNO = T5.CT06MATNO INNER JOIN CTTITL T6 ON T6.CT05POINTER = T5.CT06POINTER where T3.CT06TAG = '090' and T5.CT06TAG = '245' and T1.CI02PATR='" + patrID + "' and T1.CI02FLAG='" + flag + "'";
        } else if (flag.equals("R")) {
            sql = "Select T1.CI03DOCNO, T1.CI03RDATE, T1.CI03RTIME, T4.CT05SRAW as CallNo, T6.CT05SRAW as Title from CIRESV T1 INNER JOIN CTPONT T3 ON T1.CI03MATNO = T3.CT06MATNO INNER JOIN CTCALL T4 ON T4.CT05POINTER=T3.CT06POINTER INNER JOIN CTPONT T5 ON T1.CI03MATNO = T5.CT06MATNO INNER JOIN CTTITL T6 ON T6.CT05POINTER = T5.CT06POINTER where T3.CT06TAG = '090' and T5.CT06TAG = '245' and T1.CI03PATR='" + patrID + "'";
        } else if (flag.equals("O")) {
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd");
            Date date = new Date();
            String currentdate = dateFormat.format(date).toString();
            sql = "Select T1.CI02DOCNO, T1.CI02CDATE, T1.CI02DDATE, T1.CI02CTIME, T1.CI02DTIME, T4.CT05SRAW as CallNo, T6.CT05SRAW as Title from CICIRC T1 INNER JOIN CTDOCM T2 ON T1.CI02DOCNO = T2.CT03DOCNO INNER JOIN CTPONT T3 ON T2.CT03MATNO = T3.CT06MATNO INNER JOIN CTCALL T4 ON T4.CT05POINTER=T3.CT06POINTER INNER JOIN CTPONT T5 ON T2.CT03MATNO = T5.CT06MATNO INNER JOIN CTTITL T6 ON T6.CT05POINTER = T5.CT06POINTER where T3.CT06TAG = '090' and T5.CT06TAG = '245' and T1.CI02PATR='" + patrID + "' and T1.CI02FLAG='C' and T1.CI02DDATE<" + currentdate;
        }
        System.out.println(sql);
        try {
            ...
            if (flag.equals("C") || flag.equals("O")) {
                while (rsObj.next()) {
                    patronDetail = new Circulation(rsObj.getString("CI02DOCNO"), Handler.rawToDisplayFormat(rsObj.getString("CallNo")), Handler.rawToDisplayFormat(rsObj.getString("Title")), DateTime.formatDate(rsObj.getString("CI02CDATE")), DateTime.formatDate(rsObj.getString("CI02DDATE")), DateTime.Time(rsObj.getString("CI02CTIME")), DateTime.Time(rsObj.getString("CI02DTIME")));
                    list.add(patronDetail);
                }
            } else if (flag.equals("R")) {
                while (rsObj.next()) {
                    patronDetail = new Circulation(rsObj.getString("CI03DOCNO"), Handler.rawToDisplayFormat(rsObj.getString("CallNo")), Handler.rawToDisplayFormat(rsObj.getString("Title")), DateTime.formatDate(rsObj.getString("CI03RDATE")), DateTime.Time(rsObj.getString("CI03RTIME")));
                    list.add(patronDetail);
                }
            }
        }
    ...
    public static String getStatus(String CT03DOCNO) {
        ...
        try {
            try {
                ...
                rs = ps.executeQuery();
                if (rs.next()) {
                    result = String.valueOf(rs.getString("CT03STAT")) + "," + rs.getString("GL36DESC");
                }
            }
            catch (SQLException e) {
                e.printStackTrace();
