		  ...
		  <ul class="nav side-menu">
				<li class="header">MAIN NAVIGATION</li>
                                        ...
                                        <a><i class="glyphicon glyphicon-wrench"></i> Maintenance <i class="fa fa-angle-left pull-right"></i></a>
			                             ...
			                             <li><i class="fa fa-angle-left pull-right"></i><a href="template?MODULE=Circulation/02_Reservation&ACTION=MainPage.jsp"><i class="fa fa-circle-o text-red"></i>Reservation</a>
                                        </li>
                                         <li><i class="fa fa-angle-left pull-right"></i><a href="template?MODULE=Cataloging/02_Bibliographic_Organisation&ACTION=listBibRecord.jsp"><i class="fa fa-circle-o text-red"></i>Bibliographic Organisation</a></li>
                                         <li><i class="fa fa-angle-left pull-right"></i><a href="template?MODULE=Cataloging/03_Accession_Maintenance&ACTION=MainPage.jsp"><i class="fa fa-circle-o text-red"></i>Accession Maintenance</a></li>
                                          ...
                                          <li><i class="fa fa-angle-left pull-right"></i><a href="template?MODULE=Circulation/05_Item_Reassignment&ACTION=Item_Reassignment.jsp"><i class="fa fa-circle-o text-red"></i>Item Reassignment</a></li>
                                          <li><i class="fa fa-angle-left pull-right"></i><a href="template?MODULE=Circulation/06_Item_Status_Maintenance&ACTION=Item_Status_Maintenance.jsp"><i class="fa fa-circle-o text-red"></i>Iteam Status Maintenance</a></li>
										</ul>
                                         </li>
										<li>
