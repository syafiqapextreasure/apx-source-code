							...
							<tr>
								<td>	
									...
									<input type="hidden" id="hiddenPatrId" value="<%=i.getCI02PATR()%>">
											...
											<button class="btn btn-primary btn-sm" id='override' title="Refresh" data-toggle="modal" 
									data-target="#overrideModal"><i class="fa fa-refresh" aria-hidden="true" style="color:white"></i></button>
								</td>
