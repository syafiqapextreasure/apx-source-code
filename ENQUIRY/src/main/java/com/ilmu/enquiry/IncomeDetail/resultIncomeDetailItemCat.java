...
import com.ilmu.enquiry.IncomeDetail.IncomeDetailItemCat;
...
@WebServlet(value={"/resultIncomeDetailItemCat"})
public class resultIncomeDetailItemCat
extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        tableIncomeDetail = IncomeDetailItemCat.GetSQLStmt(txtFrom, txtTo, patrCate, brancodeValue, patrCateValue, chkOfficer, officer, chkBranch, branchVal, chkPaymentMode, paymodeVal, chkCharge, chargeVal, chkPayment, payVal, chkOverride, overrideVal, chkOthers, otherVal);
        Gson gson = new Gson();
