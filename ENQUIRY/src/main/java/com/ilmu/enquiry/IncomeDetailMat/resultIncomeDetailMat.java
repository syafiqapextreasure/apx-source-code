...
import com.ilmu.enquiry.IncomeDetailMat.IncomeDetailMat;
...
@WebServlet(value={"/resultIncomeDetailMat"})
public class resultIncomeDetailMat
extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Object> tableIncomeDetailMat = new ArrayList();
        tableIncomeDetailMat = IncomeDetailMat.GetSQLStmt(txtFrom, txtTo, patrCate, brancodeValue, patrCateValue, chkOfficer, officer, chkBranch, branchVal, chkPaymentMode, paymodeVal, chkCharge, chargeVal, chkPayment, payVal, chkOverride, overrideVal, chkOthers, otherVal);
        Gson gson = new Gson();
        JsonElement element = gson.toJsonTree(tableIncomeDetailMat, new TypeToken<List<IncomeDetailMat>>(){}.getType());
        System.out.println("tableIncomeDetailMat : " + element);
