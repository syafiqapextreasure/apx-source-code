...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/enquiry/IncomeDetails.js"></script>
								...
								<div class="col-md-6 sQ1">
						  			<fieldset class="scheduler-border">
										...
										<div class="form-check">
								  			...
								  			<label class="form-check-label" for="chkPaymentMode">Payment Mode</label>
										</div>
										<div class="form-check">
