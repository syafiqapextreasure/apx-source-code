						...
						buttons: [
					             ...
					             },
								{
										...
										customize: function (doc) {
											...
											doc.content[1].table.widths = [ '14%', '3%', '5%','9%', '8%', '15%', '10%', '15%','9%', '7%','7%',];
											//var cols = [];
								...
								drawCallback: function ( settings ) {
									$('.branchtotal div').remove();
								            ...
								            total[group_assoc]=intVal(api.column(10).data()[i]);
								              ...
								              if ( last !== group ) {
								                    $(rows).eq( i ).before(
								                        //'<tr class="group"><td colspan="8">'+group+'</td><td class="'+group_assoc+'"></td></tr>'
														'<tr class="group"><td colspan="6">'+group+'</td><td style="text-align:right" class="'+group_assoc+'"></td><td></td></tr>'
								                    );
