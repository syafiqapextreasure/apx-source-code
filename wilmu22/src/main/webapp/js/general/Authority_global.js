...
function getDetails(details){
	...
	$.get("AutGlobal_Change",{actionID:"TermRetrieval",criteria:title,tag:tag},function(data_title){
...
$("#viewtag, #accept").click(function(){
	...
	var term = $("#term").val();
	$("#modaltag").modal("show");
	$.get("AutGlobal_Change",{actionID:"Modal_TagChange",pointer:pointer, term:term},function(data){
...
$("#delete").click(function(){
	...
	swal({   
				...
				closeOnCancel: false 
					...
					$.get("AutGlobal_Change",{actionID:"Handler_DeleteRecord",pointer:pointer, tag:tag},function(data){
