	...
	$('#Reterive').click(function(){
		...
		switch(chkBoxSearchCateria) {
		  case 'pateCate':
			...
			titleHeader = "Membership Catergory";
		  ...
		  case 'itemcate':
			...
			titleHeader = "Item Catergory";
			$(head_item ).html(titleHeader);
		    // code block
		    break;
/*		  case 'brch':
				searchCateriaval = $('#brch').val();
                ...
                /*'excel', 'pdf', 'print'*/
						{
					        ...
					        title: 'Circulation Activity By '+titleHeader,
							...
							//doc.content[1].table.body[0][3].alignment = 'right';
							 ...
							 //doc.content[1].table.body[0][5].alignment = 'right';
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Circulation Activity By '+titleHeader+' \n',bold:true,fontSize:13,alignment: 'center'},
						                                   /////{ text: $("#libname").val() +'\n',bold:true,fontSize:13,alignment: 'center'},
						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					    ...
					    },
						{
					        ...
					        customize: function ( win ) {
							    ...
							    style = win.document.createElement('style');
							                ...
							                head.appendChild(style);
					 						...
					 						$(win.document.body).prepend( "<div class='center'><b>Circulation Activity By "+titleHeader+"</b></div>");
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Circulation Activity By "+titleHeader +"\n\n" + doc;
										//var split_csv = doc.split("\n");
