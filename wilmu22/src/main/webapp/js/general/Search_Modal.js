		...
		function getURL(identifier){
			...
			var title = $('.criteria').val();
			 ...
			 if(searchType=="selection"){
				...
				$(".catsearch").click();
				$.get("Accession_Maint",{actionID:"Table_SearchByAccNo",txtMatNo : title, type:type,module:module},function(data){
			...
			/*	loader("#display_title");*/
				...
				$("#result_title").collapse('show');
				loader("#display_title");	 
				$.get("RetrieveSearchTitle",{criteria:title,search_type:searchType,tag:tag,action:action,type:type,module:module},function(data_title){
					$("#display_title").html(data_title);
				});
