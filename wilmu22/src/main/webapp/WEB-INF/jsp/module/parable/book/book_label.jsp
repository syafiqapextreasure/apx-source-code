<%-- <%@ include file="/module/book/book_spine_controller.jsp" %>
<%@ include file="book_spineScript.jsp" %>
<%@page import="parable_beta.Config_Print, parable_beta.CurrentUser"%> --%>

<%@page import="com.kmlink.ilmu.parable.parable_beta.object.labelBranch"%>
<%@page import="com.kmlink.ilmu.parable.parable_beta.object.labelLocation"%>
<%@page import="com.kmlink.ilmu.parable.parable_beta.Config_Print, com.kmlink.ilmu.parable.parable_beta.CurrentUser"%>


<%@ include file="/WEB-INF/jsp/module/parable/book/book_label_controller.jsp" %>
<%@ include file="book_labelScript.jsp" %>
<style>
input[type=date]{
 max-width:184px;
}
...
$(function(){
	...
	$("#search_by").change(function(){
		...
		$("#index_date1").val("").datepicker('update');
		$("#index_date1").datepicker("setDate", new Date());
		$("#index_date1").val("").datepicker('update');
		$("#index_date2").val("").datepicker('update');
		$("#index_date2").datepicker("setDate", new Date());
		$("#index_date2").val("").datepicker('update');
		$("#index_date12").val("").datepicker('update');
		$("#index_date12").datepicker("setDate", new Date());
		$("#index_date12").val("").datepicker('update');
		$("#index_date22").val("").datepicker('update');
		$("#index_date22").datepicker("setDate", new Date());
		$("#index_date22").val("").datepicker('update');
		$("#index_date13").val("").datepicker('update');
		$("#index_date13").datepicker("setDate", new Date());
		$("#index_date13").val("").datepicker('update');
		$("#index_date23").val("").datepicker('update');
		$("#index_date23").datepicker("setDate", new Date());
		$("#index_date23").val("").datepicker('update');
		$("#index_date14").val("").datepicker('update');
		$("#index_date14").datepicker("setDate", new Date());
		$("#index_date14").val("").datepicker('update');
		$("#index_date24").val("").datepicker('update');
		$("#index_date24").datepicker("setDate", new Date());
		$("#index_date24").val("").datepicker('update');
		$("#catalog_date1").val("").datepicker('update');
		$("#catalog_date1").datepicker("setDate", new Date());
		$("#catalog_date1").val("").datepicker('update');
		$("#catalog_date2").val("").datepicker('update');
		$("#catalog_date2").datepicker("setDate", new Date());
		$("#catalog_date2").val("").datepicker('update');
		$("#catalog_date12").val("").datepicker('update');
		$("#catalog_date12").datepicker("setDate", new Date());
		$("#catalog_date12").val("").datepicker('update');
		$("#catalog_date22").val("").datepicker('update');
		$("#catalog_date22").datepicker("setDate", new Date());
		$("#catalog_date22").val("").datepicker('update');
		$("#catalog_date13").val("").datepicker('update');
		$("#catalog_date13").datepicker("setDate", new Date());
		$("#catalog_date13").val("").datepicker('update');
		$("#catalog_date23").val("").datepicker('update');
		$("#catalog_date23").datepicker("setDate", new Date());
		$("#catalog_date23").val("").datepicker('update');
		$("#catalog_date14").val("").datepicker('update');
		$("#catalog_date14").datepicker("setDate", new Date());
		$("#catalog_date14").val("").datepicker('update');
		$("#catalog_date24").val("").datepicker('update');
		$("#catalog_date24").datepicker("setDate", new Date());
		$("#catalog_date24").val("").datepicker('update');
	})
	$("#checkAll").change(function() {
	    $("input:checkbox[name=selectedValue[]]").prop('checked', $(this).prop("checked"));
	});
...
<div style= "padding:10px 10%">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title" style="display:inline">Book Label </h3><span style="display:inline;font-size:8pt"></span>
		</div>
		<div class="panel-body">
		<form class="form-horizontal" action="print_Details.jsp" method="post">
			<div class = "row">
			...
			<div id="queryDetail">
	 			<div class="form-group" id = "catalog_date"> 
			    	<label class="control-label col-sm-2" for="catalog_date1">Catalog Date :</label>
			    	<script>
			    	$(function(){
			    		var FromEndDate;
			    		var ToEndDate;
			    		var startDate;
			    		  $('#catalog_date1').datepicker({
		    		        ...
		    		        startDate.setDate(startDate.getDate(new Date(selected.date.valueOf())));			    		        $('#catalog_date2').datepicker('setStartDate', startDate);
		    		        });
			    	...
			    	<div class="col-sm-2">
			    	<input name="catalog_date1" id = "catalog_date1" class="form-control" type="text" readonly="readonly"/>
			    	</div>
			    	<div class="col-sm-1">
			    	<label for="catalog_date2" style = "margin:0 10"> to </label>
			    	</div>
			    	<div class="col-sm-2">
			    	<input name="catalog_date2" id = "catalog_date2"  class="form-control" type="text" readonly="readonly"/>
		  			</div>
		  		</div>
		  		<div class = "form-horizontal" id = "branch">
		  		<div class="form-group">
		  			<label for="branch" class="control-label col-sm-2">Branch 200:</label>
			    	<div class="col-sm-3">
			    	...
			    	<div class="form-group">
		  			...
		  			<div class="form-group">
			    		<label for="index_date1"  class="control-label col-sm-2"><input type="radio" name="location_radio" id="location_radio_2">
				    	Index Date :</label>
				    	<script>
				    	$(function(){
				    		var FromEndDate;
	 			...
	 			<div class="form-group" id = "index_date">
			    	<label class="control-label col-sm-2" for="index_date1">Index Date :</label>
			    	<script>
			    	$(function(){
			    		var FromEndDate;
			    		var ToEndDate;
	 			...
	 			<div class="form-group" id = "accession_no">
			    	...
			    	<div class="col-sm-2">
			    	<input name="first_number" class="form-control" type="text" maxlength="10"/>
			    	</div>
			    	<div class="col-sm-1">
			    	<label for="second_number" style = "margin:0 10"> to </label>
			    	</div>
			    	<div class="col-sm-2">
			    	<input name="second_number" class="form-control" type="text" maxlength="10"/>
		  			</div>
		  		</div>
		  		...
		  		<div class = "form-group" id = "call_no">		
			    	<label class="control-label col-sm-2" for="call_number">Call No. :</label>
			    	<div class="col-sm-2">
			    	<input name="call_number1" class="form-control" type="text"/>
			    	</div>
			    	 <div class="col-sm-1">
			    	<label for="call_number1" style = "margin:0 10"> to </label>
			    	</div>
			    	<div class="col-sm-2">
			    	<input name="call_number2" class="form-control" type="text"/>
		  			</div>
		  		</div>
		  		<div class = "form-group" id = "control_no">		
			    	<label class="control-label col-sm-2" for="control_number">Control No. :</label>
			    	<div class="col-sm-2">
		  		...
		  		<div class = "form-horizontal" id = "item_cat">	
					<div class="form-group"> 
			    	<label class="control-label col-sm-2" for="item_category">Item Category :</label>
			    	<div class="col-sm-3">
			    	<select name="item_category" class="form-control">
   		 			...
   		 			<div class="form-group">   		 			
			    		<label class="control-label col-sm-2" for="catalog_date1"><input type="radio" name="category_radio" id="category_radio_1" checked>
				    	Catalog Date :</label>
				    	<script>
				    	$(function(){
				    		var FromEndDate;
		  			...
		  			<div class="form-group">
				    	<label for="index_date1" class="control-label col-sm-2"><input type="radio" name="category_radio" id="category_radio_2">Index Date :</label>
				    	<script>
				    	$(function(){
				    		var FromEndDate;
				    		var ToEndDate;
			...
			<div class="form-group">
					...
					List<Config_Print> tpl = Config_Print.retrieveTpl("B", branch);
					%>
	...
	<div class = "panel panel-default">
		...
		<div class="panel-body">
			<form method="post" id = "selectedValue" action ="print_Details" target="printForm">
				...
				<div style = "max-height:500px;overflow: auto;">
					<table class="table table-bordered book_table" id = "queryResult" style = "max-width:100%">
