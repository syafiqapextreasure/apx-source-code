    ...
    <div class="container" style="margin-top:40px">
        ...
        <table border="1" id="myTable2" class="table">
            ...
            <c:forEach var="location" items="${listLocation}">
                <c:set var="test" value="${location.colourCode}" />
                <%
...
// 						System.out.println(str); 
				...
				%>
                <tr>
                    <td>${location.ppatCode}</td>
                    <td>${location.colourDescription}</td>
                    <td>${location.colourSequence}</td>
                    <td style="background-color:${rgb}"></td>
                    <%-- 				<td>${location.colourCode}</td> --%>
                    <td><a href="update/<c:out value='${location.colourSequence}'/>">Update Colour Code</a> |</br> <a href="delete/<c:out value='${location.colourCode}'/>" onclick="return confirm('Are you sure you want to delete this colour?');">Delete Colour Code</a></td>
                </tr>
            </c:forEach>
        </table>
