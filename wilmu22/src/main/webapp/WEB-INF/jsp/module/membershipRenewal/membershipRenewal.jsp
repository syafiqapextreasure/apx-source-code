...
<div class="container">
				<div class="col-md-12">
					...
					<input type="text" maxlength="12" name="patronId" id="patronId">&nbsp
...
<!-- 						<a href="Modal_MemberPatrSearch" id="searchPatronID" class="input-group-addon btn btn-primary searchheadLib" data-toggle="modal" data-target="#modal_searchPatronID" style="width: 55px;">
				...
				<div class="col-md-12" style="margin-bottom: 10px;top: 5px;">
					<div class="col-md-8" >
						<label>Names:</label><span id="patronName" style="margin-left: 103px;"></span>
					</div>
				</div>
				<div class="col-md-12">
					<div class="col-md-2">
					...
					<div class="col-md-6" style=" margin-top: 12px;">						
						<textarea name="patronAddr" id="patronAddr"  cols="40" rows="5" readonly></textarea>
					</div>	
					<div class="col-md-4">
				...
				<div class="col-md-12" style="top: 10px;margin-bottom: 10px;">
					<div class="col-md-5">
						<label>Membership Date:</label><span id="membershipDate" style="margin-left: 50px;"></span>
					</div>

					<div class="col-md-6">
						<label>Expired Date:</label><span id="expiredDate" style="margin-left: 50px;"></span>
					</div>	
				</div>	
				<div class="col-md-12" style="margin-bottom: 10px;">
					<div class="col-md-5">
						<label>Recorded By:</label><span id="recordedBy" style="margin-left: 50px;"></span>
					</div>

					<div class="col-md-6" id="divNewExpDate">
						<label>New Expiry Date:</label><span id="newExpDate" style="margin-left: 28px;"></span>
					</div>			
				</div>	
       			...
       			<div class="col-md-12 col-lg-12">			
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#item" data-toggle="tab" aria-expanded="false"><strong>Other Information</strong></a></li>
			             	<li><a href="#personalInfo" data-toggle="tab"><strong>Personal Information</strong></a></li>       
						</ul>
					   		...
					   		<div class="box-body">
							  	<div class="form-group row">
								    ...
								    <div class="col-sm-4">
								  	...
								  	<div class="form-group row">
								    	<label for="ItemCategory" class="col-sm-2 col-form-label">Date of Birth</label>
								    <div class="col-sm-4">
								      	<span id="DOB"></span>
								    </div>
								  	</div>
