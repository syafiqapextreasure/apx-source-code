...
<input id="action" type="hidden" value="delete" />

<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<span aria-hidden="true">&times;</span>
	</button>
	<h4 class="modal-title">Delete Reserve</h4>
</div>
...
<!--                             <div class="col-sm-1 col-md-1">
                        ...
                        <div class="col-md-12" style="margin-bottom: 5px;">
                            <div class="col-md-3"><input type="checkbox" class="form-check-input" name="startDateCB" id="startDateCB" disabled/> Start Date :</div>
                            <div class="col-md-4">
                        ...
                        <div class="col-md-12" style="margin-bottom: 5px;">
                            <div class="col-md-3"><input type="checkbox" class="form-check-input" name="endDateCB" id="endDateCB" disabled/> End Date :</div>
                            <div class="col-md-4">
