	...
	<%@ page import="com.kmlink.ilmu.shared.circulation.Charging.*, java.util.List"%>
		...
		%>
			<tr value="<%= i.getGL66DESC()%>" class="patrid" data-dismiss="modal">
				...
				<td>
					...
					<%
						}else if(action.equals("charge")||action.equals("batchrenewal")){
					%>
					...
					%>
					<button title="" onclick="getResvColPatrId('<%= i.getGL66DESC()%>')" class="btn btn-sm btn-default" data-original-title="Select" data-dismiss="modal">
						<i class="fa fa-check"></i> Select
					</button>
					<%
						}else if(action.equals("searchMembershipDetail")){
					%>
					<button title="" onclick="getMemberDetail('<%= i.getGL66DESC()%>')" class="btn btn-sm btn-default" data-original-title="Select" data-dismiss="modal">
						<i class="fa fa-check"></i> Select
					</button>
					<%
						}
