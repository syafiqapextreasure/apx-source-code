...
import com.kmlink.ilmu.reserveCollection.reserve.GeneralUtility;
...
public class Patron {
    ...
    public static List<Patron> retrievePatron(String criteria, String searchType, String cate_id, String sort) throws SQLException {
        ArrayList<Patron> patrMisc;
        block23: {
            patrMisc = new ArrayList<Patron>();
            try {
                try {
                    conn = DBConnection.getConnection();
                    stmt = conn.createStatement();
        ...
        System.out.println("patrMisc: " + patrMisc);
        return patrMisc;
    }
