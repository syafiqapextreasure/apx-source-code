...
public class ReprintReminder {
    ...
    public static List<OverdueNotification> getReprintReminder(String reprintDate, String reminder) throws ParseException {
        String sqlReprintedDate = String.valueOf(reprintDate.substring(6, 10)) + reprintDate.substring(3, 5) + reprintDate.substring(0, 2);
        DBConnection db = new DBConnection();
        String mssqlQuery1 = "SELECT T1.CI02DOCNO, T1.CI02FLAG, T1.CI02SENT1, T9.GL27GRACE1\r\n,CONCAT(T1.CI02PATR ,', ', T6.GL14NAME)AS CI02PATR\r\n,REPLACE(REPLACE(REPLACE(REPLACE(T3.CT05SRAW, '|a',''),'|b', ' : '),'|c',' / '), '|f',', ') AS CT05SRAW\r\n,REPLACE(REPLACE(T5.CT05SRAW, '|a',''),'|b', ' ') AS CallNo\r\n,T1.CI02DDATE\r\n,DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' )\r\n" + ",T6.GL14IPADD\r\n" + ",T8.GL05BRNC AS Branch\r\n" + ",T7.CT03LOCA AS Location\r\n" + ",T9.GL27CATE, T9.GL27ICAT, T9.GL27SMD\r\n" + "FROM CICIRC T1\r\n" + "LEFT JOIN CTPONT T2 ON (T2.CT06MATNO = T1.CI02MATNO AND T2.CT06TAG = '245')\r\n" + "LEFT JOIN CTTITL T3 ON (T2.CT06POINTER = T3.CT05POINTER)\r\n" + "LEFT JOIN CTPONT T4 ON (T4.CT06MATNO = T1.CI02MATNO AND T4.CT06TAG = '090')\r\n" + "LEFT JOIN CTCALL T5 ON (T4.CT06POINTER = T5.CT05POINTER)\r\n" + "LEFT JOIN GLPATR T6 ON (T6.GL14PATR = T1.CI02PATR)\r\n" + "LEFT JOIN CTDOCM T7 ON (T7.CT03DOCNO = T1.CI02DOCNO)\r\n" + "LEFT JOIN GLLOCA T8 ON (T7.CT03LOCA = T8.GL05LOCA)\r\n" + "LEFT JOIN GLELIG T9 ON (T9.GL27CATE = T6.GL14CATE AND T9.GL27ICAT = T7.CT03ICAT AND T9.GL27SMD = T7.CT03SMD AND T9.GL27BRNC=T8.GL05BRNC)\r\n" + "WHERE CI02FLAG = 'C' AND CI02DDATE <='" + sqlReprintedDate + "' AND T9.GL27GRACE1>0\r\n" + "AND CI02SENT1 = ''\r\n" + "AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' )>=T9.GL27GRACE1 AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' )<=T9.GL27GRACE2\r\n" + "ORDER BY CI02PATR, CI02DDATE";
        String mysqlQuery1 = "SELECT T1.CI02DOCNO\r\n,CONCAT(T1.CI02PATR ,', ', T6.GL14NAME)AS CI02PATR\r\n,REPLACE(REPLACE(REPLACE(REPLACE(T3.CT05SRAW, '|a',''),'|b', ' : '),'|c',' / '), '|f',', ') AS CT05SRAW\r\n,REPLACE(REPLACE(T5.CT05SRAW, '|a',''),'|b', ' ') AS CallNo\r\n,T1.CI02DDATE\r\n,DATEDIFF ( '" + sqlReprintedDate + "' , T1.CI02DDATE ) - (SELECT COUNT(*) FROM GLHOLIDAY WHERE T8.GL05BRNC=GL30BRNC AND GL30DATE BETWEEN T1.CI02DDATE AND '" + sqlReprintedDate + "') AS ACTUALDAY\r\n" + ",T6.GL14IPADD\n" + ",T8.GL05BRNC AS Branch\n" + ",T7.CT03LOCA AS Location\n" + ",T9.GL27CATE, T9.GL27ICAT, T9.GL27SMD\r\n" + "FROM CICIRC T1\r\n" + "LEFT JOIN CTPONT T2 ON (T2.CT06MATNO = T1.CI02MATNO AND T2.CT06TAG = '245')\r\n" + "LEFT JOIN CTTITL T3 ON (T2.CT06POINTER = T3.CT05POINTER)\r\n" + "LEFT JOIN CTPONT T4 ON (T4.CT06MATNO = T1.CI02MATNO AND T4.CT06TAG = '090')\r\n" + "LEFT JOIN CTCALL T5 ON (T4.CT06POINTER = T5.CT05POINTER)\r\n" + "LEFT JOIN GLPATR T6 ON (T6.GL14PATR = T1.CI02PATR)\r\n" + "LEFT JOIN CTDOCM T7 ON (T7.CT03DOCNO = T1.CI02DOCNO)\r\n" + "LEFT JOIN GLLOCA T8 ON (T7.CT03LOCA = T8.GL05LOCA)\r\n" + "LEFT JOIN GLELIG T9 ON (T9.GL27CATE = T6.GL14CATE AND T9.GL27ICAT = T7.CT03ICAT AND T9.GL27SMD = T7.CT03SMD AND T9.GL27BRNC=T8.GL05BRNC)\r\n" + "WHERE CI02FLAG = 'C' AND CI02DDATE <='" + sqlReprintedDate + "' AND CI02SENT1 = ''\r\n" + "AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' ) >=1 AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' ) <=7\r\n" + "ORDER BY CI02PATR, CI02DDATE";
        String mssqlQuery2 = "SELECT T1.CI02DOCNO, T1.CI02FLAG, T1.CI02SENT2, T9.GL27GRACE2\r\n,CONCAT(T1.CI02PATR ,', ', T6.GL14NAME)AS CI02PATR\r\n,REPLACE(REPLACE(REPLACE(REPLACE(T3.CT05SRAW, '|a',''),'|b', ' : '),'|c',' / '), '|f',', ') AS CT05SRAW\r\n,REPLACE(REPLACE(T5.CT05SRAW, '|a',''),'|b', ' ') AS CallNo\r\n,T1.CI02DDATE\r\n,DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' )\r\n" + ",T6.GL14IPADD\r\n" + ",T8.GL05BRNC AS Branch\r\n" + ",T7.CT03LOCA AS Location\r\n" + ",T9.GL27CATE, T9.GL27ICAT, T9.GL27SMD\r\n" + "FROM CICIRC T1\r\n" + "LEFT JOIN CTPONT T2 ON (T2.CT06MATNO = T1.CI02MATNO AND T2.CT06TAG = '245')\r\n" + "LEFT JOIN CTTITL T3 ON (T2.CT06POINTER = T3.CT05POINTER)\r\n" + "LEFT JOIN CTPONT T4 ON (T4.CT06MATNO = T1.CI02MATNO AND T4.CT06TAG = '090')\r\n" + "LEFT JOIN CTCALL T5 ON (T4.CT06POINTER = T5.CT05POINTER)\r\n" + "LEFT JOIN GLPATR T6 ON (T6.GL14PATR = T1.CI02PATR)\r\n" + "LEFT JOIN CTDOCM T7 ON (T7.CT03DOCNO = T1.CI02DOCNO)\r\n" + "LEFT JOIN GLLOCA T8 ON (T7.CT03LOCA = T8.GL05LOCA)\r\n" + "LEFT JOIN GLELIG T9 ON (T9.GL27CATE = T6.GL14CATE AND T9.GL27ICAT = T7.CT03ICAT AND T9.GL27SMD = T7.CT03SMD AND T9.GL27BRNC=T8.GL05BRNC)\r\n" + "WHERE CI02FLAG = 'C' AND CI02DDATE <='" + sqlReprintedDate + "' AND T9.GL27GRACE2>0\r\n" + "AND CI02SENT2 = ''\r\n" + "AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' )>=T9.GL27GRACE2 AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "'  )<=T9.GL27GRACE3\r\n" + "ORDER BY CI02PATR, CI02DDATE";
        String mysqlQuery2 = "SELECT T1.CI02DOCNO\r\n,CONCAT(T1.CI02PATR ,', ', T6.GL14NAME)AS CI02PATR\r\n,REPLACE(REPLACE(REPLACE(REPLACE(T3.CT05SRAW, '|a',''),'|b', ' : '),'|c',' / '), '|f',', ') AS CT05SRAW\r\n,REPLACE(REPLACE(T5.CT05SRAW, '|a',''),'|b', ' ') AS CallNo\r\n,T1.CI02DDATE\r\n,DATEDIFF ( '" + sqlReprintedDate + "' , T1.CI02DDATE ) - (SELECT COUNT(*) FROM GLHOLIDAY WHERE T8.GL05BRNC=GL30BRNC AND GL30DATE BETWEEN T1.CI02DDATE AND '" + sqlReprintedDate + "') AS ACTUALDAY\r\n" + ",T6.GL14IPADD\n" + ",T8.GL05BRNC AS Branch\n" + ",T7.CT03LOCA AS Location\n" + ",T9.GL27CATE, T9.GL27ICAT, T9.GL27SMD\r\n" + "FROM CICIRC T1\r\n" + "LEFT JOIN CTPONT T2 ON (T2.CT06MATNO = T1.CI02MATNO AND T2.CT06TAG = '245')\r\n" + "LEFT JOIN CTTITL T3 ON (T2.CT06POINTER = T3.CT05POINTER)\r\n" + "LEFT JOIN CTPONT T4 ON (T4.CT06MATNO = T1.CI02MATNO AND T4.CT06TAG = '090')\r\n" + "LEFT JOIN CTCALL T5 ON (T4.CT06POINTER = T5.CT05POINTER)\r\n" + "LEFT JOIN GLPATR T6 ON (T6.GL14PATR = T1.CI02PATR)\r\n" + "LEFT JOIN CTDOCM T7 ON (T7.CT03DOCNO = T1.CI02DOCNO)\r\n" + "LEFT JOIN GLLOCA T8 ON (T7.CT03LOCA = T8.GL05LOCA)\r\n" + "LEFT JOIN GLELIG T9 ON (T9.GL27CATE = T6.GL14CATE AND T9.GL27ICAT = T7.CT03ICAT AND T9.GL27SMD = T7.CT03SMD AND T9.GL27BRNC=T8.GL05BRNC)\r\n" + "WHERE CI02FLAG = 'C' AND CI02DDATE <='" + sqlReprintedDate + "' AND CI02SENT2 = ''\r\n" + "AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' )>=1 AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' )<=45\r\n" + "ORDER BY CI02PATR, CI02DDATE";
        String mssqlQuery3 = "SELECT T1.CI02DOCNO, T1.CI02FLAG, T1.CI02SENT3, T9.GL27GRACE3\r\n,CONCAT(T1.CI02PATR ,', ', T6.GL14NAME)AS CI02PATR\r\n,REPLACE(REPLACE(REPLACE(REPLACE(T3.CT05SRAW, '|a',''),'|b', ' : '),'|c',' / '), '|f',', ') AS CT05SRAW\r\n,REPLACE(REPLACE(T5.CT05SRAW, '|a',''),'|b', ' ') AS CallNo\r\n,T1.CI02DDATE\r\n,DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "' )\r\n" + ",T6.GL14IPADD\r\n" + ",T8.GL05BRNC AS Branch\r\n" + ",T7.CT03LOCA AS Location\r\n" + ",T9.GL27CATE, T9.GL27ICAT, T9.GL27SMD\r\n" + "FROM CICIRC T1\r\n" + "LEFT JOIN CTPONT T2 ON (T2.CT06MATNO = T1.CI02MATNO AND T2.CT06TAG = '245')\r\n" + "LEFT JOIN CTTITL T3 ON (T2.CT06POINTER = T3.CT05POINTER)\r\n" + "LEFT JOIN CTPONT T4 ON (T4.CT06MATNO = T1.CI02MATNO AND T4.CT06TAG = '090')\r\n" + "LEFT JOIN CTCALL T5 ON (T4.CT06POINTER = T5.CT05POINTER)\r\n" + "LEFT JOIN GLPATR T6 ON (T6.GL14PATR = T1.CI02PATR)\r\n" + "LEFT JOIN CTDOCM T7 ON (T7.CT03DOCNO = T1.CI02DOCNO)\r\n" + "LEFT JOIN GLLOCA T8 ON (T7.CT03LOCA = T8.GL05LOCA)\r\n" + "LEFT JOIN GLELIG T9 ON (T9.GL27CATE = T6.GL14CATE AND T9.GL27ICAT = T7.CT03ICAT AND T9.GL27SMD = T7.CT03SMD AND T9.GL27BRNC=T8.GL05BRNC)\r\n" + "WHERE CI02FLAG = 'C' AND CI02DDATE <='" + sqlReprintedDate + "' AND T9.GL27GRACE3>0 AND CI02SENT3 = ''\r\n" + "AND DATEDIFF ( DAY , T1.CI02DDATE , '" + sqlReprintedDate + "'  )>=T9.GL27GRACE3\r\n" + "ORDER BY CI02PATR, CI02DDATE";
        String mysqlQuery3 = "SELECT T1.CI02DOCNO, T1.CI02PATR\r\n,CONCAT(T1.CI02PATR ,', ', T6.GL14NAME)AS patronIDName\r\n,REPLACE(REPLACE(REPLACE(REPLACE(T3.CT05SRAW, '|a',''),'|b', ' : '),'|c',' / '), '|f',', ') AS CT05SRAW\r\n,REPLACE(REPLACE(T5.CT05SRAW, '|a',''),'|b', ' ') AS CallNo\r\n,T1.CI02DDATE\r\n,DATEDIFF ( '" + sqlReprintedDate + "' , T1.CI02DDATE ) - (SELECT COUNT(*) FROM GLHOLIDAY WHERE T8.GL05BRNC=GL30BRNC AND GL30DATE BETWEEN T1.CI02DDATE AND '" + sqlReprintedDate + "') AS ACTUALDAY\r\n" + ",T6.GL14IPADD\r\n" + ",T8.GL05BRNC AS Branch\r\n" + ",T7.CT03LOCA AS Location\r\n" + ",T9.GL27CATE, T9.GL27ICAT, T9.GL27SMD\r\n" + "FROM CICIRC T1\r\n" + "LEFT JOIN CTPONT T2 ON (T2.CT06MATNO = T1.CI02MATNO AND T2.CT06TAG = '245')\r\n" + "LEFT JOIN CTTITL T3 ON (T2.CT06POINTER = T3.CT05POINTER)\r\n" + "LEFT JOIN CTPONT T4 ON (T4.CT06MATNO = T1.CI02MATNO AND T4.CT06TAG = '090')\r\n" + "LEFT JOIN CTCALL T5 ON (T4.CT06POINTER = T5.CT05POINTER)\r\n" + "LEFT JOIN GLPATR T6 ON (T6.GL14PATR = T1.CI02PATR)\r\n" + "LEFT JOIN CTDOCM T7 ON (T7.CT03DOCNO = T1.CI02DOCNO)\r\n" + "LEFT JOIN GLLOCA T8 ON (T7.CT03LOCA = T8.GL05LOCA)\r\n" + "LEFT JOIN GLELIG T9 ON (T9.GL27CATE = T6.GL14CATE AND T9.GL27ICAT = T7.CT03ICAT AND T9.GL27SMD = T7.CT03SMD AND T9.GL27BRNC=T8.GL05BRNC)\r\n" + "WHERE CI02FLAG = 'C' AND CI02DDATE <='" + sqlReprintedDate + "' AND CI02SENT3=''\r\n" + "ORDER BY CI02PATR, CI02DOCNO\r\n";
        ArrayList<OverdueNotification> OverdueResult = new ArrayList<OverdueNotification>();
        System.out.println(sqlReprintedDate);
