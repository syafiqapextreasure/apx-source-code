...
import com.kmlink.ilmu.cataloging.Template_Maint.SQLStatement;
...
extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (accNo != null) {
                query = "  Select distinct CT05SRAW, CT03MATNO, CT03DOCNO from CTTITL,CTPONT, CTDOCM where CT06POINTER=CT05POINTER and CT03MATNO=CT06MATNO and CT03DOCNO='" + accNo + "' and ct06tag='245'";
                ...
                while (rs2.next()) {
                    al = new ArrayList();
                    raw = ISBD.getSubfield(rs2.getString("CT05SRAW"), isbd);
                    al.add(raw);
                ...
                while (rs1.next()) {
                    al1 = new ArrayList();
                    raw = ISBD.getSubfield(rs1.getString("CT05SRAW"), callisbd);
                    al1.add(raw);
