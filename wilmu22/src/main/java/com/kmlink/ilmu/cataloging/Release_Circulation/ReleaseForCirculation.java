 ...
 */
package com.kmlink.ilmu.cataloging.Release_Circulation;
...
public class ReleaseForCirculation {
    ...
    public static boolean updateRelease(String CT03DOCNO) throws SQLException {
    ...
    public static boolean itemOnHold(String CT03DOCNO) throws SQLException {
        System.out.println(DateTime.displayToDBFormat(DateTime.getTodayDate()));
        HashMap<String, String> valueStr = new HashMap<String, String>();
        HashMap<String, String> condition = new HashMap<String, String>();
        condition.put("CT03DOCNO", CT03DOCNO);
