    ...
    public static String createInsertQuery(String table, Map<String, String> map, Map<String, Integer> intMap, Map<String, Double> doubleMap) {
        ...
        if (table.equals("CTWORK") || table.equals("CTSUBJ") || table.equals("CTAUTH") || table.equals("CTCALL") || table.equals("CTINDX") || table.equals("CTPUBL") || table.equals("CTSERI") || table.equals("CTTITL") || table.equals("MPDATA")) {
            ...
            while (it.hasNext()) {
                ...
                column = String.valueOf(column) + pair.getKey();
                value = ((String)pair.getValue()).isEmpty() ? String.valueOf(value) + null : String.valueOf(value) + "'" + replaceValue + "'";
                if (!it.hasNext()) continue;
                column = String.valueOf(column) + ", ";
                value = String.valueOf(value) + ", ";
            }
    ...
    public static String createString(Map<String, String> conditionMap) {
        ...
        while (it.hasNext()) {
            ...
            if (pair.getKey().equals("Tag")) {
                marc_record = String.valueOf(marc_record) + "<td>" + pair.getValue() + "</td>";
            }
            if (pair.getKey().equals("Indi1")) {
                marc_record = String.valueOf(marc_record) + "<td>" + pair.getValue() + "</td>";
            }
            if (pair.getKey().equals("Indi2")) {
                marc_record = String.valueOf(marc_record) + "<td>" + pair.getValue() + "</td>";
            }
            if (!pair.getKey().equals("Data")) continue;
            marc_record = String.valueOf(marc_record) + "<td>" + pair.getValue() + "</td>";
        }
        return marc_record;
    }
