...
public class Handler {
    ...
    public static String removeSubfield1(String raw) {
        StringBuilder result = new StringBuilder();
        if (raw != null) {
            String[] rawArray = raw.split("\\|");
            int i = 1;
    ...
    public static String defaultValue(String data) {
        if (data == null) {
            data = "Default";
        }
        return data;
    ...
    public static String getSubfield2(String raw, List<ISBD> isbd) {
        StringBuilder result = new StringBuilder();
        if (raw != null && raw.contains("|")) {
            String[] rawArray = raw.split("\\|");
            int i = 1;
        ...
        System.out.println("1" + newString.substring(0, index));
        System.out.println("2" + newString.substring(index + 1));
        newString = newString.substring(0, index).trim();
    ...
    public static String circStat(String data) {
        if (data.equals("C")) {
            data = "Circulated";
    ...
    public static String removeSubf1(String raw) {
        String newString = null;
        StringBuilder result = new StringBuilder();
        try {
            String[] rawArray;
            newString = raw.replaceAll("\\|[a-z]", "");
            String[] stringArray = rawArray = raw.split("\\|");
