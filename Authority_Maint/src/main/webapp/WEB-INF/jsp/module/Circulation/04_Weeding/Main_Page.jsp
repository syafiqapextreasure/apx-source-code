       			...
       			<div class="col-md-12 col-lg-12">
       				<div class="form-group row">
						<label class="col-sm-2 col-form-label" for="CT03DOCNO">Accession No :</label>
							<div class="col-sm-2">
								<input type="text" maxlength="10" class="form-control" id="CT03DOCNO">
						    ...
						    <div class="col-sm-2">
						    	 <a  href='RetrieveTitleModal?action=8' class="btn btn-primary" data-toggle="modal" data-target="#searchWeed" title="Search"><span class="glyphicon glyphicon-search"></span></a>
