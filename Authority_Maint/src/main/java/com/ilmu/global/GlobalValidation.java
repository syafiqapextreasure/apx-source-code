...
public class GlobalValidation {
    ...
    public static boolean checkSubfield(String string, String string2) {
        throw new Error("Unresolved compilation problem: \n\tThe method getNonRepeatSubf(String) is undefined for the type Subfield_Handler\n");
    }

    public static String chkifsubfexist(String string, String string2) {
        throw new Error("Unresolved compilation problem: \n\tThe method SubfieldList(String) is undefined for the type BO_Validation\n");
    }
