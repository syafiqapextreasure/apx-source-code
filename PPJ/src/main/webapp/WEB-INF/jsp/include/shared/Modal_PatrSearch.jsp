...
<%@page import="com.wilmu.foundation.patroncategory.data.GetFndPatronCategory"%>
...
<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">
 ...
 <%
  ...
  <div class="modal-header">
     <button type="button" class="close closemodalpatr" data-dismiss="modal" aria-label="Close">
