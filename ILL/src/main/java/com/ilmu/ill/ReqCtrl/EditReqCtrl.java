...
@WebServlet(value={"/EditReqCtrl"})
public class EditReqCtrl
extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            sucess = ReqCtrl.EditCurrentRecord(sRequestNo, gsUserId, reqID, lendLib, doctype, dexpect, predevtype, title, issn, author, placePub, pub, yearPub, edition, remarks, vol, iss, pageno);
            if (sucess) {
                String gsModule = "CI";
                RecordTransaction.InsertAudit(gsModule, "CIU0007", sRequestNo, gsUserId);
            }
