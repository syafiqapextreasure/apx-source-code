...
<body>
	      	...
	      	<div class="panel-body" id="statusCombine">
	      		<div class="row">
	       			<div class="col-md-12 col-lg-12">
						...
						<form role="form" class="form-horizontal" id="serachreqathour">
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<div class="input-group">
													<input type="text" class="form-control idOfficer" id="txtRequestor" name="txtRequestor">
													<a href="Modal_PatrSearch" id="searchreqid" class="input-group-addon btn btn-primary" data-toggle="modal" data-target="#modal_searchreqidSearch">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<div class="input-group">
													...
													<a href="Modal_PatrSearch?textid=libid" id="searchLibraryId" class="input-group-addon btn btn-primary searchpatr" data-toggle="modal" data-target="#modal_searchLibraryId">
														<span class="glyphicon glyphicon-option-horizontal"></span></a>
												</div>
											</div>
										</div>
										...
										<div class="btn-group pull-right ">	
											<div class="col-md-1"><button type="button" id="button-retrievereq" class="btn btn-primary" title="Retrieve"><span class="glyphicon glyphicon-log-in" style="color:white"></span></button></div>
	...
	<!-- Modal END modal search -->
  	...
  	<div class="modal fade" id="modal_searchLibraryId" tabindex="-1" role="dialog" aria-labelledby="modal_searchLibraryId" data-keyboard="false" data-backdrop="static">
	...
	<div class="modal fade" id="modal_searchreqidSearch" tabindex="-1" role="dialog" aria-labelledby="modal_searchreqidSearch" data-keyboard="false" data-backdrop="static"> 
