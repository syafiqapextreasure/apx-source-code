					...
					<div  class="panel-collapse collapse in" id="search_title">
						...
						<div class="form-group">
							<label><input type="radio" name="retrieveRadios"
								id="optradio" value="course" checked="checked">Course Code </label><br/>
							<label><input type="radio" name="retrieveRadios"
								id="optradio" value="subject" checked="checked">Subject </label><br/>
							<label><input type="radio" name="retrieveRadios"
								id="optradio" value="semester">Semester Code </label>
							<label><input type="radio" name="retrieveRadios"
								id="optradio" value="instructor">Instructor Id </label><br/>
							<label><input type="radio" name="retrieveRadios"
