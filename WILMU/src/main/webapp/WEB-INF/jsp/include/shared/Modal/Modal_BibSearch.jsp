<%@ page import="com.wilmu.cataloging.bibliographic.data.*, java.text.*,java.util.*, com.wilmu.foundation.glflag2.data.*"%>
							...
							<%-- 	<%
								...
								<div class="form-group">
									...
									<select class="form-control tags" id="type" name="type">
										<%
											List<GetCatBibType> type = GetCatBibType.getBibType();
											for(GetCatBibType i: type){	
										%>
								...
								boolean searchByAcc = false;
								if(action.equals("7")){
									String search = GetGlflag2.getGlflag2Value("SEARCHBYACC");
									searchByAcc = true;
								}else if(action.equals("5")){
									searchByAcc = true;
								}
								...
								<div class="form-group">		
									...
									<div class="col-sm-4 col-md-4">
										<%								
								List<GetCatTag> TagInfo = null;
								TagInfo = GetCatTag.getBibTag();
								%>
									<select class="form-control tags" id="select_tags" name="tags" disabled>
										<option value="0">Please select</option>
										<%
										for(GetCatTag i: TagInfo){
										%>
