...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/ILL_Incoming_Request/Report/AALR0150.js"></script>
</head>
<body>
	<!-- START MAIN CONTENT -->
							...
							<div class="input-group">
								<select class="input-sm" style="width:17vw;" name="requestorName-text" id="requestorName-text">
									<jsp:include
										...
										<jsp:param name="requestorCode" value="INCOMING" /></jsp:include>
								</select>
							</div>
						</div>
					</div>
				...
				<table id="reportTable" class="table table-bordered table-striped">
					...
					<tfoot>
						<tr>
							...
							<th id="totalService" style="padding:8px 10px;"></th>
							<th id="totalHandling" style="padding:8px 10px;"></th>
							<th id="totalDiscount" style="padding:8px 10px;"></th>
							<th id="totalSum" style="padding:8px 10px;"></th>
							<th></th>
						</tr>
					</tfoot>
				</table>
