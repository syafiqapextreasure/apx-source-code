...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/Binding/Listing/AABL0150.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/general/vendor.js"></script>
</head>
<body>
	<!-- START MAIN CONTENT -->
						...
						<div class="col-sm-3">
							<div class="form-check">
								<select id="itemType" name="itemType">
									<option value="M">Monograph</option>
