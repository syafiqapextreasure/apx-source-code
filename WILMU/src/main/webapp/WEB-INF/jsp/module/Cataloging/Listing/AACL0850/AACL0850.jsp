...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/Cataloging/Listing/AACL0850.js"></script>
</head>
<body>
	<!-- START MAIN CONTENT -->
			...
			<div class="panel-body">
				<form class="form-horizontal">
						...
						<div class="form-group">
							<div class="col-sm-2 col-md-2">
								<label class="form-check-label"> <input
									...
									id="dateSelection" value="04CREDATE"
							...
							<div class="col-sm-2 col-md-2">
								<label class="form-check-label dateselectioinlabel"> <input
									class="form-check-input" type="radio" name="dateSelection"
									id="dateSelection" value="04MODIDATE"
					...
					<div class="form-group">
						<div class="col-sm-2 col-md-2">
							<label><input class="form-check-input" type="checkbox"
								value="range" id="chkBoxRangeControlNo"> Control No
								Range</label>
						</div>
						<div class="col-sm-4">
