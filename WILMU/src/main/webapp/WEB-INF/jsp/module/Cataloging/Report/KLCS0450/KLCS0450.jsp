...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Cataloging/Report/KLCS0450.js"></script>
					...
					<div class="panel-body" id="display_fndReportnListing">
						...
						<form class="form-horizontal" name="catReportnListing" id="catReportnListing">
							...
							<div class="form-group rangeCallnoDiv">
								<div class="col-sm-2 col-md-2">
									<input class="form-check-input" type="checkbox" value="rangeClassno" id="chkBoxRangeClassno">
									<label class="rangeLabel">Class No Range</label>
								</div>
									<div class="col-sm-4">
										<div class="input-group">
											<input type="text" class="input-sm form-control startInputClassno"  name="startInputClassno"
												id="startInputClassno" autocomplete="off"/> <span class="input-group-addon">to</span>
											<input type="text" class="input-sm form-control endInputClassno" name="endInputClassno" id="endInputClassno" autocomplete="off"/>
										</div>
									</div>
							</div>
						   ...
						   <div class="form-group locaDiv">
							...
							<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-2 col-md-2">
										<label class="form-check-label">
											<input class="form-check-input" type="radio" name="dataView" id="dataView" value="cathol" checked>
											Catalog Holding
										</label>
									</div>
									<div class="col-sm-2 col-md-2">
										<label class="form-check-label dateselectioinlabel">
											<input class="form-check-input" type="radio" name="dataView" id="dataView" value="unclassified">
											Unclassified
										</label>
									</div>
									<div class="col-sm-2 col-md-2">
										<label class="form-check-label dateselectioinlabel">
											<input class="form-check-input" type="radio" name="dataView" id="dataView" value="undefined">
											Undefined
										</label>
									</div>
								</div>
