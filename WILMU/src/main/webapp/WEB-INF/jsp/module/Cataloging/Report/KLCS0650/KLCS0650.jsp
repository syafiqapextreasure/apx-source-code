...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Cataloging/Report/KLCS0650.js"></script>
					...
					<div class="panel-body" id="display_fndReportnListing">
						...
						<form class="form-horizontal" name="catReportnListing" id="catReportnListing">
								...
								<div class="form-group">
									<div class="col-sm-2 col-md-2">
										<label class="form-check-label">
											<input class="form-check-input" type="radio" name="reporttype" id="reporttype" value="Unclassified"  checked>
											Unclassified
										</label>
									</div>
									<div class="col-sm-2 col-md-2">
										<label class="form-check-label dateselectioinlabel">
											<input class="form-check-input" type="radio" name="reporttype" id="reporttype" value="Undefined" >
											Undefined
										</label>
									</div>
								</div>
							...
							<div class="form-group rangeCallnoDiv">
								<div class="col-sm-2 col-md-2">
									<input class="form-check-input" type="checkbox" value="rangeCallno" id="chkBoxRangeCallno">
									<label class="rangeLabel">Call No Range</label>
								</div>
									<div class="col-sm-4">
										<div class="input-group">
											<input type="text" class="input-sm form-control startInputCallno"  name="startInputCallno"
												id="startInputCallno" autocomplete="off"/> <span class="input-group-addon">to</span>
											<input type="text" class="input-sm form-control endInputCallno" name="endInputCallno" id="endInputCallno" autocomplete="off"/>
										</div>
									</div>
							</div>
							
							<div class="form-group branchDiv">
								<div class="col-sm-2 col-md-2"><label><input class="form-check-input" type="checkbox" name="chkBoxBranch" id="chkBoxBranch" value="branchCheckbox">
									Branch</label></div>
									<div class='col-sm-6'>
						   ...
						   <div class="form-group locaDiv">
								<div class="col-sm-2 col-md-2"><label><input class="form-check-input" type="checkbox" name="chkBoxLoca" id="chkBoxLoca" value="location">
									Location</label></div>
									<div class='col-sm-6'>
										<div class="form-check">
							...
							<div class="form-group cattypeDiv">
								<div class="col-sm-2 col-md-2"><label><input class="form-check-input" type="checkbox" name="chkBoxCattype" id="chkBoxCattype" value="catelogingtype">
									Catalog Type</label></div>
									<div class='col-sm-6'>
										<div class="form-check">
						...
						<br><br>
						<div class="divTableUnclassified">
						...
						<div class="divTableUndefined">
						<table id="catreportTableUndefined" class="table table-bordered table-striped display compact" width="100%">
						 <thead>
						 	<tr>
						 		<th>No</th>
						 		<th>Control No</th>
