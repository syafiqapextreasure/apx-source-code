...
<%
	...
	String fcode = request.getParameter("selection");
    ...
    List<GetFndCode> fcodelist = GetFndCode.getFndFcodeCodeandDesc(fcode);
        	...
        	for(GetFndCode i: fcodelist)
        	{
        		...
        		output += "<input class='form-check-input' type='checkbox' name='selectionendyear' id='selectionendyear' value='" + i.getCode() + "'> ";
        		output += i.getDesc();
        		output += "</label>";
        		output += "</div>";
