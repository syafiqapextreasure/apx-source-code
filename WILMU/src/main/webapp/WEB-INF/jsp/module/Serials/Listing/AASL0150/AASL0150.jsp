...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Serials/Listing/AASL0150.js"></script>
					...
					<input type="hidden" id='setupCurrency' disabled> 
						...
						<form class="form-horizontal" name="ReportnListing" id="ReportnListing">
							...
							<div class="form-group div1">
								<div class="col-sm-2 ordertypeDiv">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="ordType" id="chkBoxOrderType">
											<label class="form-check-label">Order Type</label>
									</div>
								</div>
								<div class='col-sm-4 ordertypeDiv'>
									<div class="form-check">
										<select id="seordertype" multiple="multiple" name="seordertype">
											<jsp:include page="../../../../module/Select_Fndcode.jsp">
												<jsp:param name="fcode" value="AA" /> 
											</jsp:include>
										</select>
									</div>
								</div>
						...
						<table id="reportTable" class="table table-bordered table-striped display compact" width="100%">
						 ...
						 <!--<tfoot align="right">
							<tr><th></th>
						 		<th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th>Total Amount : </th><th></th></tr>
						</tfoot>-->
						</table>
