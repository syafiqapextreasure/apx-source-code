...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Serials/Report/AASR0250.js"></script>
						...
						<table id="reportTable" class="table table-bordered table-striped display compact" width="100%">
						 <thead>
						 	<tr>
								...
								<th>ISSN</th>
								<th>Title</th>
								<th>1st Claim Date</th>
								<th>2nd Claim Date</th>
								<th>3rd Claim Date</th>
								<th>Issues</th>
								<th>Copies</th>
								<th>Local Price</th>
						 	</tr>
