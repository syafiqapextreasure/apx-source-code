...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Serials/Listing/AASL0250.js"></script>
				...
				<div class="panel panel-default">
					...
					<input type="hidden" id='setupCurrency' disabled> 
						...
						<form class="form-horizontal" name="ReportnListing" id="ReportnListing">
							...
							<input type="hidden" class="controlSelection" value = "c">
							<jsp:include page="../../../../include/shared/Selection/ControlNo.jsp"></jsp:include> 
