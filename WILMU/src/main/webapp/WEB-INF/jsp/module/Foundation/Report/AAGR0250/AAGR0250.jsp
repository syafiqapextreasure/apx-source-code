...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Foundation/Report/AAGR0250.js"></script>
					...
					<div class="panel-body" id="display_fndReportnListing">
						...
						<form class="form-horizontal" name="fndReportnListing" id="fndReportnListing">
							...
							<div class="form-group dateDiv">
								<div class="col-sm-2 col-md-2 dateLabel"><label>Payment Date Range</label></div>
									<div class="col-sm-4">
