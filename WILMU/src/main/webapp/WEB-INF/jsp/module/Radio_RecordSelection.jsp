...
<%
	...
	String fcode = request.getParameter("recordselec");
    ...
    List<GetFndCode> fcodelist = GetFndCode.getFndFcodeCodeandDesc(fcode);
        	...
        	for(GetFndCode i: fcodelist)
        	{
        		...
        		output += "<input class='form-check-input' type='radio' name='radioRecordselection' id='radioRecordselection' value='" + i.getCode() + "'> ";
        		output += i.getDesc();
        		output += "</label>";
        		output += "</div>";
