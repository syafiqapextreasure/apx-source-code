...
<div class="form-group">
	<div class="col-sm-2 col-md-2">
		<label class="form-check-label">Item Category
		</label>
	</div>
	<div class='col-sm-4'>
		<div class="form-check">
	...
	<div class="col-sm-2 col-md-2">
		<label class="form-check-label">Patron Category
		</label>
	</div>
	<div class='col-sm-4'>
		<div class="form-check">
...
<div class="form-group">
	<div class="col-sm-2 col-md-2 smd">
		<label class="form-check-label"> <input
			class="form-check-input clickSmd" type="radio" name="chkBoxSearchCateria"
			id="radioSmd" value="smd"> SMD
		</label>
	</div>
	...
	<div class="col-sm-2 col-md-2">
		<label class="form-check-label"> <input
			class="form-check-input clickLoca" type="radio" name="chkBoxSearchCateria"
			id="radioLoca" value="loca"> Location
		</label>
	</div>
	<div class='col-sm-4'>
		<div class="form-check">
