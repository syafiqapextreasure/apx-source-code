...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/Circulation/Report/AARR0350.js"></script>
</head>
<body>
	<!-- START MAIN CONTENT -->
				...
				<form class="form-horizontal">
					<div class="form-group">
						<div class="col-sm-2 col-md-2">
							<label for="requestDate">Reservation date from </label>
						</div>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<div class="col-sm-2 col-md-2">
							<label> <input type="checkbox" id="branchSelect"
								name="chkBoxBranchCateria" value="Y"> Pickup Branch
							</label>
						</div>
						<div class="col-sm-2">
