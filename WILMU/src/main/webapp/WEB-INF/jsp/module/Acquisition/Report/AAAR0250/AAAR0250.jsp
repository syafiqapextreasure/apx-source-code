...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Acquisition/Report/AAAR0250.js"></script>
				...
				<div class="panel panel-default">
					...
					<input type="hidden" id='setupCurrency' disabled> 
						...
						<div class="form-group">
							<div class="col-sm-3">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="date" id="chkBoxDate">
											<label class="form-check-label">Claim Date Range</label>
									</div>
							</div>
						...
						<table id="reportTable" class="table table-bordered table-striped display compact" width="100%">
						 ...
						 <tfoot align="right">
						<!--	<tr><th></th>
						 		<th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th>Total : </th><th></th></tr> -->
						</tfoot>
						</table>
