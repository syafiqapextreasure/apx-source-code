		...
		<table id="reqCtrl" class="table table-bordered table-striped" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td class="last">
						<button id="View" class="btn btn-primary btn-sm" data-toggle='modal' data-target="#modalreqCtrl" data-mode="3" title="View Request Control" data-rowid="<%=reqCtrl.getreqno()%>"><span class="glyphicon glyphicon-eye-open"></span></button>
						<button id="Edit" class="btn btn-info btn-sm" data-toggle='modal' data-target="#modalreqCtrl" data-mode="2" title="Edit Request Control" data-rowid="<%=reqCtrl.getreqno()%>"><span class="glyphicon glyphicon-pencil"></span></button>
		   				<button id="Delete" class="btn btn-dull btn-sm DeleteReq" data-reqno="<%=reqCtrl.getreqno()%>" data-Status="<%=reqCtrl.getstatus()%>" onclick="deleteRequest(this)"><span class="glyphicon glyphicon-trash" title="Delete Request Control"></span></button>
					</td>
				</tr>
				<%
					}
