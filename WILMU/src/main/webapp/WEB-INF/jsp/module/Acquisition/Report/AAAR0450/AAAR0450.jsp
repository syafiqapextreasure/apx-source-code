...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Acquisition/Report/AAAR0450.js"></script>
				...
				<div class="panel panel-default">
					...
					<input type="hidden" id='setupCurrency' disabled> 
						...
						<table id="reportTable" class="table table-bordered table-striped display compact" width="100%">
						 ...
						 <tfoot align="right">
							<!-- <tr>
								<th></th><th></th><th></th><th></th><th></th><th></th><th>Total Quantity : </th><th></th><th></th><th>Total Amount : </th><th></th>
							</tr> -->
						</tfoot>
						</table>
