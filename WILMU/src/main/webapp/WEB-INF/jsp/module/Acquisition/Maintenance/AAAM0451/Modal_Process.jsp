<script type="text/javascript" src="${pageContext.request.contextPath}/js/Acquisition/Order.js"></script>					
				...
				<div id="search" class="panel-collapse collapse in">
					<div class="panel-body">
						<form role="form" class="form-horizontal" id="current_form"
							...
							<div class="form-group">
								<div class="col-sm-2">
									<label for="checkbox-orderDate">Skip Printing: </label>
								</div>
								<div class="col-sm-3">
									<label for="checkbox-orderDate">
									<input type="checkbox" id="orderLetter" name="processCheck" value="orderLetter">Order Letter
									</label>
								</div>
								<div class="col-sm-3">
									<label for="checkbox-orderDate">
									<input type="checkbox" id="notification" name="processCheck" value="notification">Request Notification Letter</label>
								</div>
							</div>
						</form>
					</div>
