...
<head> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/Acquisition/Report/AAAR0550.js"></script>
						...
						<div class="form-group">
							<div class="col-sm-3 col-md-3">
								<label class="form-check-label dateselectioinlabel">
									<input class="form-check-input" type="radio" name="dateSelection" id="dateSelection" value="orderdate" data-name="Order Date Range" checked>
									Order Date Range
								</label>
							</div>
							<div class="col-sm-3 col-md-3">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="dateSelection" id="dateSelection" value="receiveddate" data-name="Received Date Range">
									Received Date Range
								</label>
							</div>
							<div class="col-sm-3 col-md-3">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="dateSelection" id="dateSelection" value="invoicedate" data-name="Invoice Date Range">
									Invoice Date Range
								</label>
							</div>
						</div>
