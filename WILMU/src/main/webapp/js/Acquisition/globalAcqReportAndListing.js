$(document).ready(function() {
	...
	$('#ordermode, #acqStat, #acct, #dept, #acqinvstat, #acqitemstat').multiselect({
    	allSelectedText: 'All',
   		maxHeight: 200,
	...
	$(" #ordermode, #acqStat, #acct, #dept, #acqinvstat, #acqitemstat").multiselect("disable");
	
	$("#startInput, #endInput").prop( "disabled", true);
	$("#lblPatronID, #input-vendorCode").prop( "disabled", true);
	...
	$('.vendorCode, .patronid').prop('disabled', true);
