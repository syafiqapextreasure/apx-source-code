$(document).ready(function() {
	...
	$('#ordermode, #dept, #acqinvstat, #acqStat').multiselect({
    	allSelectedText: 'All',
   		maxHeight: 200,
   		includeSelectAllOption: true,
		numberDisplayed: 1,
	...
	$("#ordermode, #dept, #acqinvstat, #acqStat").multiselect("disable");
		    ...
		    ajax: {
				...
				footerCallback: function ( row, data, start, end, display ) {
		           ...
		           /*$( api.column( 9 ).footer() ).html(
		            ...
		            $("#allTotalAmountOrder").text(" "+numFormat(totalLocalPrice));
		        }
    	});
