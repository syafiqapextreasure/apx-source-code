$(document).ready(function() {
	...
	$("#bySMD-select").multiselect("disable");
	...
	$('#byBranch-select').on('change click', function(e) {
	...
	$('#Reterive').click(function() {
		...
		var title = 'WILMU Vendor Performance Report \n Created Date ';
		...
		$('#reportTable').DataTable({
			...
			buttons: [
				{
					extend: 'excelHtml5',
					filename: 'WILMU_Vendor Performance Report',
					title: title,
				},
				{
				...
				dataSrc: function(json) {
					...
					$.each(json, function(_key, value) {
						return_data.push({
							...
							'Date Ordered': value.dateOrdered,
							'Date Received': value.dateReceived,
