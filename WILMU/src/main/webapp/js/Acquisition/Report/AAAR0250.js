$(document).ready(function() {
	...
	$("#input-startDate, #input-endDate").prop( "disabled", true);
	 ...
	 $("#rbClaimStat").attr('disabled', true);
	...
	$(".dateDiv, .patronSearch, .statusDiv, .acctDiv, .itemstatDiv").hide();
	...
	$("#chkBoxDate").on('change', function () {
	    ...
	    if (self.is(":checked")) {
			...
			$("input[type=radio][name=radioclaimstat][value=U]").prop("disabled",true);
			...
			$("input[type=radio][name=radioclaimstat][value=U]").prop("disabled",false);
	    }
	});
