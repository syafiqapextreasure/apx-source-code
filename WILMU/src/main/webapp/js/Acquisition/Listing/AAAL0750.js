	...
	$('#Reterive').click(function(){
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_AcqOrderListing',
					        title: 'Order Listing ' +sDate +eDate,
					 	...
					 	},
						{
							...
							doc.content.push( {
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Order Listing '+sDate +eDate+ '\n',bold:true,fontSize:13,alignment: 'center'}						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Order Listing "+sDate + eDate +"\n\n" + doc;
									 }
             			},
            ],
			destroy: true,
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
		                ...
		                'Call No' : json[i].Column3,
						'Title' : json[i].Column4,
		                'Vendor' : json[i].Column5,
						'Sets' : json[i].Column6,
						'Copies' : json[i].Column7,
						'Forex' : json[i].Column8,
						'Foreign Price' : json[i].Column9,
						'Local Price' : json[i].Column10,												
						'Total Price' : json[i].Column11,
		            })
		            }
		     	...
		     	columns    : [
					...
					{'data': 'Copies'},
					{'data': 'Forex'},
					{'data': 'Foreign Price', className: "text-right"},					
