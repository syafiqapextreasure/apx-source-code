	...
	$('#Reterive').click(function(){
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_AcqUnclaimedItemList',
					        title: 'Unclaimed Item List ' +sDate +eDate,
					 	...
					 	},
						{
								...
								var rowCount = doc.content[1].table.body.length;
							 	...
							 	//doc.content[1].table.widths = [ '8%', '55%', '12%', '12%', '12%']; 
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Unclaimed Item List '+sDate +eDate+ '\n',bold:true,fontSize:13,alignment: 'center'}						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Unclaimed Item List "+sDate + eDate +"\n\n" + doc;
									 }
             			},
            ],
			destroy: true,
			...
			footer: true,
		    ajax: {
		    	url: "ResultAcqUnclaimedItemList",
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
						...
						'Copies/Sets' : json[i].Column5,
						'Received' : json[i].Column6,
						'Balance' : json[i].Column7,												
		            })
		            }
