	...
	$('#Reterive').click(function(){
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_AcqOrderCancellationList',
					        title: 'Order Cancellation List ' +sDate +eDate,
					 	...
					 	},
						{
								...
								var rowCount = doc.content[1].table.body.length;
							 	...
							 	//doc.content[1].table.widths = [ '8%', '55%', '12%', '12%', '12%']; 
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Order Cancellation List '+sDate +eDate+ '\n',bold:true,fontSize:13,alignment: 'center'}						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
		                	extend: 'csv',
		                	filename: 'WILMU_AcqOrderCancellationList',
		                	//title: 'Order Cancellation List By ',
							charset: "utf-8",
							bom : "true",
							customize: function(doc){
										...
										return "Order Cancellation List "+sDate + eDate +"\n\n" + doc;
									 }
             			},
            ],
			destroy: true,
			...
			footer: true,
		    ajax: {
		    	url: "ResultAcqOrderCancellationList",
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
		                ...
		                'Ref No' : json[i].Column2,
		                'Title/Author' : json[i].Column3,
		                'Order Date' : json[i].Column4,
						'Vendor' : json[i].Column5,
						'Feedback' : json[i].Column6,						
		            })
		            }
