$(document).ready(function() {
	...
	$("#rbRrcdSelection").attr('disabled', true);
	...
	$('#Reterive').click(function(){
		...
		if(recordselection=="F"){
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_AcqRequestList',
					        title: 'Request List ' +sDate +eDate,          
					 	},
						{
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Request List "+sDate + eDate +"\n\n" + doc;
									 }
             			},
            ],
			destroy: true,
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
						...
						'Author' : json[i].Column7,
						'Publication' : json[i].Column8,
						'Edition' : json[i].Column9,
						'Control No' : json[i].Column10,
						'Quantity' : json[i].Column11,
		            })
		            }
