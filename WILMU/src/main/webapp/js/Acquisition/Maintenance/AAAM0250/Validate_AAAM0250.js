                ...
                validators: {
                	callback: {
                        ...
                        callback: function(value, validator) {
                            ...
                            var options = validator.getFieldElements('acqMode').val();
                            return (options != null && options!="Please select");
                        }
                    }
                }
            },
		 		...
		 		$.post("insertOrderMaint", { 
		 	        ...
		 	        function(data,status){
							...
							$(".orderno2").val('');
			    	            ...
			    	            for(var i=0;i< json.length; i++){
			    	            	t.row.add( [
			    	    			            ...
			    	    			            json[i].oderDate,
			    	    			            json[i].amount,
			    	    			            '<button id="View" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalOdrMaint" data-mode="3" title="View Order" data-rowid="'+json[i].orderNumber+'"><span class="glyphicon glyphicon-eye-open"></span></button> <button id="Edit" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalOdrMaint" data-mode="2" title="Edit Order" data-rowid="'+json[i].orderNumber+'"><span class="glyphicon glyphicon-pencil"></span></button> <button id="Delete" class="btn btn-dull btn-sm DeleteOrder" data-OrderNo="'+json[i].orderNumber+'"><span class="glyphicon glyphicon-trash" title="Delete Oder" ></span></button>'
			    	    			        ] ).draw( false );
			    	            }
			    		 });
		 	        	...
		 	        	$('#formdataOrderMain').data('bootstrapValidator').resetForm();
      			        ...
      			        $("#title, #namePatr, #dept, #datereq").empty();
		    			 ...
		    			 var return_data = new Array();
		    	            ...
		    	            for(var i=0;i< json.length; i++){
		    	            	t.row.add( [
		    	    			            ...
		    	    			            json[i].oderDate,
		    	    			            json[i].amount,
		    	    			            '<button id="View" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modalOdrMaint" data-mode="3" title="View Order" data-rowid="'+json[i].orderNumber+'"><span class="glyphicon glyphicon-eye-open"></span></button> <button id="Edit" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modalOdrMaint" data-mode="2" title="Edit Order" data-rowid="'+json[i].orderNumber+'"><span class="glyphicon glyphicon-pencil"></span></button> <button id="Delete" class="btn btn-dull btn-xs DeleteOrder" data-OrderNo="'+json[i].orderNumber+'"><span class="glyphicon glyphicon-trash" title="Delete Oder" ></span></button>'
		    	    			        ] ).draw( false );
		    	            }
		    		 });
