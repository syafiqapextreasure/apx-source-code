					...
					customize: function(doc) {
						...
						/*var rowCount = doc.content[1].table.body.length;
						   for (i = 0; i < rowCount; i++) {
								...
								doc.content[1].table.body[i][17].alignment = 'left';
						   };*/

						//doc.content[1].table.widths = [ '3%', '5.55%', '5.55%', '8.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%', '5.55%'];  
						///doc.content[1].table.widths = [ '4%', '15%', '10%', '15%', '23%', '20%', '10%'];
