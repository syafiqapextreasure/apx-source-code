$(document).ready(function() {
	...
	$('input[type=radio][name=rbClaimStat]').prop('checked', true);
	$("input[name=radioclaimstat][value=C]").prop('checked', true);
	...
	$(".patronSearch, .statusDiv, .acctDiv, .itemstatDiv, .recordselectionDiv").hide();
	$(".invstatDiv, .orderModeDiv, .printerStat").hide();
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
						...
						'1st Claim Date' : json[i].Column7,
						'2nd Claim Date' : json[i].Column8,
						'3rd Claim Date' : json[i].Column9,
						'Issues' : json[i].Column10,
						'Copies' : json[i].Column11,
		     	...
		     	columns    : [
					...
					{'data': 'ISSN'},
					{'data': 'Title'},
					{'data': '1st Claim Date', type: 'date-uk', targets: 0,},
					{'data': '2nd Claim Date', type: 'date-uk', targets: 0,},
					{'data': '3rd Claim Date', type: 'date-uk', targets: 0,},
					{'data': 'Issues'},
					{'data': 'Copies'},
