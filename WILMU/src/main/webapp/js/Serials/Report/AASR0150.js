$(document).ready(function() {
	...
	/////validate range Order number   #startInput, #endInput
	...
	/////validate range Invoive number   #startInput, #endInput
	$("#startInput2, #endInput2").focusout(function(){

	    if(parseFloat($("#startInput2").val()) > parseFloat($("#endInput2").val())){
		...
		*/
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_SerInvoiceReport',
		    ...
		    ajax: {
		        ...
		        dataSrc: function (json) {
		     	...
		     	columns    : [
					...
					{'data': 'Order Mode'},
					{'data': 'Reference No'},
					{'data': 'Date Created', type: 'date-uk', targets: 0,},
					{'data': 'Vendor'},
					{'data': 'Payment Status'},
