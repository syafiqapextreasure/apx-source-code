$(document).ready(function() {
	...
	$("#titleinput, #input-contorlNo").prop( "disabled", true);
	...
	$('#Reterive').click(function(){
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_SeCancelledReport',
					 	...
					 	},
						{
								...
								doc.styles.tableHeader.alignment = 'left';
							 	...
							 	//doc.content[1].table.widths = [ '8%', '55%', '12%', '12%', '12%']; 
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Cancelled Order Report '+sDate +eDate+ '\n',bold:true,fontSize:13,alignment: 'center'}						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
		                	extend: 'csv',
		                	filename: 'WILMU_SeCancelledReport',
		                	//title: 'Cancelled Order Report By ',
							customize: function(doc){
										...
										return "Cancelled Order Report "+sDate + eDate +"\n\n" + doc;
									 }
             			},
            ],
			destroy: true,
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
						...
						'Issues' : json[i].Column7,
						'Copies' : json[i].Column8,
						'Local Price' : json[i].Column9,
		            })
		            }
