$(document).ready(function() {
	...
	$(".recordselectionDiv, .printerStat, .invstatDiv, .orderModeDiv").hide();
	...
	$('#Reterive').click(function(){
		...
		var t = $('#reportTable').DataTable( {
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_SerOrderListing',
					        title: 'Serials Order Listing ' +sDate +eDate,
					 	...
					 	},
						{
							...
							customize: function (doc) {
								...
								//doc.content[1].table.widths = [ '3%', '12%', '10%', '9%', '9%', '9%', '9%', '9%', '9%', '9%', '12%'];
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Serials Order Listing '+sDate +eDate+ '\n',bold:true,fontSize:13,alignment: 'center'}						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Serials Order Listing "+sDate + eDate +"\n\n" + doc;
									 }
             			},
            ],
			destroy: true,
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
						...
						'Commence' : json[i].Column4,
						'Frequency' : json[i].Column5,
						'Subs Date' : json[i].Column6,
