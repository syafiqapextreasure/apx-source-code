            ...
            buttons: [
					 	...
					 	},
						{
							...
							customize: function (doc) {
								...
								doc.content[1].table.widths = [ '8%',  '12%', '20%', '36%', '12%', '12%']; 
		    ...
		    ajax: {
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
		                'No': (i+1),
		                'Module' : json[i].Column1,
		                'Program ID' : json[i].Column2,
		                'Description' : json[i].Column3,
		                'Index' : json[i].Column4,
		                'Access Level' : json[i].Column5,
		            })
		            }
