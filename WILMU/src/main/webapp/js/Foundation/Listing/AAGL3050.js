	...
	$('#Reterive').click(function(){
		...
		var t = $('#fndreportTable').DataTable( {
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_PatronEligibilityListing',
								...
								var rowCount = doc.content[1].table.body.length;
							 	...
							 	//doc.content[1].table.widths = [ '8%', '55%', '12%', '12%', '12%']; 
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Patron Eligibility Listing'+ '\n',bold:true,fontSize:13,alignment: 'center'}						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
		    ...
		    ajax: {
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
		                'No': (i+1),
		                'PatronCategory' : json[i].Column1,
		                'ItemCategory' : json[i].Column2,
		                'SMD' : json[i].Column3,
		                'Branch' : json[i].Column4,
		                'LoanPeriod' : json[i].Column5,
		                'PeriodType' : json[i].Column6,
		                'MaxItemPermitted' : json[i].Column7,
		                'MaxNoRenewalItems' : json[i].Column8,
		            })
		            }
		     	...
		     	columns    : [
					...
					{'data': 'LoanPeriod'},
					{'data': 'PeriodType'},
					{'data': 'MaxItemPermitted'},
					{'data': 'MaxNoRenewalItems'},															
				],
    	});
