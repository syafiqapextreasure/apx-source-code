	...
	$('#Reterive').click(function(){
		...
		var t = $('#fndreportTable').DataTable( {
            ...
            buttons: [
						{
					  		extend: 'excelHtml5',
					        filename: 'WILMU_HourlyLibUse',
					        title: 'Hourly Library Use Report' +sDate +eDate,
					 	...
					 	},
						{
								...
								var rowCount = doc.content[1].table.body.length;
							 	...
							 	//doc.content[1].table.widths = [ '8%', '55%', '12%', '12%', '12%']; 
											...
											doc.content.splice(0, 1, {
						                        text: [
						                                   { text: 'Hourly Library Use Report' +sDate +eDate+ '\n',bold:true,fontSize:13,alignment: 'center'}						                        ],
						                        margin: [0, 0, 0, 12],
						                    });
					...
					
               			{
							...
							customize: function(doc){
										...
										return "Hourly Library Use Report"+sDate +eDate +"\n\n" + doc;
									 }
             			},
            ],
			destroy: true,
		    ...
		    ajax: {
		        ...
		        dataSrc: function (json) {
		            ...
		            for(var i=0;i< json.length; i++){
		              ...
		              return_data.push({
		                'No': (i+1),
		                'User Name' : json[i].Column1,
		                'Dept/School' : json[i].Column2,
						'Date Used' : json[i].Column3,
						'Timex' : json[i].Column4,
						'No of Hours' : json[i].Column5,
		            })
		            }
		     	...
		     	columns    : [
					...
					{'data': 'Dept/School'},
					{'data': 'Date Used'},
					{'data': 'Timex', className: "text-right"},
					{'data': 'No of Hours', className: "text-right"},
				],
    	});
